...
| Decision Making | L80-L101 | Guidance on choosing Functions hosting/runtime models, comparing costs and plans, and planning migrations (between runtimes, models, platforms like AWS Lambda and Express.js). |
...
| Deployment | L274-L303 | Deploying and hosting Azure Functions: provisioning plans (Consumption/Flex), templates (Bicep/ARM/Terraform), containers/Kubernetes, CI/CD (GitHub/Azure Pipelines), slots, and migration tasks. |
