...
description: Provides expert guidance on Azure Functions, including Durable Functions, across troubleshooting, architecture, best practices, configuration, security, limits, integrations, decision making, and deployment. Use this skill when designing or refactoring Functions apps (including Linux containers and Container Apps), choosing hosting and scaling models, configuring bindings and networking, securing identities and secrets, integrating with external services, or diagnosing runtime, storage, and deployment issues. It also helps with CI/CD, zero‑downtime updates, and migrations from other platforms (e.g., AWS Lambda, Express) or older Functions versions. Not for general Azure guidance outside Azure Functions or for non-Azure serverless platforms.
...
|----------|-------|-------------|
| Troubleshooting | L37-L66 | Diagnosing and fixing Durable Functions and Durable Task issues, AZFD/AZFW error codes, storage/config problems, and runtime/deployment errors for Node.js, Python, and VM start/stop functions. |
| Best Practices | L67-L103 | Patterns and coding guidance for Durable Functions and core Azure Functions: orchestrations, entities, timers, retries, performance, scaling, DI, idempotency, and language-specific best practices. |
| Decision Making | L104-L133 | Guidance on choosing/migrating hosting models, scaling and networking, Durable Functions storage/billing, runtime/language upgrades, and moving apps from AWS Lambda, Express, and older Functions versions. |
| Architecture & Design Patterns | L134-L140 | Architectural guidance for running Functions in Linux containers, using Durable Functions with Azure Storage, and hosting Functions on Azure Container Apps. |
| Limits & Quotas | L141-L150 | Scaling, throughput, payload size, and concurrency limits for Azure Functions and Durable Task Scheduler, plus supported languages/versions and how to configure scaling behavior. |
| Security | L151-L168 | Securing Functions apps: encryption at rest, managed identities, identity-based connections, key and secret handling, private access, Web PubSub and Durable security, and secure storage configuration. |
| Configuration | L169-L210 | Configuring how Functions apps run: bindings, host/app settings, plans, networking, tracing/monitoring, Durable Functions/task hubs, Core Tools/local dev, and runtime/package management. |
| Integrations & Coding Patterns | L211-L323 | Patterns and examples for wiring Functions to external services (DBs, messaging, HTTP, AI/OpenAI, Dapr, MCP, SignalR, Web PubSub) using triggers/bindings and Durable Functions features |
| Deployment | L324-L361 | Deploying, versioning, and updating Azure Functions (incl. Durable, containers, Kubernetes, CI/CD, IaC, zero‑downtime, and migrations between plans/models and extensions). |
...
| Design and use Durable entities for state | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-entities |
...
| Build fan-out/fan-in workflows with Durable Functions | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-fan-in-fan-out |
| Handle human interaction and timeouts in Durable workflows | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-human-interaction |
| Implement monitor patterns in Durable orchestrations | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-monitor |
| Implement and optimize Durable orchestrator functions | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-orchestrations |
...
| Implement function chaining with Durable Functions | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-sequence |
...
| Create singleton orchestrations in Durable Functions | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-singletons |
| Use sub-orchestrations in Durable workflows | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-sub-orchestrations |
| Use durable timers for delays and timeouts | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-timers |
...
| Topic | URL |
|-------|-----|
| Choose and migrate Azure Functions Consumption hosting | https://learn.microsoft.com/en-us/azure/azure-functions/consumption-plan |
...
| Evaluate Durable Task Scheduler characteristics and usage | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-task-scheduler/durable-task-scheduler |
| Plan costs and billing for Durable Task Scheduler workloads | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-task-scheduler/durable-task-scheduler-billing |
...
| Choose and configure Azure Functions networking options | https://learn.microsoft.com/en-us/azure/azure-functions/functions-networking-options |
...
| Architect Durable Functions with the Azure Storage provider | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-azure-storage-provider |
...
| Topic | URL |
|-------|-----|
| Handle large payloads with Durable Task Scheduler | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-task-scheduler/durable-task-scheduler-large-payloads |
...
| Configure Durable Functions triggers, bindings, and host settings | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-bindings |
| Configure and query custom orchestration status | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-custom-orchestration-status |
| Manage Durable orchestration instances via APIs | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-instance-management |
| Configure and manage Durable Functions task hubs | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-task-hubs |
...
| Create Durable Functions app using MSSQL storage provider | https://learn.microsoft.com/en-us/azure/azure-functions/durable/quickstart-mssql |
...
| Implement durable entities in .NET Durable Functions | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-dotnet-entities |
| Publish Durable Functions lifecycle events to Azure Event Grid | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-event-publishing |
...
| Upgrade Azure Durable Functions extension versions safely | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-functions-extension-upgrade |
...
| Safely deploy changes with orchestration versioning | https://learn.microsoft.com/en-us/azure/azure-functions/durable/durable-orchestration-versioning |
...
| Deploy Azure Functions in custom Linux containers | https://learn.microsoft.com/en-us/azure/azure-functions/functions-how-to-custom-container |
