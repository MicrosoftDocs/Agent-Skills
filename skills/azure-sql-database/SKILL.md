...
description: Expert knowledge for Azure SQL Database development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when using Hyperscale/serverless, geo-replication/HA, Data Sync/sharding, EF Core/.NET apps, or CI/CD templates, and other Azure SQL Database related development tasks. Not for Azure Database for MariaDB (use azure-database-mariadb), Azure Database for MySQL (use azure-database-mysql), Azure Database for PostgreSQL (use azure-database-postgresql), Azure SQL Managed Instance (use azure-sql-managed-instance).
...
| Decision Making | L77-L101 | Guides for choosing Azure SQL deployment, pricing, performance, HA/DR, Hyperscale/serverless options, and migration paths (DTU↔vCore, sharding, Data Sync, Hybrid Benefit, reservations). |
| Architecture & Design Patterns | L102-L120 | Architectural patterns for Azure SQL: geo-replication, HA/DR, backups, connectivity, sharding/elastic scale-out, multi-tenant SaaS models, and rolling upgrade/failover designs. |
| Limits & Quotas | L121-L133 | Limits, quotas, and resource caps for Azure SQL (DTU/vCore, single DBs, elastic pools, free tier), plus FAQs and how to request quota increases. |
| Security | L134-L204 | Configuring Azure SQL security: authentication (Entra, MFA, managed identity), network access, auditing, encryption (TDE, Always Encrypted), threat protection, compliance, and best practices. |
| Configuration | L205-L271 | Configuring Azure SQL databases and pools: monitoring, backups, geo-replication/failover, maintenance, security/immutability, elastic jobs/queries, scaling, and CLI/PowerShell/REST setup. |
| Integrations & Coding Patterns | L272-L301 | Connecting apps and tools to Azure SQL (EF Core, .NET, Node, Python, Spark, Stream Analytics) plus PowerShell automation for sharding, scaling, replication, backup/restore, and auditing. |
| Deployment | L302-L316 | Guides for deploying and moving Azure SQL databases: CI/CD with GitHub/Terraform/Bicep/ARM, Hyperscale setup, regional moves, feature availability, and dev environment setup. |
...
| Use Azure SQL decision tree for option selection | https://learn.microsoft.com/en-us/azure/azure-sql/azure-sql-decision-tree?view=azuresql |
...
| Choose and use Azure SQL Hyperscale tier | https://learn.microsoft.com/en-us/azure/azure-sql/database/service-tier-hyperscale?view=azuresql |
...
| Select Azure SQL Database vCore tiers and sizing | https://learn.microsoft.com/en-us/azure/azure-sql/database/service-tiers-sql-database-vcore?view=azuresql |
...
| Check vCore resource limits for single Azure SQL databases | https://learn.microsoft.com/en-us/azure/azure-sql/database/resource-limits-vcore-single-databases?view=azuresql |
...
| Provision Azure SQL with Entra-only authentication | https://learn.microsoft.com/en-us/azure/azure-sql/database/authentication-azure-ad-only-authentication-create-server?view=azuresql |
...
| Enable TDE with Key Vault customer-managed keys | https://learn.microsoft.com/en-us/azure/azure-sql/database/transparent-data-encryption-byok-configure?view=azuresql |
...
| Configure user-assigned identity and CMK TDE for Azure SQL | https://learn.microsoft.com/en-us/azure/azure-sql/database/transparent-data-encryption-byok-create-server?view=azuresql |
...
| Manage database-level CMK TDE with cross-tenant Key Vault | https://learn.microsoft.com/en-us/azure/azure-sql/database/transparent-data-encryption-byok-database-level-basic-actions?view=azuresql |
...
| Rotate Azure SQL TDE protector using Key Vault keys | https://learn.microsoft.com/en-us/azure/azure-sql/database/transparent-data-encryption-byok-key-rotation?view=azuresql |
