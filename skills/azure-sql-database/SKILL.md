...
description: Expert knowledge for Azure SQL Database development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when choosing DTU/vCore/Hyperscale/serverless tiers, configuring geo-replication, Always Encrypted, elastic pools, or EF Core app connections, and other Azure SQL Database related development tasks. Not for Azure SQL Managed Instance (use azure-sql-managed-instance), SQL Server on Azure Virtual Machines (use azure-sql-virtual-machines), Azure Cosmos DB (use azure-cosmos-db), Azure Database for PostgreSQL (use azure-database-postgresql).
...
|----------|-------|-------------|
| Troubleshooting | L37-L59 | Diagnosing and fixing Azure SQL issues: performance (CPU, memory, deadlocks, blocking), connectivity, capacity/scaling, geo-replication, Data Sync, import/export, and log/shard problems. |
| Best Practices | L60-L77 | Best practices for Azure SQL monitoring, HA/DR, failover, maintenance, security, auditing, scaling, sharding, Data Sync, post-migration ops, and handling T-SQL differences. |
| Decision Making | L78-L101 | Guidance for choosing Azure SQL deployment, pricing, HA/DR, automation, and migration options (DTU↔vCore, Hyperscale, serverless, reservations, Hybrid Benefit, enclaves, and feature comparisons). |
| Architecture & Design Patterns | L102-L119 | Architectural patterns for Azure SQL: geo-replication, HA/DR, backups, connectivity, sharding/elastic scale-out, multi-tenant SaaS models, and rolling upgrade/failover designs. |
| Limits & Quotas | L120-L133 | Limits, quotas, and resource caps for Azure SQL (free tiers, DTU/vCore, elastic pools, Hyperscale), plus how to request quota increases and watcher/operational constraints. |
| Security | L134-L204 | Configuring Azure SQL security: authentication (Entra, MI, MFA), network access, auditing, encryption (TDE, Always Encrypted), threat protection, compliance, and secure import/export. |
| Configuration | L205-L269 | Configuring Azure SQL databases and pools: monitoring, backups and immutability, geo-replication/failover, scaling and elastic pools/jobs, maintenance windows, networking/TLS, and CLI/PowerShell/REST setup. |
| Integrations & Coding Patterns | L270-L304 | Patterns and code for connecting apps to Azure SQL (EF Core, .NET, Node, Python), sharding/elastic tools, replication/geo-replication, and automation via PowerShell, Spark, and Stream Analytics. |
| Deployment | L305-L319 | Guides for deploying and moving Azure SQL databases: automation (GitHub, ARM, Bicep, Terraform), Hyperscale setup, regional moves, feature availability, and dev environment setup. |
...
| Fix transaction log full issues in Azure SQL Managed Instance | https://learn.microsoft.com/en-us/azure/azure-sql/managed-instance/troubleshoot-transaction-log-errors-issues?view=azuresql-mi |
...
| Monitor Azure SQL shard map manager performance counters | https://learn.microsoft.com/en-us/azure/azure-sql/database/elastic-database-perf-counters?view=azuresql |
...
| Configure Entra service principals for Azure SQL users | https://learn.microsoft.com/en-us/azure/azure-sql/database/authentication-aad-service-principal-tutorial?view=azuresql |
...
| Migrate existing Azure SQL shards to Elastic tools | https://learn.microsoft.com/en-us/azure/azure-sql/database/elastic-convert-to-use-elastic-tools?view=azuresql |
| Use Elastic Database client library for sharding in Azure SQL | https://learn.microsoft.com/en-us/azure/azure-sql/database/elastic-database-client-library?view=azuresql |
| Query across Azure SQL databases with elastic query | https://learn.microsoft.com/en-us/azure/azure-sql/database/elastic-query-getting-started?view=azuresql |
| Configure elastic queries over horizontally partitioned Azure SQL databases | https://learn.microsoft.com/en-us/azure/azure-sql/database/elastic-query-horizontal-partitioning?view=azuresql |
| Implement data-dependent routing with ShardMapManager in Azure SQL | https://learn.microsoft.com/en-us/azure/azure-sql/database/elastic-scale-data-dependent-routing?view=azuresql |
...
| Upgrade Azure SQL elastic database client via NuGet | https://learn.microsoft.com/en-us/azure/azure-sql/database/elastic-scale-upgrade-client-library?view=azuresql |
