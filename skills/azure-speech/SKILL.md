---
name: azure-speech
description: Expert knowledge for Azure AI Speech development including troubleshooting, best practices, decision making, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when building STT/TTS, Voice Live, avatars, custom speech/voice models, or batch/long-form synthesis, and other Azure AI Speech related development tasks. Not for Azure Communication Services (use azure-communication-services), Azure AI Bot Service (use azure-bot-service), Azure AI Video Indexer (use azure-video-indexer), Azure AI Immersive Reader (use azure-immersive-reader).
...
| Security | L90-L101 | Configuring security for Azure AI Speech: auth (Entra, RBAC), data encryption/BYOK, BYOS storage, voice consent, and network isolation via VNet, service endpoints, Private Link, and sovereign clouds. |
| Configuration | L102-L138 | Configuring Azure AI Speech and Voice Live: audio inputs/outputs, storage and logging, regions, SDK/CLI settings, SSML/phonemes, visemes/avatars, and custom speech/voice training workflows. |
| Integrations & Coding Patterns | L139-L161 | Patterns and code for integrating Azure Speech/Voice Live with apps and telephony: STT/TTS, avatars, translation, OpenAI chat, BYOM, REST/SDK usage, events, function calling, and automation. |
| Deployment | L162-L173 | Deploying and scaling Azure AI Speech: Docker/Kubernetes containers, on-prem STT/TTS, custom speech models/endpoints, language ID, and batch/long-form synthesis workflows. |
...
| Use SSML phonetic alphabets in Azure Speech | https://learn.microsoft.com/en-us/azure/ai-services/speech-service/speech-ssml-phonetic-sets |
...
| Configure language and locale support in Voice Live API | https://learn.microsoft.com/en-us/azure/ai-services/speech-service/voice-live-language-support |
...
| Integrate custom BYOM models with Voice Live API | https://learn.microsoft.com/en-us/azure/ai-services/speech-service/how-to-bring-your-own-model |
...
| Trigger proactive messages in Voice Live agents | https://learn.microsoft.com/en-us/azure/ai-services/speech-service/how-to-voice-live-proactive-messages |
