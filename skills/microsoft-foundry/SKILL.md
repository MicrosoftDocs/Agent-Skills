...
description: Expert knowledge for Microsoft Foundry (aka Azure AI Foundry) development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when building Foundry agents with tools, Responses API, Azure OpenAI, M365/Teams publishing, or CI/CD, and other Microsoft Foundry related development tasks. Not for Microsoft Foundry Classic (use microsoft-foundry-classic), Microsoft Foundry Local (use microsoft-foundry-local), Microsoft Foundry Tools (use microsoft-foundry-tools).
...
| Decision Making | L57-L81 | Guides for choosing models, deployment types, data isolation, and streaming modes, plus planning migrations, upgrades, costs, and regional availability for Foundry and Azure OpenAI |
...
| Configuration | L135-L185 | Configuring and operating Foundry agents and models: hosts, workflows, tools, memory, evaluators, safety/guardrails, storage, monitoring, tracing, token limits, and Azure OpenAI/runtime setup. |
| Integrations & Coding Patterns | L186-L252 | Patterns and APIs for integrating Foundry models/agents into apps: SDKs, Responses API, tools (search, web, speech, browser, code), LangChain/LangGraph, Azure OpenAI, gateways, tracing, and webhooks. |
