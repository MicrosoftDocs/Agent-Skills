...
description: Provides expert Azure architecture guidance across reference architectures, solution ideas, design patterns, technology choices, architecture styles, best practices, anti-patterns, example workloads, and migration guides. Use this skill to design or review Azure solutions, choose services and architecture styles, avoid performance/scalability pitfalls, plan migrations from other clouds/on-prem, and validate end-to-end workload designs (data, AI/ML, IoT, SAP, networking, hybrid, and more). Not for writing application code or generic cloud advice unrelated to Azure platform architecture.
...
|----------|-------|-------------|
| Reference Architectures | L37-L92 | End-to-end Azure solution blueprints: secure, mission-critical, and hybrid architectures for data platforms, AKS, App Service, networking, identity, DR, and MLOps deployments. |
| Solution Ideas | L93-L125 | End-to-end solution patterns for AI, analytics, IoT, security, SAP, and DevOps on Azure, showing reference architectures, services to use, and how to implement them in real scenarios. |
| Design Patterns | L126-L180 | Patterns and reference architectures for building resilient, scalable, secure Azure solutions: messaging, microservices, gateways, caching, transactions, multitenancy, and integration with legacy systems. |
| Technology Choices | L181-L215 | Guides for choosing the right Azure/Fabric services (compute, storage, data, AI/ML, analytics, networking, containers, messaging, search) for specific workloads and architectures. |
| Architecture Styles | L216-L226 | Guidance on choosing and designing Azure app architectures (Big Compute, Big Data, event-driven, microservices, N-tier, Web-Queue-Worker) and comparing their patterns and use cases. |
| Best Practices | L227-L290 | Best practices for designing, securing, scaling, operating, and monitoring Azure apps and platforms (AKS, App Service, IoT, SAP, networking, APIs, Event Hubs, DR, DevOps, and MLOps). |
...
| Example Workloads | L306-L373 | End-to-end reference architectures for real-world Azure workloads: data/analytics, AI/ML, security, networking, hybrid, VDI, AKS, IoT, mainframe, and app integration patterns. |
| Migration Guides | L374-L406 | Guides for migrating from AWS, GCP, on-prem Oracle, Kafka, and EKS to Azure, mapping services, architectures, identity, security, and cost/governance differences. |
...
| Evaluate and choose Azure data store services | https://learn.microsoft.com/en-us/azure/architecture/guide/technology-choices/data-stores-getting-started |
...
| Select the right Azure storage service for workloads | https://learn.microsoft.com/en-us/azure/architecture/guide/technology-choices/storage-options |
...
| Implement autoscaling best practices in Azure applications | https://learn.microsoft.com/en-us/azure/architecture/best-practices/auto-scaling |
...
| Apply cross-cutting best practices for Azure cloud apps | https://learn.microsoft.com/en-us/azure/architecture/best-practices/index-best-practices |
...
| Map and compare AWS and Azure compute services | https://learn.microsoft.com/en-us/azure/architecture/aws-professional/compute |
