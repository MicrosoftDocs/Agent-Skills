...
description: Provides expert guidance on Azure IoT Operations across troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations, and deployment on Kubernetes. Use this skill when designing or operating production Azure IoT Operations environments: planning layered/segmented industrial networks, configuring MQTT broker and data flows, integrating industrial protocols and edge modules, securing and monitoring workloads, sizing and scaling clusters, and diagnosing deployment/runtime issues. Not for generic Azure IoT, IoT Hub, or non–Azure IoT platforms.
...
| Security | L65-L81 | Securing Azure IoT Operations: TLS/cert management, OPC UA trust, MQTT authz/authn and encryption, RBAC roles, secrets in Key Vault/Kubernetes, and image validation. |
| Configuration | L82-L119 | Configuring Azure IoT Operations data flows, endpoints, schemas, WASM, MQTT broker, observability, and device/asset registry settings for routing, transforming, and monitoring IoT data. |
...
| Topic | URL |
|-------|-----|
| Configure secure settings and identities in Azure IoT Operations | https://learn.microsoft.com/en-us/azure/iot-operations/deploy-iot-ops/howto-enable-secure-settings |
