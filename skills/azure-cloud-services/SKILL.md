...
| Decision Making | L46-L54 | Planning, migrating, and operating Azure Cloud Services (extended support), including feature comparison with VM Scale Sets and moving classic/non-VNet services into VNets. |
