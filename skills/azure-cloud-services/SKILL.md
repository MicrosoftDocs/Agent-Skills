...
description: Expert knowledge for Azure Cloud Services development including troubleshooting, best practices, decision making, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when managing Cloud Services roles, .csdef/.cscfg, Guest OS versions, Key Vault certs, or autoscale rules, and other Azure Cloud Services related development tasks. Not for Azure Networking (use azure-networking), Azure Virtual Machines (use azure-virtual-machines), Azure Resource Manager (use azure-resource-manager), Azure Portal (use azure-portal).
...
| Decision Making | L46-L54 | Guidance on planning, comparing, and migrating Azure Cloud Services (classic to extended support), including VMSS comparison, VNet requirements, and operational best practices. |
...
| Topic | URL |
|-------|-----|
| Plan and operate Azure Cloud Services (extended support) | https://learn.microsoft.com/en-us/azure/cloud-services-extended-support/faq |
