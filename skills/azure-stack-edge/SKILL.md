...
description: Expert knowledge for Azure Stack Edge development including troubleshooting, best practices, decision making, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when running IoT Edge or GPU/Kubernetes apps, configuring VMs/networking, or managing Azure Stack Edge devices, and other related development tasks. Not for Azure IoT Edge (use azure-iot-edge), Azure Kubernetes Service Edge Essentials (use azure-aks-edge-essentials), Azure IoT (use azure-iot), Azure Virtual Machines (use azure-virtual-machines).
