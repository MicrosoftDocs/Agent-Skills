...
description: Expert knowledge for Azure US Government development including decision making, architecture & design patterns, security, configuration, integrations & coding patterns, and deployment. Use when handling FedRAMP/DoD IL5 scope, SACA patterns, Gov Marketplace publishing, Entra auth, or Gov Storage/SQL APIs, and other related development tasks. Not for Azure Security (use azure-security), Azure Networking (use azure-networking), Azure Virtual Network (use azure-virtual-network), Azure Resource Manager (use azure-resource-manager).
