---
name: azure-bastion
description: Expert knowledge for Azure Bastion development including troubleshooting, best practices, decision making, architecture & design patterns, security, configuration, and integrations & coding patterns. Use when connecting via SSH/RDP to AKS private clusters or VMSS, using native clients, Kerberos auth, or IP-based Bastion, and other Azure Bastion related development tasks. Not for Azure Virtual Network (use azure-virtual-network), Azure Virtual Machines (use azure-virtual-machines), Azure VPN Gateway (use azure-vpn-gateway), Azure Firewall (use azure-firewall).
...
| Configuration | L66-L78 | Configuring Azure Bastion behavior: scaling, auth (Kerberos), monitoring/metrics/logs, native client access, session management, recordings, and shareable links. |
...
| Topic | URL |
|-------|-----|
| Understand and set Azure Bastion configuration options | https://learn.microsoft.com/en-us/azure/bastion/configuration-settings |
| Configure Azure Bastion host scaling settings | https://learn.microsoft.com/en-us/azure/bastion/configure-host-scaling |
