---
name: azure-sentinel
description: Expert guidance on Microsoft Sentinel architecture, configuration, operations, and troubleshooting, including data connectors, analytics/automation rules, SOAR patterns, security/RBAC, limits/quotas, integrations, and deployment/CI-CD. Use this skill when designing or migrating Sentinel environments, tuning SOC operations, resolving ingestion or rule issues, planning multi-workspace/tenant setups, integrating external tools and data sources, or optimizing cost, resiliency, and compliance. Not for Microsoft Defender XDR, Azure Monitor-only scenarios, or non-Sentinel SIEM products.
...
|----------|-------|-------------|
| Troubleshooting | L37-L48 | Diagnosing and fixing Microsoft Sentinel ingestion, connector, KQL/data lake, analytics rule (incl. auto-disabled), MCP tools, and SAP/AWS/Blob/CEF/Syslog agent issues. |
...
| Decision Making | L76-L111 | Guidance on Sentinel design and migration decisions: SIEM/agent/automation migrations, pricing and cost control, data tiers/residency, connector choices, and feature availability across clouds. |
| Architecture & Design Patterns | L112-L127 | Architecting Sentinel deployments: multi-workspace/tenant patterns, MSSP setups, SOAR automation, BCDR/resiliency, cross-workspace data/incident ops, SAP, ML models, and Jupyter-based hunting. |
| Limits & Quotas | L128-L139 | Limits, quotas, pricing, and retention tiers for Sentinel data, search jobs, watchlists, ASIM, and workspace removal impacts, including file size and large dataset constraints. |
| Security | L140-L154 | Security, RBAC, and auditing for Microsoft Sentinel: configuring auth, roles, CMK encryption, network protection, SAP/AWS identity controls, and logging of queries and data access. |
| Configuration | L155-L278 | Configuring Microsoft Sentinel: data connectors, retention, analytics and automation rules, ASIM schemas, SAP/UEBA/MCP integrations, health monitoring, and data lake/notebook setup. |
...
| Deployment | L324-L346 | Deploying and publishing Microsoft Sentinel solutions, connectors, and content (SAP, Power Platform, Dynamics, Azure Stack Hub), plus CI/CD, ARM-based rule/automation management, and solution status tracking. |
