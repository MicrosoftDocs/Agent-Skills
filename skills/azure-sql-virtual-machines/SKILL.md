...
description: Provides expert guidance on SQL Server on Azure Virtual Machines across troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use this skill when designing or operating SQL Server on Azure VMs, including HA/DR (AGs, FCIs, WSFC), performance and storage tuning, security hardening, backup/restore to Azure storage, migration planning, and resolving connectivity, performance, or IaaS Agent issues. Not for Azure SQL Database, Azure SQL Managed Instance, or non-Azure-hosted SQL Server scenarios.
...
|----------|-------|-------------|
| Troubleshooting | L37-L52 | Diagnosing and fixing Azure SQL and SQL Server on Azure VM issues: connectivity, performance, memory, transaction logs, geo-replication, capacity, I/O throttling, and IaaS Agent problems. |
...
| Decision Making | L67-L79 | Guidance on choosing SQL on Azure VM vs other Azure SQL options, planning migrations (Db2/Oracle/SQL 2014), HADR/BCDR design, pricing/licensing (Hybrid Benefit), and using Modernization Advisor. |
...
| Configuration | L108-L150 | Configuring SQL Server on Azure VMs: HA/DR (AGs, FCIs, listeners, load balancers), storage and performance, IaaS Agent, deployment/upgrade options, and monitoring/logging. |
...
| Topic | URL |
|-------|-----|
| Choose the right Azure SQL deployment option | https://learn.microsoft.com/en-us/azure/azure-sql/azure-sql-decision-tree?view=azuresql |
