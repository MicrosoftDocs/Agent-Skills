...
description: Expert knowledge for Azure Databricks development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when using Unity Catalog, Lakehouse/Lakeflow, Lakebase, Delta Sharing, Databricks Apps, or Model Serving, and other Azure Databricks related development tasks. Not for Azure HDInsight (use azure-hdinsight), Azure Synapse Analytics (use azure-synapse-analytics), Azure Machine Learning (use azure-machine-learning), Azure Data Factory (use azure-data-factory).
...
|----------|----------|-------------|
| Troubleshooting | L37-L127 | Diagnosing and fixing Databricks issues: cluster startup/termination, SQL and connector errors, Lakeflow/ingestion failures, model serving, Genie/AI agents, and performance/debug tooling. |
| Best Practices | L128-L326 | Best-practice guidance for Databricks architecture, performance, cost, governance, streaming, Delta Lake, BI, ML/GenAI, Lakeflow, and troubleshooting across Azure Databricks workloads. |
...
| Architecture & Design Patterns | L408-L444 | Architectural patterns and best practices for Databricks lakehouse, AI agents (RAG, multi-agent, memory), MLOps/LLMOps, Lakebase, governance, performance, reliability, and data modeling. |
| Limits & Quotas | [limits-quotas.md](limits-quotas.md) | Limits, quotas, and constraints for Databricks compute, runtimes, AI/BI, connectors, Lakeflow, Model Serving, Unity Catalog, and related performance, scaling, and retention behaviors. |
...
| Configuration | [configuration.md](configuration.md) | Configuring and managing Azure Databricks: accounts, workspaces, security, networking, compute, storage, SQL/Unity Catalog, Lakehouse/Lakeflow, AI/ML/GenAI, system tables, and CLI/bundle-based automation. |
| Integrations & Coding Patterns | [integrations.md](integrations.md) | Integrating Databricks with external data sources, tools, and agents; using CLIs/SDKs, Lakehouse Federation, Lakeflow, MLflow, and PySpark/SQL APIs for I/O, streaming, AI/ML, and geospatial workloads. |
| Deployment | [deployment.md](deployment.md) | Deploying and managing Databricks workspaces, apps, jobs, ML/GenAI models and agents via CI/CD, Terraform, VS Code, Model Serving, and migration/infra options on Azure Databricks. |
...
| Choose and train deep recommender models in Azure Databricks | https://learn.microsoft.com/en-us/azure/databricks/machine-learning/train-recommender-models |
