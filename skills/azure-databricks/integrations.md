...
| Query Unity AI Gateway endpoints via unified and native APIs | https://learn.microsoft.com/en-us/azure/databricks/ai-gateway/query-endpoints-beta |
...
| Operate MLflow experiments using Databricks CLI experiments commands | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/experiments-commands |
...
| Manage Databricks groups with CLI groups-v2 | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/groups-v2-commands |
...
| Manage Knowledge Assistants via Databricks CLI | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/knowledge-assistants-commands |
...
| Embed Lakeview dashboards using CLI lakeview-embedded | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/lakeview-embedded-commands |
...
| Manage Unity Catalog ABAC policies with CLI | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/policies-commands |
| Manage Lakebase Postgres with Databricks CLI postgres | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/postgres-commands |
...
| Connect to Lakebase Postgres using CLI psql | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/psql-command |
| Manage data quality monitors with CLI quality-monitor-v2 | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/quality-monitor-v2-commands |
| Use Databricks CLI quality-monitors commands | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/quality-monitors-commands |
...
| Control Databricks serving endpoints via CLI | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/serving-endpoints-commands |
...
| Manage Databricks users with users-v2 CLI | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/users-v2-commands |
| Operate vector search endpoints via Databricks CLI | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/vector-search-endpoints-commands |
...
| Manage Databricks SQL warehouses with CLI | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/warehouses-commands |
...
| Use Databricks CLI workspace-iam-v2 commands for access control | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/workspace-iam-v2-commands |
| Manage Databricks workspace settings with CLI workspace-settings-v2 | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/workspace-settings-v2-commands |
...
| Use Databricks Supervisor API to orchestrate AI agents | https://learn.microsoft.com/en-us/azure/databricks/generative-ai/agent-bricks/supervisor-api |
...
| Build Databricks Apps agents using Supervisor API orchestration | https://learn.microsoft.com/en-us/azure/databricks/generative-ai/agent-framework/supervisor-api-app |
...
| Integrate Genie via API into apps and agents | https://learn.microsoft.com/en-us/azure/databricks/genie/conversation-api |
| Load ADLS data into Unity Catalog with COPY INTO | https://learn.microsoft.com/en-us/azure/databricks/ingestion/cloud-object-storage/copy-into/unity-catalog |
...
| Configure Lakeflow Connect pipeline for Meta Ads | https://learn.microsoft.com/en-us/azure/databricks/ingestion/lakeflow-connect/meta-ads-pipeline |
| Create Lakeflow Connect pipeline for NetSuite data | https://learn.microsoft.com/en-us/azure/databricks/ingestion/lakeflow-connect/netsuite-pipeline |
| Build Lakeflow Connect pipeline from ServiceNow | https://learn.microsoft.com/en-us/azure/databricks/ingestion/lakeflow-connect/servicenow-pipeline |
| Configure SharePoint ingestion with Lakeflow Connect | https://learn.microsoft.com/en-us/azure/databricks/ingestion/lakeflow-connect/sharepoint-pipeline |
| Configure Lakeflow Connect pipeline for TikTok Ads | https://learn.microsoft.com/en-us/azure/databricks/ingestion/lakeflow-connect/tiktok-ads-pipeline |
| Set up Lakeflow Connect pipeline for Workday HCM | https://learn.microsoft.com/en-us/azure/databricks/ingestion/lakeflow-connect/workday-hcm-pipeline |
| Ingest Workday reports using Lakeflow Connect | https://learn.microsoft.com/en-us/azure/databricks/ingestion/lakeflow-connect/workday-reports-pipeline |
| Create a Lakeflow Connect pipeline for Zendesk Support | https://learn.microsoft.com/en-us/azure/databricks/ingestion/lakeflow-connect/zendesk-support-pipeline |
...
| Ingest SFTP data using Lakeflow Connect Auto Loader | https://learn.microsoft.com/en-us/azure/databricks/ingestion/sftp |
...
| Query Azure Databricks data via Google Sheets connector | https://learn.microsoft.com/en-us/azure/databricks/integrations/google-sheets/query-data |
...
| Use append_flow decorator in Databricks Python pipelines | https://learn.microsoft.com/en-us/azure/databricks/ldp/developer/ldp-python-ref-append-flow |
...
| Materialize Databricks declarative features to tables | https://learn.microsoft.com/en-us/azure/databricks/machine-learning/feature-store/materialized-features |
...
| Serve Databricks declarative features via endpoints | https://learn.microsoft.com/en-us/azure/databricks/machine-learning/feature-store/serve-declarative-features |
...
| Call Databricks Foundation Model REST APIs | https://learn.microsoft.com/en-us/azure/databricks/machine-learning/foundation-model-apis/api-reference |
...
| Send requests to Databricks and external foundation models | https://learn.microsoft.com/en-us/azure/databricks/machine-learning/model-serving/score-foundation-models |
...
| Use Lakebase Postgres with Databricks Apps | https://learn.microsoft.com/en-us/azure/databricks/oltp/projects/databricks-apps |
...
| Use DataFrameWriter.option for Azure Databricks writes | https://learn.microsoft.com/en-us/azure/databricks/pyspark/reference/classes/dataframewriter/option |
...
| Set DataFrameWriterV2.option for Databricks data sources | https://learn.microsoft.com/en-us/azure/databricks/pyspark/reference/classes/dataframewriterv2/option |
...
| Use get_json_object in Databricks SQL queries | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/functions/get_json_object |
...
| Normalize IP addresses with ip_host in Databricks SQL | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/functions/ip_host |
...
| Find last address in CIDR with ip_network_last in Databricks SQL | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/functions/ip_network_last |
| Get CIDR prefix length with ip_prefix_length in Databricks SQL | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/functions/ip_prefix_length |
...
| Author SQL scripting procedures in Azure Databricks | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/sql-ref-scripting |
...
| Define tables with CREATE TABLE in Databricks SQL | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/sql-ref-syntax-ddl-create-table-using |
...
| Register and serve OSS embedding models for Vector Search | https://learn.microsoft.com/en-us/azure/databricks/vector-search/embedding-with-oss-models |
...
| Use GTE foundation embeddings with Vector Search | https://learn.microsoft.com/en-us/azure/databricks/vector-search/vector-search-foundation-embedding-model-gte-example |
