...
| Reference Azure Databricks diagnostic log events | https://learn.microsoft.com/en-us/azure/databricks/admin/account-settings/audit-logs |
| Configure a custom URL for Azure Databricks | https://learn.microsoft.com/en-us/azure/databricks/admin/account-settings/custom-url |
| Configure legacy feature access for new workspaces | https://learn.microsoft.com/en-us/azure/databricks/admin/account-settings/legacy-features |
| Import and use Databricks usage monitoring dashboards | https://learn.microsoft.com/en-us/azure/databricks/admin/account-settings/usage |
| Enable and manage verbose audit logs in workspaces | https://learn.microsoft.com/en-us/azure/databricks/admin/account-settings/verbose-logs |
...
| Define Databricks compute policies with JSON attributes | https://learn.microsoft.com/en-us/azure/databricks/admin/clusters/policy-definition |
...
| Create and configure governed tags in Databricks | https://learn.microsoft.com/en-us/azure/databricks/admin/governed-tags/manage-governed-tags |
| Configure SQL warehouse admin settings and access controls | https://learn.microsoft.com/en-us/azure/databricks/admin/sql/ |
| Configure legacy data access properties for SQL warehouses | https://learn.microsoft.com/en-us/azure/databricks/admin/sql/data-access-configuration |
| Set up and manage serverless SQL warehouses | https://learn.microsoft.com/en-us/azure/databricks/admin/sql/serverless |
| Use Azure Databricks system tables for monitoring and auditing | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/ |
| Track Genie Code assistant usage with system tables | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/assistant |
| Use audit log system table for account insights | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/audit-logs |
| Query billable usage system table to monitor Databricks costs | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/billing |
| Audit clean room activity via system tables | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/clean-rooms |
...
| Use data classification system table for sensitivity | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/data-classification |
...
| Use lakeflow jobs system tables to track Databricks job activity | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/jobs |
| Track Lakeflow job costs and performance via system tables | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/jobs-cost |
| Query lineage system tables for data dependencies | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/lineage |
...
| Analyze network access events via system tables | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/network |
| Inspect predictive optimization history via system table | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/predictive-optimization |
...
| Query the system.query.history table for Databricks query history | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/query-history |
| Analyze serverless compute costs using billing tables | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/serverless-billing |
| Monitor SQL warehouse events using warehouse_events system table | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/warehouse-events |
...
| Monitor Databricks workspaces using system tables | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/workspaces |
| Query Zerobus Ingest system tables for monitoring | https://learn.microsoft.com/en-us/azure/databricks/admin/system-tables/zerobus-ingest |
| Configure serverless usage policies for cost attribution | https://learn.microsoft.com/en-us/azure/databricks/admin/usage/budget-policies |
| Monitor default storage spending via billable usage table | https://learn.microsoft.com/en-us/azure/databricks/admin/usage/default-storage |
| Monitor Databricks costs via billable usage system table | https://learn.microsoft.com/en-us/azure/databricks/admin/usage/system-tables |
| Configure workspace base environments for serverless compute | https://learn.microsoft.com/en-us/azure/databricks/admin/workspace-settings/base-environment |
...
| Configure default Python package repositories in Azure Databricks | https://learn.microsoft.com/en-us/azure/databricks/admin/workspace-settings/default-python-packages |
...
| Configure workspace email notification settings in Azure Databricks | https://learn.microsoft.com/en-us/azure/databricks/admin/workspace-settings/email |
...
| Configure notification destinations and webhooks in Azure Databricks | https://learn.microsoft.com/en-us/azure/databricks/admin/workspace-settings/notification-destinations |
| Purge Azure Databricks workspace storage and logs | https://learn.microsoft.com/en-us/azure/databricks/admin/workspace-settings/storage |
...
| Configure Unity AI Gateway inference tables for monitoring | https://learn.microsoft.com/en-us/azure/databricks/ai-gateway/inference-tables-beta |
| Configure and query Unity AI Gateway usage tracking | https://learn.microsoft.com/en-us/azure/databricks/ai-gateway/usage-tracking-beta |
...
| Use YAML syntax to define Databricks metric views | https://learn.microsoft.com/en-us/azure/databricks/business-semantics/metric-views/yaml-reference |
...
| Configure Azure Databricks compute settings | https://learn.microsoft.com/en-us/azure/databricks/compute/configure |
...
| Use Unity Catalog to view data lineage | https://learn.microsoft.com/en-us/azure/databricks/data-governance/unity-catalog/data-lineage |
...
| Define and use Delta Lake generated columns in Databricks | https://learn.microsoft.com/en-us/azure/databricks/delta/generated-columns |
...
| Understand Databricks Apps system environment and variables | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/databricks-apps/system-env |
...
| Configure and manage Genie spaces in Azure Databricks | https://learn.microsoft.com/en-us/azure/databricks/genie/set-up |
...
| Configure Dynamics 365 as a Lakeflow data source | https://learn.microsoft.com/en-us/azure/databricks/ingestion/lakeflow-connect/d365-source-setup |
...
| Set up and configure Azure Databricks Excel Add-in with SSO | https://learn.microsoft.com/en-us/azure/databricks/integrations/excel-setup |
...
| Use supported connection properties for Databricks JDBC Driver | https://learn.microsoft.com/en-us/azure/databricks/integrations/jdbc-oss/properties |
...
| Configure connections to Databricks AI Runtime | https://learn.microsoft.com/en-us/azure/databricks/machine-learning/ai-runtime/connecting |
...
| Reference for Databricks declarative feature APIs | https://learn.microsoft.com/en-us/azure/databricks/machine-learning/feature-store/declarative-api-reference |
...
| Reference available Databricks serverless environment versions | https://learn.microsoft.com/en-us/azure/databricks/release-notes/serverless/environment-version/ |
| Review system environment details for serverless environment 5 | https://learn.microsoft.com/en-us/azure/databricks/release-notes/serverless/environment-version/five |
| Inspect system environment for Serverless GPU environment 5 | https://learn.microsoft.com/en-us/azure/databricks/release-notes/serverless/environment-version/five-gpu |
| Review system environment details for serverless environment 4 | https://learn.microsoft.com/en-us/azure/databricks/release-notes/serverless/environment-version/four |
...
| Review system environment for deprecated Serverless GPU environment 3 | https://learn.microsoft.com/en-us/azure/databricks/release-notes/serverless/environment-version/three-gpu |
...
| Use OPTIMIZE to tune Delta Lake tables in Databricks | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/delta-optimize |
...
| Use ALTER PROVIDER in Databricks SQL | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/sql-ref-syntax-ddl-alter-provider |
...
| Alter table definitions in Databricks SQL | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/sql-ref-syntax-ddl-alter-table |
...
| Define column mask clauses in Databricks SQL | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/sql-ref-syntax-ddl-column-mask |
...
| Configure real-time mode for Databricks Structured Streaming | https://learn.microsoft.com/en-us/azure/databricks/structured-streaming/real-time/setup |
...
| Monitor Databricks Structured Streaming with Spark UI | https://learn.microsoft.com/en-us/azure/databricks/structured-streaming/stream-monitoring |
...
| Configure SQL constraints on Delta tables in Azure Databricks | https://learn.microsoft.com/en-us/azure/databricks/tables/constraints |
...
| Configure and run multi-statement transactions on Unity Catalog tables | https://learn.microsoft.com/en-us/azure/databricks/transactions/ |
