...
| Secure no isolation shared clusters in Databricks | https://learn.microsoft.com/en-us/azure/databricks/admin/account-settings/no-isolation-shared |
...
| Manage identities across Azure Databricks account and workspaces | https://learn.microsoft.com/en-us/azure/databricks/admin/users-groups/ |
...
| Administer user accounts in Azure Databricks workspaces | https://learn.microsoft.com/en-us/azure/databricks/admin/users-groups/users |
...
| Administer access controls for Databricks AI/BI | https://learn.microsoft.com/en-us/azure/databricks/ai-bi/admin/ |
| Manage Databricks consumer access entitlements and roles | https://learn.microsoft.com/en-us/azure/databricks/ai-bi/consumers/ |
...
| Secure ADLS access with Entra ID passthrough | https://learn.microsoft.com/en-us/azure/databricks/archive/credential-passthrough/adls-passthrough |
...
| Administer Unity Catalog with legacy CLI commands | https://learn.microsoft.com/en-us/azure/databricks/archive/dev-tools/cli/unity-catalog-cli |
...
| Configure Databricks dedicated group compute access | https://learn.microsoft.com/en-us/azure/databricks/compute/group-access |
| Understand Databricks Lakeguard user isolation model | https://learn.microsoft.com/en-us/azure/databricks/compute/lakeguard |
| Enforce fine-grained access control on Databricks compute | https://learn.microsoft.com/en-us/azure/databricks/compute/single-user-fgac |
...
| Understand Unity Catalog access control model | https://learn.microsoft.com/en-us/azure/databricks/data-governance/unity-catalog/access-control |
...
| Apply Unity Catalog row filters and column masks | https://learn.microsoft.com/en-us/azure/databricks/data-governance/unity-catalog/filters-and-masks/ |
| Manually configure Unity Catalog row filters and masks | https://learn.microsoft.com/en-us/azure/databricks/data-governance/unity-catalog/filters-and-masks/manually-apply |
| Manage Unity Catalog privileges and object access | https://learn.microsoft.com/en-us/azure/databricks/data-governance/unity-catalog/manage-privileges/ |
...
| Tag Unity Catalog securable objects for organization | https://learn.microsoft.com/en-us/azure/databricks/database-objects/tags |
...
| Create bearer-token recipients for Delta Sharing open protocol | https://learn.microsoft.com/en-us/azure/databricks/delta-sharing/create-recipient-token |
...
| Share data securely via Databricks-to-Databricks Delta Sharing | https://learn.microsoft.com/en-us/azure/databricks/delta-sharing/share-data-databricks |
| Share data using Delta Sharing open protocol from Databricks | https://learn.microsoft.com/en-us/azure/databricks/delta-sharing/share-data-open |
| Configure M2M OIDC federation Python client for Delta Sharing | https://learn.microsoft.com/en-us/azure/databricks/delta-sharing/sharing-over-oidc-m2m |
...
| Authenticate to Azure Databricks using Azure CLI | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/auth/azure-cli |
| Sign in to Azure Databricks via Azure CLI | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/auth/azure-cli-login |
| Configure Azure managed identity auth for Databricks | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/auth/azure-mi |
| Use Azure managed identities with Databricks automation | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/auth/azure-mi-auth |
| Authenticate to Azure Databricks with PowerShell | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/auth/azure-powershell-login |
| Configure Entra service principal auth for Databricks | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/auth/azure-sp |
...
| Configure OAuth federation policies for Databricks APIs | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/auth/oauth-federation-policy |
...
| Understand Databricks unified authentication configuration | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/auth/unified-auth |
...
| Configure run identity for Databricks bundle workflows | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/bundles/run-as |
...
| Manage Databricks IP access lists with CLI | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/ip-access-lists-commands |
| Manage Databricks permissions using CLI commands | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/permissions-commands |
...
| Generate temporary table credentials via Databricks CLI | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/cli/reference/temporary-table-credentials-commands |
...
| Configure Unity Catalog connections as app resources | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/databricks-apps/connections |
...
| Manage Databricks App user permissions and roles | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/databricks-apps/permissions |
...
| Add Unity Catalog volume resources with privileges | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/databricks-apps/uc-volumes |
...
| Configure auth for the Databricks VS Code extension | https://learn.microsoft.com/en-us/azure/databricks/dev-tools/vscode-ext/authentication |
| Configure secure external access to Unity Catalog | https://learn.microsoft.com/en-us/azure/databricks/external-access/admin |
| Configure Unity Catalog credential vending for external engine access | https://learn.microsoft.com/en-us/azure/databricks/external-access/credential-vending |
...
| Secure Databricks access to external MCP servers | https://learn.microsoft.com/en-us/azure/databricks/generative-ai/mcp/external-mcp |
...
| Configure Confluence OAuth U2M for Databricks ingestion | https://learn.microsoft.com/en-us/azure/databricks/ingestion/lakeflow-connect/confluence-source-setup |
| Configure GA4 and BigQuery access for Databricks ingestion | https://learn.microsoft.com/en-us/azure/databricks/ingestion/lakeflow-connect/google-analytics-source-setup |
| Configure HubSpot OAuth for Databricks ingestion | https://learn.microsoft.com/en-us/azure/databricks/ingestion/lakeflow-connect/hubspot-source-setup |
...
| Assign PostgreSQL user privileges for ingestion | https://learn.microsoft.com/en-us/azure/databricks/ingestion/lakeflow-connect/postgresql-privileges |
| Configure Run as identity for secure Lakeflow Connect pipelines | https://learn.microsoft.com/en-us/azure/databricks/ingestion/lakeflow-connect/run-as |
...
| Configure authentication for legacy Simba Databricks JDBC Driver | https://learn.microsoft.com/en-us/azure/databricks/integrations/jdbc/authentication |
...
| Design account and identity strategy for Azure Databricks | https://learn.microsoft.com/en-us/azure/databricks/lakehouse-architecture/deployment-guide/account-setup |
| Architect Unity Catalog for governed Databricks lakehouses | https://learn.microsoft.com/en-us/azure/databricks/lakehouse-architecture/deployment-guide/unity-catalog |
| Manage identities and permissions for pipelines | https://learn.microsoft.com/en-us/azure/databricks/ldp/privileges |
| Use Unity Catalog with Lakeflow pipelines | https://learn.microsoft.com/en-us/azure/databricks/ldp/unity-catalog |
...
| Secure external resource access from Databricks serving endpoints | https://learn.microsoft.com/en-us/azure/databricks/machine-learning/model-serving/store-env-variable-model-serving |
...
| Configure Lakebase Postgres project permissions and access control | https://learn.microsoft.com/en-us/azure/databricks/oltp/projects/manage-project-permissions |
...
| Configure Git provider authentication for Azure Databricks | https://learn.microsoft.com/en-us/azure/databricks/repos/get-access-tokens-from-git-provider |
...
| Manage user and group entitlements in Databricks | https://learn.microsoft.com/en-us/azure/databricks/security/auth/entitlements |
...
| Configure customer-managed keys for Databricks managed services data | https://learn.microsoft.com/en-us/azure/databricks/security/keys/cmk-managed-services-azure/ |
...
| Enable customer-managed keys for Databricks managed services via Key Vault | https://learn.microsoft.com/en-us/azure/databricks/security/keys/cmk-managed-services-azure/customer-managed-key-managed-services-azure |
| Use customer-managed keys for Databricks workspace encryption | https://learn.microsoft.com/en-us/azure/databricks/security/keys/customer-managed-keys |
| Use customer-managed keys to encrypt Databricks DBFS root | https://learn.microsoft.com/en-us/azure/databricks/security/keys/customer-managed-keys-dbfs/ |
...
| Configure HSM-backed DBFS customer-managed keys via Azure CLI | https://learn.microsoft.com/en-us/azure/databricks/security/keys/customer-managed-keys-dbfs/cmk-hsm-dbfs-azure-cli |
...
| Enable double encryption for Databricks DBFS root storage | https://learn.microsoft.com/en-us/azure/databricks/security/keys/double-encryption |
...
| Configure VNet injection for Azure Databricks workspaces | https://learn.microsoft.com/en-us/azure/databricks/security/network/classic/vnet-inject |
...
| Use IP access lists to restrict Databricks access | https://learn.microsoft.com/en-us/azure/databricks/security/network/front-end/ip-access-list |
...
| Inspect column masking metadata with INFORMATION_SCHEMA in Databricks | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/information-schema/column_masks |
...
| Manage workspace-local groups with ALTER GROUP in Databricks SQL | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/security-alter-group |
| Create workspace-local groups with Databricks SQL CREATE GROUP | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/security-create-group |
...
| Delete workspace-local groups using Databricks SQL DROP GROUP | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/security-drop-group |
| Grant privileges on Databricks securable objects with GRANT | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/security-grant |
...
| Revoke privileges on Databricks securable objects with REVOKE | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/security-revoke |
...
| Apply row filters for Unity Catalog tables | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/sql-ref-syntax-ddl-row-filter |
| Set Unity Catalog tags with required permissions | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/sql-ref-syntax-ddl-set-tag |
| Remove Unity Catalog tags with proper access | https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/sql-ref-syntax-ddl-unset-tag |
