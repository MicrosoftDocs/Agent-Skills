...
| Limits & Quotas | L104-L116 | Limits, capacity planning, supported versions, upgrade cadence, node restarts/timeouts, isolation domain requirements, and log behavior/quotas for Azure Operator Nexus. |
