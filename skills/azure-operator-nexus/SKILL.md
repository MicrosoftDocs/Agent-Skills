...
| Limits & Quotas | L104-L116 | Nexus platform capacity and version limits: storage planning, node restarts/timeouts, isolation domain requirements, supported Kubernetes/software versions, upgrade cadence, and log disruption after disconnection. |
