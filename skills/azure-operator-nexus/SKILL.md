...
description: Provides expert guidance on Azure Operator Nexus architecture, configuration, deployment, troubleshooting, security, limits, and operational best practices across bare metal, fabric networking, storage, and Nexus AKS/Kubernetes. Use this skill when designing near-edge storage and cluster topologies, selecting SKUs and VM sizes, planning capacity and redundancy, configuring BGP/VRF/ACL/QoS and isolation domains, deploying or upgrading Nexus instances and Kubernetes clusters, securing Nexus environments, or diagnosing provisioning, connectivity, performance, and hardware/software failures. Not for Azure Stack HCI, Azure VMware Solution, generic Azure Kubernetes Service, or non-Nexus telco/edge platforms.
...
|----------|-------|-------------|
| Troubleshooting | L36-L83 | Diagnosing and fixing Nexus bare-metal, storage, network, and Kubernetes issues (provisioning, connectivity, pods/VMs, hardware validation, logs, and emergency recovery actions). |
...
| Configuration | L156-L217 | Configuring and operating Nexus clusters and network fabric: JSON templates, isolation domains, BGP/VRF/route policies, ACLs, QoS, maintenance/commit workflows, monitoring, and Kubernetes settings. |
...
| Run data extract for troubleshooting Nexus bare-metal machines | https://learn.microsoft.com/en-us/azure/operator-nexus/howto-baremetal-run-data-extract |
...
| Fix Nexus AKS VM scheduling failures from topology spread | https://learn.microsoft.com/en-us/azure/operator-nexus/troubleshoot-kubernetes-cluster-vm-scheduling-topology-spread |
