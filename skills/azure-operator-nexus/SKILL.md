...
| Security | L115-L154 | Security and access control for Operator Nexus: identities, RBAC, ACLs, SSH/break-glass, key/cert/secret rotation, Defender/Policy, and secure connectivity for fabric, clusters, and VMs. |
| Configuration | L155-L217 | Configuring and operating Azure Operator Nexus: cluster and fabric templates, isolation domains, BGP/route policies, QoS, security/locks, maintenance, monitoring, and staged/commit-based changes. |
...
| Deployment | L223-L231 | Guides for upgrading and replacing Nexus fabric devices/terminal servers, running pre-validation and template-based fabric upgrades, and building/maintaining VM images for Operator Nexus. |
...
| Perform certificate rotation for Azure Operator Nexus | https://learn.microsoft.com/en-us/azure/operator-nexus/howto-certificate-rotation |
