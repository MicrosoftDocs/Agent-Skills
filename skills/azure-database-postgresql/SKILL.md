...
| Configuration | L158-L245 | Configuring Azure Database for PostgreSQL servers: parameters, extensions, logging, monitoring, HA, networking, maintenance, scaling, vector search, and migration-related settings. |
...
| Deployment | L276-L286 | CI/CD deployment to Azure PostgreSQL, infrastructure-as-code (Bicep), app deployment patterns (AKS/Django, Web Apps + VNet), upgrades, network migrations, and point-in-time restore. |
