...
description: Expert knowledge for Azure App Service development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when choosing plans/ASE, configuring auth/networking, using slots/CI-CD, Key Vault/MSI, or App Service diagnostics, and other Azure App Service related development tasks. Not for Azure Functions (use azure-functions), Azure Container Apps (use azure-container-apps), Azure Spring Apps (use azure-spring-apps), Azure Static Web Apps (use azure-static-web-apps).
...
| Configuration | L135-L192 | Configuring App Service apps: app settings, auth, networking/VNet/ASE, storage, domains/certs, containers/sidecars, language runtimes, health/monitoring, backup/restore, and environment variables. |
...
| Configure TLS/SSL versions and certificates in Azure App Service | https://learn.microsoft.com/en-us/azure/app-service/overview-tls |
...
| Configure upgrade preference for App Service Environment v3 | https://learn.microsoft.com/en-us/azure/app-service/environment/how-to-upgrade-preference |
