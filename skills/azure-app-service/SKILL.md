...
| Configuration | L137-L189 | Configuring App Service apps: app settings, networking/VNet/ASE, auth, containers/sidecars, language runtimes, scaling, storage, certificates, diagnostics, and health/monitoring. |
...
| Configure Azure Storage file shares for App Service | https://learn.microsoft.com/en-us/azure/app-service/configure-connect-to-azure-storage |
