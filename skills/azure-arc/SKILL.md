---
name: azure-arc
description: Provides expert guidance on Azure Arc architecture patterns, best practices, configuration, decision-making, deployment, integrations, limits/quotas, security, and troubleshooting across Arc-enabled servers, Kubernetes, data services, Edge RAG, and resource bridge scenarios. Use this skill when you need to design or review Arc-based hybrid/multi-cloud architectures, plan migrations, secure and monitor Arc resources, automate onboarding and operations, resolve deployment or runtime issues, or validate that your implementation aligns with supported limits and recommended patterns. Not for general Azure (non-Arc) services, on-prem-only solutions without Arc, or unrelated hybrid management products.
...
| Best Practices | L72-L79 | Best practices for Azure Arc container/edge storage: filesystem behavior, handling out-of-space scenarios, using static retain workflows, and common usage FAQs for Arc-enabled data services. |
...
| Configuration | L189-L288 | Configuring Azure Arc infrastructure and data services: storage, networking, GitOps, monitoring, Edge RAG, SQL MI, VM/server agents, extensions, policies, and portal/CLI management. |
| Integrations & Coding Patterns | L289-L311 | Programmatic and automation patterns for Azure Arc: CLI/PowerShell/ARM/SDK usage, Ansible/ConfigMgr/GPO onboarding, VM extensions, Resource Graph, Sentinel, Terraform, Event Grid, and BYOM endpoints. |
| Deployment | L312-L341 | Deploying and upgrading Azure Arc components (data controller, Edge RAG, resource bridge, SCVMM/vSphere, agents), including prerequisites, support matrices, and clean removal/migration steps. |
...
| Topic | URL |
|-------|-----|
| Handle filesystem behavior in Azure Arc container storage | https://learn.microsoft.com/en-us/azure/azure-arc/container-storage/reference-filesystem-behavior |
| Design for out-of-space behavior in Azure Arc container storage | https://learn.microsoft.com/en-us/azure/azure-arc/container-storage/reference-filesystem-out-of-space |
