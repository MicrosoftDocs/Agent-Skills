...
| Configuration | L187-L286 | Configuring Azure Arc infrastructure and services: Kubernetes, data services, Edge RAG, storage, networking, GitOps, monitoring, VM/agent settings, extensions, and portal/CLI management. |
