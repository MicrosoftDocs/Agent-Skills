...
| Configuration | L187-L286 | How to configure and manage Azure Arc infrastructure, data services, Edge RAG, Kubernetes (GitOps, cert-manager, Key Vault), networking, monitoring, and VM/agent settings. |
