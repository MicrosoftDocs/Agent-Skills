...
description: Provides expert guidance on Azure ExpressRoute design, deployment, configuration, security, integrations, limits, and troubleshooting, including routing optimization, high availability patterns, VPN coexistence, bandwidth and gateway selection, and automation with PowerShell/CLI/Terraform. Use this skill when planning or modifying ExpressRoute circuits/gateways, resolving connectivity or performance issues, implementing DR-ready topologies, enforcing security controls (IPsec/MACsec/RBAC/NAT), or validating that your design stays within supported limits and quotas. Not for generic Azure networking, public VPN-only scenarios, or non-ExpressRoute connectivity products (e.g., Azure VPN Gateway without ExpressRoute, Azure Virtual WAN, or third-party SD-WAN design).
...
| Best Practices | L42-L50 | Best practices for ExpressRoute design and operations: bandwidth upgrades, BGP community use, fixing asymmetric routing, QoS for Skype voice, and migrating to new gateways. |
| Decision Making | L51-L61 | Guidance on choosing ExpressRoute gateways, connectivity models, locations/providers, Direct, VNet options, prerequisites, migration planning, and estimating/optimizing ExpressRoute costs. |
| Architecture & Design Patterns | L62-L73 | Designing resilient, multi-site, and DR-ready ExpressRoute topologies, routing optimization, high availability, VPN coexistence/backup, and using Microsoft peering for PSTN services. |
...
| Configuration | L92-L128 | Configuring and managing ExpressRoute circuits, gateways, routing/peering, NAT, BFD, IPv6, Global Reach, monitoring, resiliency, and linking VNets using portal, PowerShell, and CLI. |
...
| Handle asymmetric routing issues with Azure ExpressRoute | https://learn.microsoft.com/en-us/azure/expressroute/expressroute-asymmetric-routing |
...
| Architect high-availability connectivity with Azure ExpressRoute | https://learn.microsoft.com/en-us/azure/expressroute/designing-for-high-availability-with-expressroute |
| Evaluate resiliency of multi-site ExpressRoute circuits | https://learn.microsoft.com/en-us/azure/expressroute/evaluate-circuit-resiliency |
...
| Reference monitoring metrics and logs for ExpressRoute | https://learn.microsoft.com/en-us/azure/expressroute/monitor-expressroute-reference |
