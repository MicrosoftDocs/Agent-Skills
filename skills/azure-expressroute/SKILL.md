...
description: Expert knowledge for Azure ExpressRoute development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when designing ExpressRoute circuits/gateways, BGP routing, FastPath, Microsoft peering, or encrypted connectivity, and other Azure ExpressRoute related development tasks. Not for Azure Internet Peering (use azure-internet-peering), Azure Virtual WAN (use azure-virtual-wan), Azure VPN Gateway (use azure-vpn-gateway), Azure Virtual Network (use azure-virtual-network).
...
| Configuration | L90-L126 | Configuring and managing ExpressRoute circuits, peerings, gateways, routing/BGP, NAT, IPv6, monitoring, resiliency, and linking VNets using portal, PowerShell, and CLI. |
...
| Deployment | L134-L141 | Guides for deploying and migrating ExpressRoute circuits/gateways, including Direct SKUs, AZ-enabled gateways, and automation with ARM templates and Terraform. |
