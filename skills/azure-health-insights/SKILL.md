...
| Configuration | L31-L43 | Configuring Health Insights containers and models, setting filters/parameters, and interpreting inference outputs for Radiology Insights, quality measures/MIPS, and Trial Matcher. |
