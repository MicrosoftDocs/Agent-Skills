...
description: Provides expert guidance on troubleshooting, best practices, decision making, limits & quotas, security, configuration, integrations, and deployment for Microsoft Foundry Tools and Azure AI Content Understanding. Use this skill when setting up or tuning Content Understanding analyzers, choosing between Foundry and related Azure AI services, planning capacity and quotas, securing and configuring endpoints, integrating via REST/.NET, or diagnosing failed or low‑quality analyses in production. Not for general Azure OpenAI, Copilot, or non‑Foundry Azure AI services that are not using Content Understanding or Foundry containers. Formerly Azure AI services.
...
| Decision Making | L47-L56 | Guidance on choosing pricing tiers, comparing Foundry vs Content Understanding/Studio modes, selecting between Content Understanding, Document Intelligence, and LLMs, and planning/migrating analyzer costs. |
| Limits & Quotas | L57-L64 | Rate limits and quotas for Foundry: autoscaling throughput, Content Moderator image/term list size and usage limits, and Content Understanding quota references. |
...
| Reference quotas and limits for Content Understanding in Foundry | https://learn.microsoft.com/en-us/azure/ai-services/content-understanding/service-limits |
