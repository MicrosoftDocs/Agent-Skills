---
name: azure-monitor
description: Expert knowledge for Azure Monitor development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when working with Log Analytics workspaces, AMA/data collection rules, alerts/autoscale, Application Insights, or KQL, and other Azure Monitor related development tasks. Not for Azure Managed Grafana (use azure-managed-grafana), Azure Network Watcher (use azure-network-watcher), Azure Service Health (use azure-service-health), Azure Defender For Cloud (use azure-defender-for-cloud).
...
|----------|----------|-------------|
| Troubleshooting | L37-L87 | Diagnosing and fixing Azure Monitor issues: agents (AMA/Log Analytics/Diagnostics), data collection/ingestion, alerts, metrics, workbooks, autoscale, ITSM connectors, and Application Insights. |
...
| Decision Making | L131-L161 | Guidance for planning and deciding Azure Monitor migrations, alert types, cost/usage models, data export options, and transitions from legacy/third‑party monitoring tools. |
...
| Limits & Quotas | L170-L231 | Limits, quotas, performance, and scale behavior for Azure Monitor logs, metrics, agents, autoscale, ingestion, queries, and per‑resource metric definitions and caps. |
| Security | L232-L289 | Securing Azure Monitor and related services: network isolation, TLS, auth (Entra, RBAC, keys), policy/compliance, private access, and analyzing security/audit logs across many Azure/3rd‑party workloads. |
| Configuration | [configuration.md](configuration.md) | Configuring Azure Monitor: agents, data collection rules, pipelines, diagnostics, alerts, autoscale, workspaces, schemas, and per‑service logs/metrics references across Azure and hybrid workloads. |
| Integrations & Coding Patterns | [integrations.md](integrations.md) | Integrating Azure Monitor with VMs, apps, Prometheus/Grafana/ITSM tools, REST/Logs Ingestion APIs, and using KQL patterns to query and analyze many Azure and security log tables. |
...
| Monitor and alert on Azure Log Analytics workspace health | https://learn.microsoft.com/en-us/azure/azure-monitor/logs/log-analytics-workspace-health |
