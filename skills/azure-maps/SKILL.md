---
name: azure-maps
description: Expert knowledge for Azure Maps development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, and integrations & coding patterns. Use when using Azure Maps web SDK, REST search/routing/weather APIs, Spatial IO, Power BI visual, or Private Link, and other Azure Maps related development tasks.
...
| Best Practices | L41-L51 | Best practices for Azure Maps apps: auth, routing and search usage, static image rendering, copyright, accessibility, and Web SDK performance optimization. |
| Decision Making | L52-L64 | Guidance on pricing, billing, and migrating maps apps to Azure Maps from Bing/Google/Power BI, including routing, imagery, search, SDS replacement, and tier selection. |
...
| Security | L81-L95 | Securing Azure Maps access: auth methods (Entra ID, SAS), SPAs/daemon/background apps, device scenarios, Power BI visual access/residency, and private endpoints with Private Link. |
...
| Migrate Bing truck routing to Azure Maps Route Directions | https://learn.microsoft.com/en-us/azure/azure-maps/migrate-calculate-truck-route |
...
| Configure Azure Maps private endpoints with Private Link | https://learn.microsoft.com/en-us/azure/azure-maps/private-endpoints |
