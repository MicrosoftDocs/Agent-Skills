---
name: azure-maps
description: Provides expert guidance on Azure Maps across troubleshooting, best practices, architecture & design, limits & quotas, security, configuration, and integrations & coding patterns. Use this skill when designing elevation and multi-itinerary routing solutions, choosing pricing tiers, securing and configuring web/mobile/Power BI map experiences, optimizing performance and accessibility, understanding service limits and coverage, or diagnosing Weather API and other Azure Maps issues. Not for Bing Maps, Google Maps, or non-Azure mapping platforms.
...
| Security | L78-L91 | Securing Azure Maps access: auth methods (keys, Entra ID, SAS), SPA/daemon/device scenarios, Power BI visual access control, and private endpoints for network isolation. |
...
| Secure Azure Maps access with Private Endpoints | https://learn.microsoft.com/en-us/azure/azure-maps/private-endpoints |
