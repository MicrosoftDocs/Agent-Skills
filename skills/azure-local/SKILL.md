---
name: azure-local
description: Expert knowledge for Azure Local development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when deploying or managing Azure Local clusters, SDN networking, Arc-enabled VMs, disconnected setups, or DR plans, and other Azure Local related development tasks. Not for Microsoft Foundry Local (use microsoft-foundry-local), Microsoft Foundry Classic (use microsoft-foundry-classic), Microsoft Foundry (use microsoft-foundry), Azure Virtual Machines (use azure-virtual-machines).
...
| Best Practices | L65-L72 | Best practices for Azure Local monitoring, VM operations, SDN-based networking, and update management, including recommended alerts, supported actions, and network/update design guidance. |
| Decision Making | L73-L86 | Guidance on Azure Local design choices: VM types, deployment scale, networking/SDN, migration, licensing/billing, and upgrade/DR planning. |
| Architecture & Design Patterns | L87-L112 | Designing Azure Local network and VM architectures, resilience/DR strategies, rack-aware and disconnected topologies, and choosing/planning specific network deployment patterns. |
| Limits & Quotas | L113-L128 | Hardware, network, IP addressing, scale, and migration prerequisites/limits for deploying and running Azure Local (including SLB HA ports and Arc-enabled VM constraints). |
| Security | L129-L173 | Security and compliance for Azure Local: standards mapping (FedRAMP, HIPAA, ISO, PCI), identity/RBAC, certificates/PKI, NSGs/firewall, Defender, ESUs, syslog/SIEM, and security baselines. |
| Configuration | L174-L269 | Configuring Azure Local clusters, networking, storage, monitoring, images, VMs (incl. Arc, GPUs, multi-rack), migrations, and connectivity (private endpoints, proxy, Arc gateway) |
| Integrations & Coding Patterns | L270-L282 | Hybrid integration patterns for Azure Local: using Arc, managed disks, images, SDN/NSGs, and PowerShell/SSH/RDP to create, manage, and connect to Azure Local VMs. |
| Deployment | L283-L318 | Deploying, scaling, updating, and repairing Azure Local clusters (rack-aware, SDN, disconnected), including prerequisites, ARM/portal deployment, upgrades, and workload migrations. |
...
| Select Azure Local rack-aware room-to-room connectivity | https://learn.microsoft.com/en-us/azure/azure-local/concepts/rack-aware-cluster-room-to-room-connectivity?view=azloc-2602 |
...
| Deploy Azure Local 23H2 with local identity and Key Vault | https://learn.microsoft.com/en-us/azure/azure-local/deploy/deployment-local-identity-with-key-vault?view=azloc-2602 |
...
| Create NSGs for Azure Local multi-rack VMs | https://learn.microsoft.com/en-us/azure/azure-local/multi-rack/multi-rack-create-network-security-groups?view=azloc-2602 |
...
| Configure SDN integration on Azure Local via PowerShell | https://learn.microsoft.com/en-us/azure/azure-local/deploy/enable-sdn-integration?view=azloc-2602 |
...
| Create Azure Arc-enabled VMs on Azure Local | https://learn.microsoft.com/en-us/azure/azure-local/multi-rack/multi-rack-create-arc-virtual-machines?view=azloc-2602 |
...
| Configure network interfaces for Azure Local VMs | https://learn.microsoft.com/en-us/azure/azure-local/multi-rack/multi-rack-create-network-interfaces?view=azloc-2602 |
...
| Manage disks and NICs for Azure Local VMs | https://learn.microsoft.com/en-us/azure/azure-local/multi-rack/multi-rack-manage-arc-virtual-machine-resources?view=azloc-2602 |
...
| Update Azure Local 23H2 systems using PowerShell | https://learn.microsoft.com/en-us/azure/azure-local/update/update-via-powershell-23h2?view=azloc-2602 |
...
| Connect to Azure Local VMs via SSH and RDP | https://learn.microsoft.com/en-us/azure/azure-local/multi-rack/multi-rack-connect-arc-vm-using-ssh?view=azloc-2602 |
