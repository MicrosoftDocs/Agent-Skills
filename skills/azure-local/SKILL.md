---
name: azure-local
description: Expert knowledge for Azure Local development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when planning Azure Local racks/SDN, Arc/Insights setup, disconnected ops, AKS/VM workloads, or DR/migration, and other Azure Local related development tasks.
...
|----------|-------|-------------|
| Troubleshooting | L37-L66 | Diagnosing and fixing Azure Local issues: health faults, SDN, registration, deployment/upgrade, disconnected ops, VM/AKS/Arc problems, log collection, and known issues/workarounds. |
...
| Decision Making | L77-L94 | Guidance on choosing Azure Local deployment type/scale, VM and licensing options, connectivity vs disconnected networking, migration/upgrade paths, and multi-rack/large datacenter planning. |
...
| Limits & Quotas | L122-L129 | System requirements, capacity limits, and supported configurations for Azure Local clusters, SLB high availability ports, and Hyper-V/VMware migration to Azure Local. |
| Security | L130-L168 | Security hardening for Azure Local: identity, RBAC, NSGs/firewall, certificates/PKI, BitLocker, Defender, logging/SIEM, attestation/trusted launch, and security updates (connected/disconnected). |
| Configuration | L169-L253 | Configuring and operating Azure Local infrastructure: networking, Arc/Insights/monitoring, GPUs, storage, VMs (incl. multi-rack & disconnected), prerequisites, health, updates, and diagnostics. |
| Integrations & Coding Patterns | L254-L264 | Guides for networking, load balancing, VM image workflows, migration, and disaster recovery for Azure Local (especially multi-rack) using CLI, PowerShell, SSH, and Azure services. |
| Deployment | L265-L288 | Deploying, scaling, upgrading, and maintaining Azure Local clusters (rack-aware, virtualized, disconnected), including Arc gateway, updates, SQL/ACR workloads, and node repair/maintenance. |
...
| Resolve common Azure Local VM migration issues | https://learn.microsoft.com/en-us/azure/azure-local/migrate/migrate-faq?view=azloc-2603 |
...
| Understand billing and licensing for disconnected Azure Local | https://learn.microsoft.com/en-us/azure/azure-local/manage/disconnected-operations-billing?view=azloc-2603 |
...
| Check system requirements for Hyper-V migration to Azure Local | https://learn.microsoft.com/en-us/azure/azure-local/migrate/migrate-hyperv-requirements?view=azloc-2603 |
| Check VMware-to-Azure Local migration system requirements | https://learn.microsoft.com/en-us/azure/azure-local/migrate/migrate-vmware-requirements?view=azloc-2603 |
...
| Apply security updates for Azure Local 23xx releases | https://learn.microsoft.com/en-us/azure/azure-local/previous-releases/security-update-23?view=azloc-2603 |
| Apply security updates for Azure Local 24xx releases | https://learn.microsoft.com/en-us/azure/azure-local/previous-releases/security-update-24?view=azloc-2603 |
...
| Meet physical network requirements for Azure Local | https://learn.microsoft.com/en-us/azure/azure-local/concepts/physical-network-requirements?view=azloc-2603 |
