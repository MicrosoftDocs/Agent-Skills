...
description: Expert knowledge for Azure Pipelines development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when designing YAML CI/CD to App Service/Kubernetes, configuring agents, Git/GitHub integration, or Key Vault secrets, and other Azure Pipelines related development tasks. Not for Azure DevOps (use azure-devops), Azure Boards (use azure-boards), Azure Repos (use azure-repos), Azure Test Plans (use azure-test-plans).
...
|----------|-------|-------------|
| Troubleshooting | L37-L47 | Diagnosing and fixing Azure Pipelines issues: service connection/auth problems, web app deployments, triggers/queued runs not starting, and analyzing logs to resolve run failures. |
...
| Security | L83-L132 | Securing Azure Pipelines: auth for agents, secrets/Key Vault, permissions/approvals, secure variables/files, repo access, workload identities, artifact policies, and code/security scanning. |
| Configuration | L133-L460 | Configuring Azure Pipelines: agents, triggers, stages/jobs/steps, variables, environments, artifacts, test/analytics, and detailed task/YAML schema options for building and deploying apps. |
| Integrations & Coding Patterns | L461-L494 | Patterns and tasks for integrating Azure Pipelines with languages, tools, Git/GitHub, Key Vault, ARM, ServiceNow, Slack, and scripting (PowerShell, logging, variables, multi-repo). |
| Deployment | L495-L586 | Agent setup and deployment guides for Azure Pipelines: installing/hosting agents, configuring CI/CD to VMs, App Service, containers, Kubernetes, databases, and publishing/consuming artifacts. |
...
| Diagnose issues with workload identity service connections | https://learn.microsoft.com/en-us/azure/devops/pipelines/release/troubleshoot-workload-identity?view=azure-devops |
...
| Troubleshoot Azure Pipelines queued but not starting | https://learn.microsoft.com/en-us/azure/devops/pipelines/troubleshooting/troubleshoot-start?view=azure-devops |
| Resolve Azure Pipelines trigger and start issues | https://learn.microsoft.com/en-us/azure/devops/pipelines/troubleshooting/troubleshoot-triggers?view=azure-devops |
...
| Manually configure workload identity ARM service connections | https://learn.microsoft.com/en-us/azure/devops/pipelines/release/configure-workload-identity?view=azure-devops |
...
| Configure Azure Pipelines BicepDeploy@0 task inputs | https://learn.microsoft.com/en-us/azure/devops/pipelines/tasks/reference/bicep-deploy-v0?view=azure-pipelines |
...
| Handle special Azure Resource Manager connection scenarios | https://learn.microsoft.com/en-us/azure/devops/pipelines/library/azure-resource-manager-alternate-approaches?view=azure-devops |
