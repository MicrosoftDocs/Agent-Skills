...
description: Provides expert guidance on Azure Logic Apps architecture patterns, best practices, troubleshooting, security, limits, integrations, configuration, decision-making, and deployment for both Standard and Consumption workflows. Use this skill when designing new Logic Apps solutions, optimizing or securing existing workflows, diagnosing failures or performance issues, planning migrations (e.g., BizTalk/Power Automate), or setting up CI/CD and governance at scale. Not for building or managing other Azure integration services like Azure Functions, Power Automate flows, or API Management directly, except where they integrate with Logic Apps.
...
|----------|-------|-------------|
| Troubleshooting | L37-L51 | Diagnosing and fixing Logic Apps failures, throttling/429s, B2B (AS2/EDIFACT/X12) acknowledgment errors, and using test/alert tools for detailed error info and workflow troubleshooting. |
| Best Practices | L52-L59 | Error handling patterns, control/advanced ruleset design, and handling non‑Unicode encodings for building robust, optimized Azure Logic Apps workflows |
| Decision Making | L60-L70 | Guidance on when and how to migrate (BizTalk, Power Automate), choose Standard vs Consumption, move apps across regions/subscriptions, and estimate/optimize Logic Apps costs. |
| Architecture & Design Patterns | L71-L87 | Patterns for AI agent workflows, B2B and API designs, resource replication, convoy/messaging, rules engine, and high availability/disaster recovery in Logic Apps. |
| Limits & Quotas | L88-L97 | Limits, quotas, and performance for Logic Apps: JavaScript inline limits, SQL result/timeout control, pagination beyond connector caps, large message chunking, config limits, and metering/billing behavior. |
| Security | L98-L114 | Securing Logic Apps with identities, OAuth/Easy Auth, private endpoints/VNets, certificates, cross-tenant and connector controls, Defender for Cloud, and Azure Policy governance. |
| Configuration | L115-L155 | Configuring Logic Apps workflows: runtime, code, control flow, B2B/integration accounts, schemas/maps, on-premises access, endpoints, and monitoring/diagnostic logging. |
| Integrations & Coding Patterns | L156-L236 | Patterns and samples for integrating Logic Apps with Azure/OpenAI, SAP/IBM/HL7/B2B, storage and messaging services, plus custom connectors, transformations, and automated testing. |
| Deployment | L237-L260 | CI/CD, ARM/Bicep, DevOps, and tooling (VS Code, CLI, PowerShell, DevOps, Deployment Center) for creating, exporting, migrating, and deploying Logic Apps (Standard & Consumption, including hybrid). |
...
| Decide how to move Logic Apps across subscriptions and regions | https://learn.microsoft.com/en-us/azure/logic-apps/move-logic-app-resources |
...
| Design disaster recovery for Logic Apps B2B integration accounts | https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-b2b-business-continuity |
...
| Understand Logic Apps Rules Engine execution and optimization | https://learn.microsoft.com/en-us/azure/logic-apps/rules-engine/rules-engine-optimization |
...
| Deploy Standard Logic Apps to private storage with private endpoints | https://learn.microsoft.com/en-us/azure/logic-apps/deploy-single-tenant-logic-apps-private-storage-account |
...
| Secure Logic Apps Standard with private endpoints and VNets | https://learn.microsoft.com/en-us/azure/logic-apps/secure-single-tenant-workflow-virtual-network-private-endpoint |
...
| Configure monitoring and tracking for B2B Logic Apps Standard | https://learn.microsoft.com/en-us/azure/logic-apps/monitor-track-b2b-transactions-standard |
...
| Understand tracking schemas for B2B Logic Apps Standard | https://learn.microsoft.com/en-us/azure/logic-apps/tracking-schemas-standard |
...
| Use Azure AI Search connector in Logic Apps | https://learn.microsoft.com/en-us/azure/logic-apps/connectors/built-in/reference/azureaisearch/ |
...
| Use Confluent Kafka connector in Logic Apps | https://learn.microsoft.com/en-us/azure/logic-apps/connectors/built-in/reference/confluentkafka/ |
...
| Use Azure OpenAI connector in Logic Apps | https://learn.microsoft.com/en-us/azure/logic-apps/connectors/built-in/reference/openai/ |
...
| Use SAP connector in Azure Logic Apps | https://learn.microsoft.com/en-us/azure/logic-apps/connectors/built-in/reference/sap/ |
...
| Create Azure OpenAI chat completions with Logic Apps prompt templates | https://learn.microsoft.com/en-us/azure/logic-apps/connectors/create-chat-completions-prompt-template |
...
| Export Logic Apps Standard workflows to VS Code | https://learn.microsoft.com/en-us/azure/logic-apps/export-standard-logic-app-to-visual-studio-code |
...
| Deploy Logic Apps Consumption workflows with ARM templates | https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-deploy-azure-resource-manager-templates |
...
| Create and manage Logic Apps via Azure CLI | https://learn.microsoft.com/en-us/azure/logic-apps/quickstart-logic-apps-azure-cli |
| Create and manage Logic Apps using PowerShell | https://learn.microsoft.com/en-us/azure/logic-apps/quickstart-logic-apps-azure-powershell |
