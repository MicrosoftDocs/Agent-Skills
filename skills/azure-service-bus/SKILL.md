...
| Security | L88-L110 | Securing Service Bus: auth with Entra ID/managed identities/SAS, encryption & CMK, TLS settings, network isolation (VNet, Private Link, firewalls), and policy/compliance configuration. |
