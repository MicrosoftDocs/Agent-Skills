...
description: Provides expert guidance on Azure Service Bus across troubleshooting, best practices, architecture & design patterns, decision making, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use this skill when designing or reviewing Service Bus-based messaging solutions, diagnosing runtime or connectivity issues, tuning performance and reliability, planning migrations or geo-DR, securing access and network boundaries, or automating deployment and configuration via ARM/Bicep/PowerShell. Not for questions about other Azure messaging services like Event Hubs, Storage Queues, or third-party brokers unless they are being compared with or integrated into Azure Service Bus.
...
| Limits & Quotas | L82-L87 | Service Bus message, entity, and namespace quotas (size, connections, topics/queues) and how throttling works, limits are enforced, and performance is affected under load. |
...
| Integrations & Coding Patterns | L135-L151 | Patterns and code for integrating Service Bus with JMS, AMQP, RabbitMQ, Event Grid/Logic Apps/Functions, subscription filters, replication, and batch message deletion. |
...
| Define Azure Service Bus subscription filters | https://learn.microsoft.com/en-us/azure/service-bus-messaging/service-bus-filter-examples |
