...
| Configuration | L63-L78 | Configuring and governing Network Watcher logging: Connection Monitor AMA setup, NSG/VNet flow logs, Traffic Analytics schemas, filters, templates, and Azure Policy enforcement. |
