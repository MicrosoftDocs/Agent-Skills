...
|----------|-------|-------------|
| Security | L25-L28 | Setting up managed identities and resource registration for Network Function Manager, including required permissions, role assignments, and identity configuration steps. |
