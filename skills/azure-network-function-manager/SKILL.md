...
|----------|-------|-------------|
| Security | L25-L28 | Configuring resource registration, managed identities, and access control needed for secure deployment and operation of Azure Network Function Manager. |
