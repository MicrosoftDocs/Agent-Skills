...
|----------|-------|-------------|
| Security | L25-L28 | Setting up resource registration, managed identities, and access control needed for secure deployment and operation of Network Function Manager resources |
