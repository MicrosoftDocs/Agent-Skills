...
| Strategy | L40-L54 | Designing cloud adoption strategies: aligning with business goals, defining motivations and teams, and planning for AI, analytics, cost, resiliency, security, and sustainability. |
...
| Readiness & Landing Zones | L75-L169 | Designing, deploying, and operating Azure landing zones: network topology, identity, subscriptions, management groups, automation/DevOps, multitenancy, and specialized app/data/analytics landing zone patterns. |
...
| Organization & Teams | L282-L302 | Designing org structures, roles, RACI, and team models (Ops, DevOps, data, security, CCoE) for cloud/AI adoption, governance, automation, and cost-conscious cloud operations |
...
| Define motivations, mission, and objectives for cloud adoption | https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/strategy/motivations |
...
| Design and implement secure connectivity from on-premises to Azure | https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/ready/azure-best-practices/connectivity-to-azure |
