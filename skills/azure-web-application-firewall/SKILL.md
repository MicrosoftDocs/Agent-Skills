...
description: Expert knowledge for Azure Web Application Firewall development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when configuring Front Door/App Gateway WAF rules, bot/CAPTCHA, Sentinel logging, APIM/Azure OpenAI protection, or IaC deployments, and other Azure Web Application Firewall related development tasks. Not for Azure Application Gateway (use azure-application-gateway), Azure Firewall (use azure-firewall), Azure Front Door (use azure-front-door), Azure DDos Protection (use azure-ddos-protection).
...
| Security | L70-L76 | Details on WAF security rules (DRS groups), bot protection features on Application Gateway, and enforcing WAF configurations and standards using Azure Policy. |
...
| Topic | URL |
|-------|-----|
| Understand Azure WAF DRS rule groups and rules | https://learn.microsoft.com/en-us/azure/web-application-firewall/afds/waf-front-door-drs |
