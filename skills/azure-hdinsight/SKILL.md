...
description: Expert knowledge for Azure HDInsight development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when working with HDInsight Spark/Hive/Kafka/HBase, Ambari, autoscale, VNet security, or CLI/PowerShell/ARM, and other Azure HDInsight related development tasks. Not for Azure Databricks (use azure-databricks), Azure Synapse Analytics (use azure-synapse-analytics), Azure Stream Analytics (use azure-stream-analytics).
...
| Decision Making | L175-L199 | Planning HDInsight capacity, storage, and VM sizes, and guidance for migrating/ upgrading Hadoop, HBase, Kafka, Ambari, and cluster versions or load balancers. |
