---
name: azure-quantum
description: Provides expert guidance on Azure Quantum architecture patterns, best practices, configuration, decision-making, deployment, integrations, limits/quotas, security, and troubleshooting across QDK, simulators, and hardware providers (IonQ, PASQAL, Quantinuum, Rigetti). Use this skill when designing hybrid quantum-classical workflows, setting up or securing Azure Quantum workspaces, choosing providers/regions/pricing, integrating QDK and external circuit formats, deploying via ARM/Bicep/CLI, or diagnosing job and connectivity issues. Not for general Azure, classical HPC, or non-Azure quantum services such as AWS Braket or IBM Quantum.
...
| Decision Making | L53-L62 | Guides for choosing regions, providers, pricing plans, dev environments, estimating quantum resources, and understanding costs/billing for Azure Quantum jobs and migrations. |
...
| Security | L75-L84 | Managing secure access to Azure Quantum workspaces: RBAC and bulk assignment, access control configuration, ARM locks, managed identities, service principals, and safe handling of access keys |
| Configuration | L85-L104 | Configuring Azure Quantum workspaces, QDK tools, simulators, and hardware targets (IonQ, PASQAL, Quantinuum, Rigetti), including resource estimator settings, noise models, and VS Code/Jupyter setup. |
...
| Decide and execute Azure Quantum workspace region migration | https://learn.microsoft.com/en-us/azure/quantum/migration-guide |
...
| Topic | URL |
|-------|-----|
| Bulk configure Azure Quantum workspace user access | https://learn.microsoft.com/en-us/azure/quantum/bulk-add-users-to-a-workspace |
