...
description: Expert knowledge for Azure Health Data Services development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when working with FHIR/DICOM/MedTech services, de-identification APIs, SMART on FHIR, or migration from Azure API for FHIR, and other Azure Health Data Services related development tasks. Not for Azure Health Bot (use azure-health-bot), Azure API Management (use azure-api-management), Azure Data Factory (use azure-data-factory), Azure Synapse Analytics (use azure-synapse-analytics).
...
| Decision Making | L57-L63 | Guidance on planning and choosing migration paths from Azure API for FHIR to FHIR service or broader Azure Health Data Services, including retirement impact and architecture decisions. |
...
| Security | L77-L117 | Configuring security for FHIR/DICOM/De-ID: Entra app registration, auth tokens, RBAC, CMK encryption, network/Private Link, external identities, SMART on FHIR, and compliance policies. |
...
| Integrations & Coding Patterns | L182-L218 | End-to-end coding patterns and API examples for integrating FHIR, DICOM, MedTech, and de-identification services with tools like cURL, SDKs, Synapse, Logic Apps, ADF, AML, Power BI, and Teams |
| Deployment | L219-L234 | How to deploy and move FHIR, DICOM, MedTech, and de-identification services using portal, ARM, Bicep, CLI, PowerShell, and configure storage/backing resources |
...
| Use bulk update API for DICOM metadata changes | https://learn.microsoft.com/en-us/azure/healthcare-apis/dicom/update-files |
