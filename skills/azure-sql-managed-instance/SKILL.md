...
description: Provides expert guidance on Azure SQL Managed Instance across troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use this skill when you need to design connectivity and networking models, choose the right MI tier/architecture, deploy or migrate (including automation/IaC), configure HA/DR, security, and monitoring, integrate applications and tools, or diagnose performance, connectivity, and operational issues specific to Managed Instance. Not for Azure SQL Database, SQL Server on VMs, or other non–Managed Instance database services.
...
|----------|-------|-------------|
| Troubleshooting | L37-L54 | Diagnosing and fixing Azure SQL MI issues: deployment/scale errors, slow import/export, performance, connectivity, geo-replication, memory/log full, XTP storage, MI link, health, and Entra Kerberos auth. |
| Best Practices | L55-L76 | Guidance on monitoring, performance tuning, HA/DR, maintenance, alerts, read replicas, batching, and migration practices for Azure SQL Managed Instance applications. |
...
| Limits & Quotas | L97-L106 | Limits, quotas, and resource caps for Azure SQL Managed Instance: DTUs, memory/In‑Memory OLTP, free-tier limits, monitoring behavior, and how to request quota increases. |
| Security | L107-L159 | Configuring Azure SQL Managed Instance security: Entra auth (users, logins, Windows/Kerberos), TLS, auditing, Defender/ATP, data protection (TDE, CMK, masking, classification), and security best practices. |
| Configuration | L160-L211 | Configuring and managing SQL Managed Instance: networking, backups/restore, maintenance windows/updates, monitoring/alerts (database watcher, metrics, logs), failover, zone redundancy, and tempdb/time zone settings. |
| Integrations & Coding Patterns | L212-L236 | Connecting apps and tools to Azure SQL Managed Instance (.NET, Java, Python, etc.), plus automation, networking, DTC, XEvents, Spark, bcp, MI Link, backup/restore, and tracing setup. |
| Deployment | L237-L258 | Deploying and managing Azure SQL Managed Instance: provisioning (Bicep/ARM/Terraform), networking, region/subnet moves, start/stop, DR/migration, replication, and operation timing/cancellation. |
...
| Configure managed identities for Azure SQL with Entra | https://learn.microsoft.com/en-us/azure/azure-sql/database/authentication-azure-ad-user-assigned-managed-identity?view=azuresql |
