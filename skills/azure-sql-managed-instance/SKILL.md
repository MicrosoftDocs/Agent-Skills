...
| Limits & Quotas | L97-L106 | Limits, quotas, and resource caps for Azure SQL Managed Instance (DTUs, memory, free tier, monitoring behavior) and how to request or plan around capacity increases. |
| Security | L107-L160 | Configuring Azure SQL Managed Instance security: Entra auth and logins, Windows/Kerberos auth, TDE and Key Vault CMK, auditing, Defender/ATP, TLS, policies, endpoints, and best practices. |
...
| Deployment | L238-L258 | Deploying and managing Azure SQL Managed Instance: provisioning (Bicep/ARM/Terraform), networking, region/subnet moves, DR/replication, migrations (Managed Instance link/BACPAC), and start/stop operations. |
