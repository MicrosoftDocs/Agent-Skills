...
description: Provides expert guidance on Azure Dedicated HSM architecture, deployment, security, troubleshooting, and migration decisions, including sizing and topology design, high availability patterns, secure networking, ExpressRoute Gateway IP configuration upgrades (Basic to Standard), physical and operational security best practices, and clarifying support boundaries between Microsoft, HSM vendors, and customers. Use this skill when planning or operating Dedicated HSM, resolving deployment/networking/configuration issues, or deciding whether to remain on Dedicated HSM or migrate to Managed/Cloud HSM. Not for general Azure Key Vault, Managed HSM, or non-Azure HSM products.
