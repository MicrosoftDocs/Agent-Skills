...
description: Expertise in Azure Managed Grafana for configuration, decision-making, deployment, integrations, limits/quotas, security, and troubleshooting. Use this skill to design, secure, and operate Azure Managed Grafana workspaces: set up instance settings, plugins, SMTP, and diagnostics; choose Enterprise plans and upgrade paths (Grafana 11/12); configure zone redundancy; integrate with Azure Monitor, Prometheus/AKS, Azure Data Explorer, Azure AI agents, and private/managed data sources; understand rendering limits and service quotas; and resolve access, configuration, and private endpoint/DNS issues. Not for generic Grafana OSS, self-hosted Grafana, or non-Azure monitoring solutions.
...
| Decision Making | L41-L47 | Guidance on choosing and managing Grafana Enterprise plans, migrating existing Grafana or dashboards into Azure Managed Grafana, and upgrading workspaces to Grafana 11. |
| Limits & Quotas | L48-L53 | Using image/report rendering features in Azure Managed Grafana and understanding its service limits, quotas, and operational constraints |
| Security | L54-L67 | Securing Managed Grafana: auth/permissions, Entra/Team Sync, roles, service accounts/tokens, private access/endpoints, outbound IPs, data encryption, and security best practices. |
| Configuration | L68-L77 | Configuring Azure Managed Grafana workspaces: instance settings, built-in MCP, plugins, metrics/diagnostics via Azure Monitor, and SMTP email alert setup. |
| Integrations & Coding Patterns | L78-L91 | Connecting Managed Grafana to Azure AI agents, workflows, Prometheus/AKS, Azure Monitor, and Data Explorer, plus configuring plugins, alerts, and private/managed data source integrations. |
| Deployment | L92-L96 | Configuring Azure Managed Grafana deployment options, including enabling zone redundancy for workspaces and upgrading existing workspaces to Grafana 12. |
...
| Topic | URL |
|-------|-----|
| Configure Azure Managed Grafana built-in MCP server | https://learn.microsoft.com/en-us/azure/managed-grafana/grafana-mcp-server |
...
| Upgrade Azure Managed Grafana workspaces to Grafana 12 | https://learn.microsoft.com/en-us/azure/managed-grafana/how-to-upgrade-grafana-12 |