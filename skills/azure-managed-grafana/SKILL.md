...
| Security | L55-L68 | Securing Managed Grafana: auth and RBAC, Entra/Team Sync, service accounts/tokens, private endpoints and outbound IPs, data encryption, Azure Monitor access, and security best practices. |
...
| Integrations & Coding Patterns | L78-L92 | Patterns and code to integrate Managed Grafana with Azure Monitor, Prometheus, App Insights, AKS, Azure AI Foundry, MCP, and Data Explorer, plus managing data source plugins and alerts. |
