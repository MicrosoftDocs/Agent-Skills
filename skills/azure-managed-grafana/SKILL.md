...
|----------|-------|-------------|
| Troubleshooting | L31-L36 | Diagnosing and resolving common Azure Managed Grafana issues, including access, configuration, and managed private endpoint connectivity and validation problems. |
| Decision Making | L37-L44 | Guidance on reliability/availability options, choosing and managing Enterprise plans, migrating between tiers or to Azure Monitor, and upgrading Managed Grafana from v10 to v11 |
| Limits & Quotas | L45-L50 | Using reporting and image rendering features in Azure Managed Grafana, plus service limits, quotas, and constraints that affect dashboards, data sources, and usage capacity. |
