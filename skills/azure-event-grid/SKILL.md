...
description: Expert knowledge for Azure Event Grid development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when configuring Event Grid domains/topics, MQTT brokers, webhooks, filters/retries, or Arc-enabled Kubernetes deployments, and other Azure Event Grid related development tasks. Not for Azure Service Bus (use azure-service-bus), Azure Event Hubs (use azure-event-hubs), Azure Notification Hubs (use azure-notification-hubs), Azure Logic Apps (use azure-logic-apps).
...
| Security | L76-L126 | Securing Event Grid and MQTT: auth with keys, Entra ID, JWT, certs and RBAC; managed identities; webhooks; IP/firewall, private endpoints, TLS; and security via Azure Policy. |
| Configuration | L127-L206 | Configuring Event Grid and MQTT: domains, topics, subscriptions, filters, delivery/retry/dead-letter, monitoring, and detailed event schemas for many Azure and Microsoft services. |
| Integrations & Coding Patterns | L207-L247 | Patterns for publishing, routing, and consuming Event Grid events with HTTP/webhooks, MQTT, Azure/M365/Security services, and partner sources like Auth0, plus schema and handler configuration. |
...
| Configure Azure RBAC roles for Event Grid access control | https://learn.microsoft.com/en-us/azure/event-grid/security-authorization |
