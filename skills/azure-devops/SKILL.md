...
| Configuration | L180-L272 | Configuring Azure DevOps and Azure DevOps Server: Managed DevOps Pools, notifications, Boards/process customization, Analytics/Power BI, dashboards, backups, networking, email, and server settings. |
