---
name: azure-devops
description: Expert knowledge for Azure DevOps development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when managing org/project structure, Boards, repos, pipelines, agent pools, Analytics/OData, or Power BI reports, and other Azure DevOps related development tasks. Not for Azure Boards (use azure-boards), Azure Pipelines (use azure-pipelines), Azure Repos (use azure-repos), Azure Test Plans (use azure-test-plans).
...
| Limits & Quotas | L99-L113 | Org/project deletion & recovery windows, user access limits, naming/work item/wiki constraints, pipeline/ARM size limits, dashboard widgets, and Analytics data availability/latency. |
| Security | L114-L174 | Managing Azure DevOps security: identities, auth, permissions, access levels, groups, auditing, project/repo/pipeline rights, server service accounts, SSL, and download integrity. |
| Configuration | L175-L258 | Configuring Azure DevOps/Server: managed pools, networking, scaling, notifications, Boards/process customization, Analytics/Power BI, dashboards, backups, SQL, services, and admin console settings. |
| Integrations & Coding Patterns | L259-L317 | Integrating Azure DevOps with tools (VS, SIEM, notifications, clients), and building Analytics/OData- and Power BI–based reports for work items, pipelines, and tests. |
| Deployment | L318-L349 | Installing, configuring, scaling, moving, backing up, restoring, and upgrading Azure DevOps Server/TFS deployments, including SQL, SharePoint, domains, and project collections |
...
| Manage users and permissions in Azure DevOps | https://learn.microsoft.com/en-us/azure/devops/organizations/accounts/faq-user-and-permissions-management?view=azure-devops |
...
| Query Azure DevOps trend data with OData aggregation | https://learn.microsoft.com/en-us/azure/devops/report/extend-analytics/querying-for-trend-data?view=azure-devops |
...
| Write OData work item queries for Azure DevOps Analytics | https://learn.microsoft.com/en-us/azure/devops/report/extend-analytics/wit-analytics?view=azure-devops |
...
| Create and configure Azure DevOps Analytics views for Power BI | https://learn.microsoft.com/en-us/azure/devops/report/powerbi/analytics-views-create?view=azure-devops |
| Create Power BI bug trend report using Azure DevOps OData | https://learn.microsoft.com/en-us/azure/devops/report/powerbi/create-quick-report-odataq?view=azure-devops |
| Build Power BI reports from Azure DevOps Analytics views | https://learn.microsoft.com/en-us/azure/devops/report/powerbi/create-quick-report?view=azure-devops |
...
| Connect to Azure DevOps Analytics with OData queries | https://learn.microsoft.com/en-us/azure/devops/report/powerbi/odataquery-connect?view=azure-devops |
