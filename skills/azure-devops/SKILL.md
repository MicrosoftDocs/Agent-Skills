---
name: azure-devops
description: Expert knowledge for Azure DevOps development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when managing org/project structure, Boards, Analytics/OData, Power BI reports, agent pools, or Azure DevOps Server, and other Azure DevOps related development tasks. Not for Azure Boards (use azure-boards), Azure Pipelines (use azure-pipelines), Azure Repos (use azure-repos), Azure Test Plans (use azure-test-plans).
...
| Security | L116-L176 | Managing Azure DevOps security: identities, auth, permissions, groups, access levels, auditing, server service accounts, SSL, and validating secure installations. |
...
| Understand Azure DevOps data storage locations | https://learn.microsoft.com/en-us/azure/devops/organizations/security/data-location?view=azure-devops |
