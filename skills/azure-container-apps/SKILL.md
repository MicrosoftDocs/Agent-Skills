...
| Configuration | L128-L172 | Configuring Container Apps behavior: networking/ingress, scaling, revisions/traffic, Dapr, Functions, logging/monitoring, Java options, storage mounts, alerts, and workload profiles. |
...
| Deployment | L196-L204 | Deploying and automating Container Apps: CI/CD with GitHub Actions/Azure Pipelines, Docker Compose migration, self-hosted runners, and Arc-enabled Kubernetes integration. |
