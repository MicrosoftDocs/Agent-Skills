...
description: Provides expert guidance on Azure Container Apps across troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use this skill when designing Java microservice architectures (including Eureka HA and AI-enabled patterns), tuning performance and cold start, configuring networking/ingress/scale/Dapr, planning capacity and costs, securing apps and data, integrating with Azure services and AI frameworks, or diagnosing runtime and deployment issues (logs, probes, image pulls, scaling). Not for Azure Kubernetes Service (AKS), Azure App Service, or non–Azure container platforms.
...
| Security | L89-L122 | Auth, identity, network, and data protection: configuring OAuth/OIDC providers, mTLS, certs, CORS, private endpoints, firewalls, WAF, secrets, managed identities, and security best practices. |
| Configuration | L123-L168 | Configuring Container Apps environments: networking, ingress, scaling (KEDA, Functions, Java), Dapr, revisions/traffic, storage, monitoring/logging/metrics, alerts, and workload profiles. |
| Integrations & Coding Patterns | L169-L195 | Patterns for connecting Container Apps to each other, Azure services, Spring components, and AI/agent frameworks (Dapr, Front Door, Service Connector, LangChain, MCP, Semantic Kernel). |
| Deployment | L196-L204 | Guides for deploying and automating Container Apps: CI/CD with GitHub Actions/Azure Pipelines, Docker Compose and Functions deployment, Arc-enabled clusters, and self-hosted runners/jobs. |
...
| Expose internal Container Apps via Front Door Premium and Private Link | https://learn.microsoft.com/en-us/azure/container-apps/front-door-custom-virtual-network-private-link |
...
| Use MCP with dynamic Python sessions in Container Apps | https://learn.microsoft.com/en-us/azure/container-apps/sessions-tutorial-python-mcp |
