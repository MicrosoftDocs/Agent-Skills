...
| Limits & Quotas | L115-L126 | Hardware, storage, IP, and scale limits for AKS Edge/Arc/Local: system requirements, supported VM sizes, cluster/node pool capacities, and official support policies and release changes |
