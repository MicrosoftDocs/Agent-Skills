...
| Limits & Quotas | L115-L126 | Hardware, storage, IP, and VM size requirements, plus scale limits, quotas, and support policies for AKS Edge Essentials, AKS on Azure Local, and AKS Arc deployments. |
...
| Configuration | L161-L241 | Configuring AKS Edge/Arc/hybrid clusters: networking, storage, load balancers, autoscaling, GPU, Windows/Linux nodes, Arc connectivity, GitOps, monitoring, upgrades, and offline installs. |
...
| Review AKS on Azure Local cluster scale limits | https://learn.microsoft.com/en-us/azure/aks/aksarc/scale-requirements |
...
| Configure GPU-enabled node pools in AKS on Azure Local | https://learn.microsoft.com/en-us/azure/aks/aksarc/deploy-gpu-node-pool |
