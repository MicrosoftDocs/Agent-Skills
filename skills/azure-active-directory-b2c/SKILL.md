...
description: Provides expert guidance on Azure Active Directory B2C architecture, configuration, security, integrations, deployment, and troubleshooting, including custom policies, user flows, MFA, and identity provider setups. Use this skill when designing or refining Azure AD B2C-based customer identity solutions, choosing patterns and regions, implementing CI/CD for policies, integrating apps/APIs, understanding limits and quotas, or diagnosing sign-in/sign-up issues. Not for Azure AD (Entra ID) workforce identity, Entra External ID for customers/partners, or non-B2C identity platforms.
...
| Decision Making | L53-L60 | Guidance on choosing app types, billing tiers, regions/data residency, supported Entra ID features, and user migration strategies for Azure AD B2C tenants |
...
| Limits & Quotas | L70-L77 | Service limits, tenant and directory size quotas, token formats/constraints, and guidance on creating tenants within Azure AD B2C capacity and restriction boundaries. |
...
| Configuration | L95-L210 | Configuring Azure AD B2C policies, user flows, tokens, MFA, identity providers, apps/APIs, UI/UX, localization, and advanced auth options for web, SPA, mobile, and desktop clients. |
...
| Configure custom HTML templates for Azure AD B2C UI | https://learn.microsoft.com/en-us/azure/active-directory-b2c/customize-ui-with-html |
