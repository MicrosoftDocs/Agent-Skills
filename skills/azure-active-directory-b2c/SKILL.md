...
description: Expert knowledge for Azure Active Directory B2C development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when designing B2C user flows/custom policies, app registrations, MFA/IdP setup, CI/CD deployments, or Sentinel logging, and other Azure Active Directory B2C related development tasks. Not for Azure Information Protection (use azure-information-protection), Azure Role-based access control (use azure-rbac), Azure Security (use azure-security), Azure Virtual Desktop (use azure-virtual-desktop).
...
| Configuration | L96-L210 | Configuring Azure AD B2C policies, user flows, tokens, identity providers, MFA, app registrations, UI/localization, and advanced auth options for web, SPA, mobile, and API scenarios. |
