...
| Configuration | L96-L210 | Configuring Azure AD B2C policies, user flows, tokens, identity providers, MFA, custom UI, app/API registration, and advanced auth options for web, SPA, mobile, and desktop apps. |
