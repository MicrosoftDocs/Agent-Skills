...
| Configuration | L64-L76 | Configuring Chaos Studio: deploy agents/targets via ARM/Bicep, set fault/action parameters, integrate with Azure Monitor/Workbooks/Policy, and verify OS/tool compatibility. |
