...
| Configuration | L64-L76 | Configuring Chaos Studio: deploy agents/targets via ARM/Bicep/Policy, define experiments and parameters, set up monitoring with Azure Monitor/Workbooks, and verify OS/tool compatibility. |
...
| Use Azure Policy to add Chaos Studio targets | https://learn.microsoft.com/en-us/azure/chaos-studio/sample-policy-targets |
