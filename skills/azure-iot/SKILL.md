...
|----------|-------|-------------|
| Decision Making | L31-L36 | Guidance on designing Azure Device Registry namespaces and schema registries for IoT, including structure, organization, and planning of device data models. |
