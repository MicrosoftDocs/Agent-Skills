...
| Configuration | L58-L70 | How to configure and manage Private Link/endpoint behavior: subnet policies, routing, DNS, SNAT, security perimeters, and monitoring/diagnostic logs. |
