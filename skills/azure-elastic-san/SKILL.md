...
description: Expert knowledge for Azure Elastic SAN development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, and integrations & coding patterns. Use when creating iSCSI volumes, tuning AVS datastores, using snapshots, CMK encryption, or AKS/clustered app storage, and other Azure Elastic SAN related development tasks. Not for Azure Blob Storage (use azure-blob-storage), Azure NetApp Files (use azure-netapp-files), Azure Managed Lustre (use azure-managed-lustre), Azure Files (use azure-files).
...
| Best Practices | L41-L47 | Guidance on tuning Elastic SAN performance (including AVS datastores) and using volume snapshots for backup, recovery, and data protection. |
...
| Limits & Quotas | L58-L63 | Performance, scalability, capacity, and throughput limits for Azure Elastic SAN and attached VMs, including IOPS/MBps caps, volume/host scale, and how these limits affect workload design. |
...
| Configuration | L74-L82 | Configuring, resizing, deleting, and monitoring Azure Elastic SANs and volumes, plus managing iSCSI/IQN naming transitions and best practices for safe lifecycle operations. |
...
| Azure Elastic SAN scalability, capacity, and performance limits | https://learn.microsoft.com/en-us/azure/storage/elastic-san/elastic-san-scale-targets |
...
| Transition IQN naming authority for Azure Elastic SAN | https://learn.microsoft.com/en-us/azure/storage/elastic-san/elastic-san-transition-iqn-naming-authority |
