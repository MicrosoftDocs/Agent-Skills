...
description: Expert knowledge for Microsoft Foundry Classic (aka Azure AI Foundry classic) development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when building Foundry classic agents, RAG with Azure OpenAI, multi-agent topologies, secure hubs, or CI/CD deployments, and other Microsoft Foundry Classic related development tasks. Not for Microsoft Foundry (use microsoft-foundry), Microsoft Foundry Local (use microsoft-foundry-local), Microsoft Foundry Tools (use microsoft-foundry-tools).
...
|----------|-------|-------------|
| Troubleshooting | L37-L47 | Diagnosing and fixing Foundry classic issues: compute/Prompt Flow limits, deployments and monitoring, private endpoints, Azure OpenAI fine-tuning, and Risks & Safety errors. |
| Best Practices | L48-L62 | Best practices for safe, resilient, low-latency AI agents: system messages, safety evals, DeepSeek-R1, GPT-4V fine-tuning, On Your Data, and chat app evaluation/optimization. |
| Decision Making | L63-L92 | Guidance on choosing models, regions, deployments, costs, PTU, lifecycle/migration, and rollout strategy to make architecture and upgrade decisions for Foundry and Azure OpenAI. |
| Architecture & Design Patterns | L93-L100 | Architectural guidance for Foundry: multi-agent design, service/resource topology, high availability, and full BCDR (backup, recovery, DR, and resiliency) for Agent Service and Azure OpenAI workloads |
| Limits & Quotas | L101-L115 | Quotas, rate limits, and regional support for Foundry Agents, Models, Azure OpenAI (incl. dynamic/global batch), and how to view, manage, and request increased usage limits. |
| Security | L116-L162 | Securing Foundry and Azure OpenAI: auth/RBAC, keys, networks/Private Link, Azure Policy guardrails, data handling/privacy, safety filters, and secure hub/project/tool configurations. |
| Configuration | L163-L214 | Configuring and monitoring Foundry classic: agents, models, evaluators, networking, storage, compute, tracing, safety, RAG, and Azure OpenAI deployments, metrics, and logging. |
| Integrations & Coding Patterns | L215-L336 | Patterns and code for integrating Foundry and Azure OpenAI with tools, data sources, search/grounding, evaluations, SDKs, real‑time audio, fine-tuning, and external frameworks like LangChain. |
| Deployment | L337-L355 | Deploying Foundry hubs, models, agents, and prompt flows via portal/CLI/Bicep/Terraform, using managed/serverless compute, CI/CD evaluations, and checking regional feature availability. |
...
| Diagnose and work around Microsoft Foundry classic issues | https://learn.microsoft.com/en-us/azure/foundry-classic/reference/foundry-known-issues |
...
| Design resilient, highly available Foundry classic agents | https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/high-availability-resiliency |
...
| Handle deprecation of managed compute Foundry models | https://learn.microsoft.com/en-us/azure/foundry-classic/concepts/model-retirement-managed-compute |
...
| Use Foundry model retirement schedule for migration planning | https://learn.microsoft.com/en-us/azure/foundry-classic/openai/concepts/model-retirement-schedule |
...
| Rate limits and regional support for Foundry evaluations (classic) | https://learn.microsoft.com/en-us/azure/foundry-classic/concepts/evaluation-regions-limits-virtual-network |
...
| Configure environment for Foundry Agent Service classic | https://learn.microsoft.com/en-us/azure/foundry-classic/agents/environment-setup |
