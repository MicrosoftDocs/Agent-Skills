...
| Decision Making | L67-L97 | Guidance on choosing and upgrading models, regions, SKUs, and SDKs; planning costs, governance, BCDR, migrations, and handling model lifecycle, deprecation, and fine-tuning in Foundry. |
...
| Limits & Quotas | L104-L117 | Quotas, rate limits, and regional availability for Foundry agents, models, and Azure OpenAI; how to view, manage, increase, and use dynamic/batch capacity for large-scale workloads |
...
| Configuration | L165-L210 | Configuring and monitoring Foundry: agent service infra, model deployments, tools (RAG, evals, tracing), storage/network, Azure OpenAI settings, and cross-project/hub resources. |
| Integrations & Coding Patterns | L211-L324 | Patterns and code to integrate Foundry and Azure OpenAI models/agents with tools, data sources, SDKs, search/grounding, evaluations, real‑time audio, and external services. |
...
| Plan PTU costs and capacity for Foundry provisioned throughput | https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/provisioned-throughput-onboarding |
...
| Reference Azure OpenAI quotas and limits in Foundry classic | https://learn.microsoft.com/en-us/azure/foundry-classic/openai/quotas-limits |
...
| Implement Azure OpenAI Responses API with Python and REST | https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/responses |
