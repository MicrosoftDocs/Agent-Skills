...
description: Expert knowledge for Microsoft Foundry Classic (aka Azure AI Foundry classic) development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when building Foundry agents/models with RAG, tools, evaluators, tracing, Azure OpenAI, or multi-agent routing, and other Microsoft Foundry Classic related development tasks. Not for Microsoft Foundry (use microsoft-foundry), Microsoft Foundry Local (use microsoft-foundry-local), Microsoft Foundry Tools (use microsoft-foundry-tools).
...
| Decision Making | L60-L93 | Guides for choosing models, regions, SDKs, costs, PTU, and deployment types, plus when to fine-tune, upgrade/migrate, handle deprecations, and evaluate partner/community models. |
| Architecture & Design Patterns | L94-L104 | Architectural guidance for Foundry: multi-agent design, model router, HA/resiliency, and full BCDR planning and recovery for Agent Service and Azure OpenAI workloads |
| Limits & Quotas | L105-L120 | Quotas, rate limits, timeouts, and capacity management for Foundry Agents, Foundry Models, Azure OpenAI (incl. batch, dynamic quota, fine-tuning), and how to request or increase limits. |
| Security | L121-L164 | Security, networking, auth, RBAC, keys, policies, and data privacy for Foundry hubs/projects, tools (browser/computer use, Content Safety), and Azure OpenAI/model deployments |
| Configuration | L165-L224 | Configuring, monitoring, and evaluating Foundry agents and models: hosts, compute, storage, RAG, tools, evaluators, tracing, safety, OpenAI setup, and continuous quality monitoring. |
| Integrations & Coding Patterns | L225-L346 | Patterns and code to integrate Foundry and Azure OpenAI models/agents with tools, data sources, search/grounding, evaluations, real‑time/audio, and external apps/services. |
| Deployment | L347-L368 | Deploying Foundry hubs, projects, and models (managed/serverless) using Bicep, Terraform, CLI/SDK/portal, plus CI/CD pipelines and region/feature availability. |
...
| Plan and manage Microsoft Foundry classic costs | https://learn.microsoft.com/en-us/azure/foundry-classic/concepts/manage-costs |
...
| Use priority processing tiers for Foundry models | https://learn.microsoft.com/en-us/azure/foundry-classic/openai/concepts/priority-processing |
...
| Azure OpenAI FAQ on limits, models, and usage | https://learn.microsoft.com/en-us/azure/foundry-classic/openai/faq |
...
| Configure and use custom block lists in Azure OpenAI | https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/use-blocklists |
...
| Deploy and call Anthropic Claude models in Foundry | https://learn.microsoft.com/en-us/azure/foundry-classic/foundry-models/how-to/use-foundry-models-claude |
...
| Integrate Foundry Assistants with Azure Logic Apps workflows | https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/assistants-logic-apps |
...
| Use Azure OpenAI deep research with Responses API | https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/deep-research |
...
| Integrate and call Foundry model router deployments | https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/model-router |
...
| Configure web_search tool in Azure OpenAI Responses API | https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/web-search |
