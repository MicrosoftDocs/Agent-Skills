...
description: Provides expert guidance on Azure Defender for IoT across troubleshooting, best practices, decision making, architecture patterns, limits/quotas, security, configuration, integrations, and deployment for OT/ICS and IoT environments. Use this skill when planning or designing Defender for IoT architectures (including Purdue-aligned topologies), configuring or deploying OT sensors and micro agents, integrating with SIEM/Sentinel and IT/OT tools, securing access and operations, understanding quotas and data retention, or diagnosing sensor/agent and alert issues. Not for Microsoft Defender for Cloud, Defender for Endpoint, or non–Defender for IoT security products.
...
| Limits & Quotas | L76-L84 | Info on OT trial setup, supported/retiring features, OT appliance catalog and requirements, and Defender for IoT data retention and storage limits. |
