---
name: azure-rbac
description: Expert knowledge for Azure Role-based access control development including troubleshooting, best practices, decision making, limits & quotas, security, configuration, and integrations & coding patterns. Use when managing Azure RBAC roles/ABAC, deny assignments, PIM, policy integration, or role assignments via CLI/ARM, and other Azure Role-based access control related development tasks. Not for Azure Active Directory B2C (use azure-active-directory-b2c), Azure Information Protection (use azure-information-protection), Azure Policy (use azure-policy), Azure Security (use azure-security).
...
| Security | L65-L130 | Azure RBAC roles, permissions, and conditions: built-in role references by service, custom roles, ABAC, deny assignments, PIM, delegation, policy integration, and security/privileged access controls. |
