...
| Decision Making | L61-L91 | Guides for choosing models, regions, hubs, SKDs, and deployment types, plus cost, throughput, migration, HA/DR, and deprecation planning for Foundry and Azure OpenAI. |
...
| Integrations & Coding Patterns | L204-L299 | Patterns and code to integrate Azure/OpenAI/Foundry models and agents with tools, data sources, RAG, function calling, realtime audio, tracing, and SDKs like LangChain, SK, and LlamaIndex. |
| Deployment | L300-L321 | Deploying and managing Foundry hubs, projects, and models (base, partner, fine-tuned) via CLI/Bicep/Terraform/SDK, serverless APIs, CI/CD, and checking regional/feature availability. |
...
| Plan PTU costs and billing for Azure AI Foundry | https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/provisioned-throughput-onboarding?view=foundry-classic |
...
| Generate and edit images with Azure OpenAI models | https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/dall-e?view=foundry-classic |
...
| Implement function calling with Azure OpenAI chat | https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/function-calling?view=foundry-classic |
