---
name: azure-industry
description: Expert knowledge for Azure Industry development including troubleshooting, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when configuring Community Training portals, Teams embedding, Azure AD/B2C auth, Android app builds, or UI languages, and other related development tasks.
