...
description: Expert knowledge for Azure Foundry Classic development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when building Foundry hubs/agents, Azure OpenAI deployments, RAG/On Your Data apps, guardrails, or CI/CD flows, and other related development tasks. Not for Microsoft Foundry (use azure-microsoft-foundry), Azure AI Foundry Local (use azure-ai-foundry-local), Azure Machine Learning (use azure-machine-learning).
