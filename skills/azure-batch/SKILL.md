---
name: azure-batch
description: Expert knowledge for Azure Batch development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when configuring Batch pools/tasks, autoscale, CI/CD job deployments, SDK/CLI workflows, or render/MPI workloads, and other Azure Batch related development tasks. Not for Azure Virtual Machines (use azure-virtual-machines), Azure Virtual Machine Scale Sets (use azure-vm-scalesets), Azure Kubernetes Service (AKS) (use azure-kubernetes-service), Azure Container Instances (use azure-container-instances).
...
| Configuration | L99-L137 | Configuring Batch pools, tasks, networking, containers, autoscale, monitoring/diagnostics, and storage mounts, plus metrics/events and .NET management for Batch account and pool settings |
