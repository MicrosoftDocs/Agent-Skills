...
description: Expert knowledge for Azure VPN Gateway development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when configuring S2S/P2S tunnels, BGP routing, IPsec/IKE policies, Entra/RADIUS auth, or cross-cloud VPNs, and other Azure VPN Gateway related development tasks. Not for Azure Virtual Network (use azure-virtual-network), Azure Virtual WAN (use azure-virtual-wan), Azure ExpressRoute (use azure-expressroute), Azure Application Gateway (use azure-application-gateway).
...
| Decision Making | L50-L59 | Guidance on choosing VPN Gateway SKUs, planning SKU/IP migrations, mapping old to new SKUs, and migrating/architecting P2S and Classic-to-ARM VPN gateways for remote access. |
...
| Decide and plan VPN Gateway public IP SKU migration | https://learn.microsoft.com/en-us/azure/vpn-gateway/basic-public-ip-migrate-about |
