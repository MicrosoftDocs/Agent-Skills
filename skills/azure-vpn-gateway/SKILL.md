...
description: Provides expert guidance on Azure VPN Gateway architecture, configuration, security, deployment, integrations, limits, and troubleshooting, including S2S/P2S setup, BGP/IPsec design, SKU selection, and connectivity with on-premises and other clouds. Use this skill when planning or operating Azure VPN Gateway-based hybrid or remote access solutions, diagnosing connection or performance issues, hardening VPN security, or deciding between gateway SKUs and topologies for high availability and scale. Not for Azure Virtual Network Manager, Azure Virtual WAN, third-party VPN appliances, or non-Azure VPN products.
...
| Decision Making | L50-L58 | Guidance on choosing VPN Gateway SKUs, understanding SKU mappings, migrating P2S/SSTP and Classic gateways, and planning remote work scenarios using P2S VPN gateways |
...
| Deployment | L162-L175 | Deploying and configuring Azure VPN Gateways: create/migrate gateways and public IP SKUs, switch active/active-active, set up S2S VPNs, and deploy VPN client profiles via Intune. |
...
| Topic | URL |
|-------|-----|
| Select appropriate Azure VPN Gateway SKUs | https://learn.microsoft.com/en-us/azure/vpn-gateway/about-gateway-skus |
