...
description: Expert knowledge for Azure Database for MySQL development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when using MySQL Flexible Server HA/replicas, VNet/Private Link, backups/restore, CI/CD deploys, or AKS connectivity, and other Azure Database for MySQL related development tasks. Not for Azure Database for MariaDB (use azure-database-mariadb), Azure Database for PostgreSQL (use azure-database-postgresql), Azure SQL Database (use azure-sql-database), Azure SQL Managed Instance (use azure-sql-managed-instance).
...
| Decision Making | L72-L89 | Planning MySQL on Azure: version lifecycle, HA/BCDR, sizing and tiers, performance features, and end-to-end migration/upgrade strategies and tooling. |
| Architecture & Design Patterns | L90-L98 | Patterns for connecting AKS to MySQL Flexible Server, designing backup/restore, data-in/out replication, high availability (zone-redundant), and read-replica-based scaling. |
