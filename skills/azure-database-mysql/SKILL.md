...
description: Expert knowledge for Azure Database for MySQL development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when using MySQL Flexible Server HA/replicas, VNet/Private Link, backups/geo-restore, Entra auth, or CI/CD deployments, and other Azure Database for MySQL related development tasks. Not for Azure Database for MariaDB (use azure-database-mariadb), Azure Database for PostgreSQL (use azure-database-postgresql), Azure SQL Database (use azure-sql-database), Azure SQL Managed Instance (use azure-sql-managed-instance).
...
| Decision Making | L72-L89 | Guidance on MySQL version/HA choices, sizing and reserved capacity, performance features, and planning/choosing methods for low-downtime migration to Azure Database for MySQL |
...
| Topic | URL |
|-------|-----|
| Plan MySQL version lifecycle on Azure Database for MySQL | https://learn.microsoft.com/en-us/azure/mysql/concepts-version-policy |
