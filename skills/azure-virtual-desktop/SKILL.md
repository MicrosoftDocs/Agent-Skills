...
description: Provides expert guidance on Azure Virtual Desktop architecture, deployment, configuration, security, integrations, limits, troubleshooting, and operational best practices across host pools, FSLogix, autoscale, networking, Teams, and identity. Use this skill when designing or optimizing AVD environments, deciding on cost and deployment models, configuring features (e.g., GPU, RDP, SSO, Conditional Access), integrating automation or partner solutions, or diagnosing performance, connectivity, or session host issues. Not for on-premises Remote Desktop Services, Windows 365 Cloud PC, or non-Azure virtual desktop products.
...
| Limits & Quotas | L90-L95 | Guidance on RDP bandwidth requirements and Microsoft Teams feature support/limitations when running Teams in Azure Virtual Desktop environments. |
...
| Configuration | L115-L174 | Configuring AVD environments: images, autoscale, licensing, networking, RDP/redirection, Teams/OneDrive/M365, GPU, language packs, updates, security, and client/RemoteApp settings. |
...
| Supported Microsoft Teams features on Azure Virtual Desktop | https://learn.microsoft.com/en-us/azure/virtual-desktop/teams-supported-features |
