...
| Security | L95-L113 | Securing AVD access and sessions: SSO (Entra ID/AD FS), MFA/Conditional Access, RBAC/delegated admin, managed identities, external identities, clipboard/screen/watermark controls, WebAuthn, Kerberos, and Purview. |
