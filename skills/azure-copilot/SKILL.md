---
name: azure-copilot
description: Provides expert guidance on using Azure Copilot for troubleshooting, decision making, architecture & design patterns, security, configuration, and integrations & coding patterns across Azure workloads. Use this skill when you need to design or validate Azure network architectures, configure Cosmos DB for Copilot conversation storage, compare cost‑efficient Azure options, generate or refine infra-as-code and automation artifacts, secure Copilot-related resources and access, or diagnose issues in App Service, Functions, and VM disk performance. Not for general-purpose coding assistants or non-Azure cloud platforms.
...
| Configuration | L64-L68 | How to set up and configure Azure Cosmos DB as the storage backend for Azure Copilot conversation history and related data. |
