...
description: Expert knowledge for Azure Service Connector development including troubleshooting, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when wiring apps to Azure DBs, messaging, storage, Key Vault, OpenAI, or managing auth, regions, and IaC for connections, and other Azure Service Connector related development tasks. Not for Azure API Management (use azure-api-management), Azure App Service (use azure-app-service), Azure Functions (use azure-functions), Azure Logic Apps (use azure-logic-apps).
...
| Security | L44-L49 | Details on what Microsoft Entra roles and resource permissions Service Connector assigns or requires, and how those affect secure access to connected Azure services. |
...
| Service Connector required permissions for Azure resources | https://learn.microsoft.com/en-us/azure/service-connector/concept-permission |
