...
| Integrations & Coding Patterns | L57-L85 | How to connect apps to Azure and external data/services (Cosmos DB variants, SQL, PostgreSQL/MySQL, storage, messaging, AI, Redis, Kafka, MongoDB, Key Vault) using Service Connector patterns |
| Deployment | L86-L90 | Info on where Service Connector is regionally supported per compute service and how to create connections using infrastructure-as-code tools. |
