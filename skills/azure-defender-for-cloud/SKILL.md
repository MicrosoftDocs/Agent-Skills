...
description: Provides expert guidance on Microsoft Azure Defender for Cloud, covering troubleshooting, best practices, decision-making, architecture patterns, limits/quotas, security, configuration, integrations, and deployment across servers, containers, SQL, storage, and multi‑cloud connectors. Use this skill when planning or optimizing Defender for Cloud deployments, investigating or tuning alerts and recommendations, integrating with SIEM/DevOps tools, or deciding between agent-based and agentless approaches at scale. Not for Microsoft Defender XDR, Microsoft Sentinel, or non‑Azure cloud security products outside Defender for Cloud’s supported integrations.
...
| Best Practices | L63-L79 | Best-practice workflows for investigating and remediating misconfigurations, vulnerabilities, secrets, and API/endpoint/container risks in Defender for Cloud, plus governance and networking guidance. |
| Decision Making | L80-L96 | Guidance on choosing and configuring Defender for Cloud plans, cost models, portals, and deployment options (servers, containers, storage, GCP), including migration and agent retirement decisions |
| Architecture & Design Patterns | L97-L107 | Architectural guidance for Defender for Servers/Containers: agentless scanning, malware/vuln detection on VMs/Kubernetes, data collection, residency, workspaces, and large-scale deployment. |
| Limits & Quotas | L108-L118 | Limits, quotas, and prerequisites for Defender for Cloud features: free trials, data ingestion, APIs, DevOps, portal preview, alert export limits, and data collection extension changes. |
| Security | L119-L196 | Security alerts, permissions, and hardening guidance for Defender for Cloud across VMs, containers, storage, SQL, APIs, Kubernetes, multi-cloud connectors, and security recommendations. |
| Configuration | L197-L265 | Configuring Defender for Cloud features: onboarding, policies, alerts, exports, exemptions, DevOps/containers/SQL/storage scanning, data security posture, and agentless/VM security settings. |
| Integrations & Coding Patterns | L266-L293 | Integrating Defender for Cloud with SIEMs, DevOps, APIs, and third‑party tools (ServiceNow, Power BI, EDR, AWS/GCP), plus ARG queries, exports, and automation patterns. |
| Deployment | L294-L324 | Deploying and configuring Defender for Cloud plans (Containers, SQL, Storage, Servers) across AKS/EKS/GKE and hybrid, via portal, CLI, IaC, policy, REST, and migration/compatibility checks |
...
| Configure governance rules for Defender for Cloud remediation | https://learn.microsoft.com/en-us/azure/defender-for-cloud/governance-rules |
...
| Configure Defender for Cloud threat protection for AI | https://learn.microsoft.com/en-us/azure/defender-for-cloud/ai-onboarding |
...
| Configure Exemptions for Container Vulnerability Findings | https://learn.microsoft.com/en-us/azure/defender-for-cloud/disable-vulnerability-findings-containers |
...
| Enable Defender Vulnerability Assessment for Containers | https://learn.microsoft.com/en-us/azure/defender-for-cloud/enable-vulnerability-assessment |
