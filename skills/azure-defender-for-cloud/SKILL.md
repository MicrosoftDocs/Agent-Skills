...
|----------|-------|-------------|
| Troubleshooting | L37-L66 | Diagnosing and fixing Defender for Cloud issues: alert validation/interpretation, connector/onboarding problems (AWS/GCP/APIs/SQL/K8s), deployment gaps, malware/vuln handling, and incident references. |
| Best Practices | L67-L86 | Hands-on guides for investigating and remediating Defender for Cloud security findings: misconfigurations, vulnerabilities, secrets, APIs, endpoints, networking, and container/Kubernetes images |
| Decision Making | L87-L105 | Guides for choosing and planning Defender for Cloud features: plan selection, cost/chargeback, deployment options, migrations (e.g., Storage, Servers), regions, and agent retirement. |
| Architecture & Design Patterns | L106-L114 | Architectural guidance for Defender for Servers/Containers: agentless scanning, malware/vuln detection on VMs/Kubernetes, data collection, residency, workspaces, and large-scale deployment. |
...
| Security | L125-L202 | Security alerts, recommendations, and permissions for Defender for Cloud: configuring protections (VMs, containers, storage, SQL, APIs, AI), CIEM/RBAC, data handling, and investigating/remediating threats |
| Configuration | L203-L268 | Configuring Defender for Cloud features and integrations: enabling plans, scanners, alerts, exports, exemptions, DevOps/containers/SQL/storage settings, and cross-tenant or private-link connectivity. |
| Integrations & Coding Patterns | L269-L299 | Integrating Defender for Cloud with CI/CD, SIEM, EDR, ticketing, cloud logs, partner scanners, exporting data via APIs/ARG, and automating onboarding, queries, and container/SQL scans. |
| Deployment | L300-L327 | Deploying, enabling, scaling, and removing Defender for Cloud plans (Containers, SQL, Storage, Servers) across AKS/EKS/GKE and VMs using portal, CLI, IaC, policy, Helm, and APIs. |
...
| Resolve common Microsoft Defender for Cloud issues | https://learn.microsoft.com/en-us/azure/defender-for-cloud/faq-general |
...
| Prioritize and remediate machine secrets in Defender for Cloud | https://learn.microsoft.com/en-us/azure/defender-for-cloud/remediate-server-secrets |
...
| Query security risks with cloud security explorer | https://learn.microsoft.com/en-us/azure/defender-for-cloud/how-to-manage-cloud-security-explorer |
...
| Configure JIT access and application control for Azure VMs | https://learn.microsoft.com/en-us/azure/defender-for-cloud/tutorial-protect-resources |
...
| Enable Defender for open-source Azure databases | https://learn.microsoft.com/en-us/azure/defender-for-cloud/enable-defender-for-databases-azure |
...
| Automate Defender for Cloud onboarding with PowerShell | https://learn.microsoft.com/en-us/azure/defender-for-cloud/powershell-onboarding |
...
| Containers support matrix for Defender for Cloud | https://learn.microsoft.com/en-us/azure/defender-for-cloud/support-matrix-defender-for-containers |
