...
|----------|-------|-------------|
| Decision Making | L25-L28 | Guidance on selecting NC2 on Azure regions and hardware SKUs, including availability, capacity, and configuration considerations for BareMetal Infrastructure deployments. |
