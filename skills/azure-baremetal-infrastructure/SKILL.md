...
|----------|-------|-------------|
| Decision Making | L25-L28 | Guidance on selecting NC2 on Azure regions and bare metal SKUs, including capacity, performance, and placement considerations for Nutanix Cloud Clusters on Azure. |
