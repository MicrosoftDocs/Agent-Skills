...
description: Expert knowledge for Azure Translator development including troubleshooting, best practices, decision making, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when using Translator REST/SDK APIs, Docker containers, custom models, glossaries, or Document Translation, and other Azure Translator related development tasks. Not for Azure AI Language (use azure-language-service), Azure AI Speech (use azure-speech), Azure AI Immersive Reader (use azure-immersive-reader).
...
| Integrations & Coding Patterns | L97-L135 | Using Translator REST/SDK APIs, containers, and Power Automate for text/document translation, custom models, preview features, status management, and language/dictionary utilities |
...
| Decide and migrate from Translator v3 to preview API | https://learn.microsoft.com/en-us/azure/ai-services/translator/text-translation/how-to/migrate-to-preview |
...
| Use transliterate text parameters in Translator containers | https://learn.microsoft.com/en-us/azure/ai-services/translator/containers/transliterate-text-parameters |
| Configure adaptive custom translation API in Foundry | https://learn.microsoft.com/en-us/azure/ai-services/translator/custom-translator/azure-ai-foundry/concepts/adaptive-custom-translation |
...
| Integrate with Document translation REST API methods | https://learn.microsoft.com/en-us/azure/ai-services/translator/document-translation/reference/rest-api-guide |
...
| Use text translation preview REST APIs in Foundry Tools | https://learn.microsoft.com/en-us/azure/ai-services/translator/text-translation/preview/rest-api-guide |
| Call the Azure Translator preview translate REST method | https://learn.microsoft.com/en-us/azure/ai-services/translator/text-translation/preview/translate-api |
| Invoke the Azure Translator preview transliterate REST method | https://learn.microsoft.com/en-us/azure/ai-services/translator/text-translation/preview/transliterate-api |
