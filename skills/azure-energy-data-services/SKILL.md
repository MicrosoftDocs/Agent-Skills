...
description: Provides expert guidance on architecting, configuring, securing, integrating, deploying, and troubleshooting Azure Energy Data Services (Azure Data Manager for Energy/OSDU) environments, including HA/DR patterns, tier selection, DDMS enablement, auth/ACLs/legal tags, and diagnosing manifest ingestion issues via Airflow logs. Use this skill when designing or reviewing ADME architectures, setting up or tuning configurations, integrating external data sources and monitoring, planning deployments (e.g., Geospatial CZ, Admin UI), or resolving ingestion and platform issues. Not for generic Azure data platforms (e.g., Synapse, Fabric, Databricks) or non-OSDU energy solutions.
