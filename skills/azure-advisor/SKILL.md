---
name: azure-advisor
description: Provides expert guidance on using Azure Advisor for best practices, decision making, configuration, limits & quotas, security, and integrations & coding patterns, including setting up alerts/digests, applying cost and reliability optimizations, understanding feature availability in sovereign clouds, managing RBAC for recommendations, and querying Advisor via Resource Graph/Kusto at scale. Use this when you need to operationalize Advisor across many subscriptions, enforce governance, or integrate recommendations into reporting and automation. Not for general Azure architecture design without using Azure Advisor as the primary recommendation source.
...
|----------|-------|-------------|
| Best Practices | L34-L47 | Using Advisor to assess architectures and apply cost, performance, operational excellence, and reliability best practices, including bulk fixes and calculating/exporting cost savings |
| Decision Making | L48-L56 | Using Advisor workbooks and critical risk views to assess cost impact, optimize spend, evaluate reliability, and plan migrations for service retirements |
