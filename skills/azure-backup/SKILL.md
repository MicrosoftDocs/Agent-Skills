...
| Limits & Quotas | L91-L118 | Backup support matrices, region support, limits, retention, and performance/metrics for Azure Backup workloads (VMs, disks, files, blobs, DBs, AKS, SAP, MARS/MABS/DPM, Backup Center). |
| Security | L119-L159 | Security, encryption, access control, soft delete, immutability, private endpoints, MUA/Resource Guard, and Azure Policy for protecting and restoring Azure Backup data. |
| Configuration | L160-L237 | Configuring Azure Backup and restore: setup, policies, scripts/APIs, vaults, monitoring/alerts, and workload-specific backups (VMs, AKS, Files, Blobs, disks, SQL, SAP HANA, AD, Windows Server). |
...
| Azure Backup behavior for PostgreSQL retirement | https://learn.microsoft.com/en-us/azure/backup/backup-azure-database-postgresql-server-faq |
