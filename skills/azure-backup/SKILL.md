...
| Best Practices | L68-L78 | Best practices for Azure Backup: protecting VMs and workloads (SQL, Exchange, Always On), configuring DPM/MABS, handling TRIM, and recovering data from vault-registered servers. |
| Decision Making | L79-L85 | Guidance on estimating Azure Backup costs, checking which VM SKUs/policies are supported, and planning migrations from classic backup alerts to Azure Monitor alerts. |
...
| Limits & Quotas | L91-L117 | Backup support matrices, region availability, performance constraints, retention and quota limits, and monitoring thresholds for Azure Backup across VMs, databases, files, disks, and SAP workloads. |
| Security | L118-L158 | Security, compliance, and access control for Azure Backup: soft delete, immutable vaults, encryption/CMK, RBAC/MUA, private endpoints, ransomware protection, and secure restore scenarios. |
| Configuration | L159-L235 | Configuring, automating, monitoring, and governing Azure Backup: vaults, policies, agents, scripts/APIs, alerts, diagnostics, and backup/restore for VMs, AKS, SQL, SAP HANA, Files, Blobs, Disks, and AD. |
| Integrations & Coding Patterns | L236-L292 | Automating Azure Backup and restore for VMs, SQL, PostgreSQL, blobs, disks, and files using REST, CLI, PowerShell, scripts, policies, vaults, jobs, and security integrations |
| Deployment | L293-L299 | MABS v3/v4 deployment details: supported workload/protection matrices and how to automate unattended/silent installation of Azure Backup Server v4. |
...
| Determine supported VM SKUs for Azure Backup policies | https://learn.microsoft.com/en-us/azure/backup/backup-azure-policy-supported-skus |
...
| Topic | URL |
|-------|-----|
| Consult Data Lake Storage backup support matrix | https://learn.microsoft.com/en-us/azure/backup/azure-data-lake-storage-backup-support-matrix |
| Check Elastic SAN backup regions and limitations | https://learn.microsoft.com/en-us/azure/backup/azure-elastic-san-backup-support-matrix |
...
| Azure Backup FAQ with limits and behaviors | https://learn.microsoft.com/en-us/azure/backup/backup-azure-backup-faq |
| Review PostgreSQL Flexible Server backup support and limits | https://learn.microsoft.com/en-us/azure/backup/backup-azure-database-postgresql-flex-support-matrix |
...
| Azure PostgreSQL server backup support and constraints | https://learn.microsoft.com/en-us/azure/backup/backup-azure-database-postgresql-support-matrix |
| Understand MySQL Flexible Server long-term backup limits | https://learn.microsoft.com/en-us/azure/backup/backup-azure-mysql-flexible-server-support-matrix |
...
| Review Azure Blob backup support matrix | https://learn.microsoft.com/en-us/azure/backup/blob-backup-support-matrix |
...
| Check Azure Backup support limits for SAP HANA in VMs | https://learn.microsoft.com/en-us/azure/backup/sap-hana-backup-support-matrix |
| Protect Azure file shares with soft delete | https://learn.microsoft.com/en-us/azure/backup/soft-delete-azure-file-share |
| Review Azure Backup support limits for SQL in VMs | https://learn.microsoft.com/en-us/azure/backup/sql-support-matrix |
...
| Private endpoints (v2) concepts for Azure Backup | https://learn.microsoft.com/en-us/azure/backup/backup-azure-private-endpoints-concept |
...
| Understand multiuser authorization with Resource Guard | https://learn.microsoft.com/en-us/azure/backup/multi-user-authorization-concept |
| Configure Resource Guard and MUA on Backup vaults | https://learn.microsoft.com/en-us/azure/backup/multi-user-authorization-tutorial |
...
| Soft delete for SQL and SAP HANA backups in Azure VMs | https://learn.microsoft.com/en-us/azure/backup/soft-delete-sql-saphana-in-azure-vm |
...
| Enable TLS 1.2 security for Azure Backup traffic | https://learn.microsoft.com/en-us/azure/backup/transport-layer-security |
