...
|----------|-------|-------------|
| Troubleshooting | L37-L67 | Diagnosing and fixing Azure Backup errors across VMs, disks, databases (SQL, PostgreSQL, MySQL, SAP), files, AKS, MABS/DPM, agents, vaults, and restore or performance issues. |
| Best Practices | L68-L79 | Best practices for configuring and optimizing Azure Backup/MABS/DPM for Hyper-V VMs, SQL (incl. Always On), Exchange, TRIM handling, VM backups, and vault-based recovery. |
...
| Limits & Quotas | L92-L121 | Backup support matrices, region support, limits, retention, performance, and quotas for Azure Backup workloads (VMs, disks, files, blobs, DBs, AKS, SAP, MARS/MABS/DPM) and related reporting/metrics. |
...
| MARS agent backup limits, schedules, and constraints | https://learn.microsoft.com/en-us/azure/backup/backup-azure-file-folder-backup-faq |
