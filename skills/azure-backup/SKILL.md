...
| Best Practices | L68-L79 | Best practices for backing up/restoring AD, SQL (incl. Always On), Exchange, Azure VMs, and DPM/Azure Backup Server, including TRIM handling and safe configuration across vaults. |
| Decision Making | L80-L86 | Guidance on planning Azure Backup costs, checking which VM SKUs/policies are supported, and deciding how to migrate from classic alerts to Azure Monitor alerts. |
...
| Limits & Quotas | L92-L119 | Backup support matrices, performance, and service limits for Azure workloads (VMs, disks, files, blobs, databases, AKS, SAP), plus quotas, retention, metrics, and monitoring constraints. |
| Security | L120-L160 | Security, compliance, and access control for Azure Backup: soft delete, immutable vaults, encryption/CMK, MUA/Resource Guard, private endpoints, ransomware protection, and secure restore permissions. |
| Configuration | L161-L238 | Configuring, automating, monitoring, and managing Azure Backup for VMs, AKS, Files, Blobs, disks, databases, and servers, including policies, diagnostics, alerts, vaults, and restore operations. |
...
| Deployment | L295-L302 | Deploying Azure Backup Server/MARS: supported workload matrices (MABS v3/v4), silent install automation, and using Azure Data Box for offline backup seeding. |
...
| Determine VM SKUs supported by Azure Backup policies | https://learn.microsoft.com/en-us/azure/backup/backup-azure-policy-supported-skus |
...
| Check support limits for Azure Files backup | https://learn.microsoft.com/en-us/azure/backup/azure-file-share-support-matrix |
| Review AKS backup support limits and scenarios | https://learn.microsoft.com/en-us/azure/backup/azure-kubernetes-service-cluster-backup-support-matrix |
| Reference Azure Backup FAQs and service limits | https://learn.microsoft.com/en-us/azure/backup/backup-azure-backup-faq |
| Long-term backup capabilities for PostgreSQL Flexible Server | https://learn.microsoft.com/en-us/azure/backup/backup-azure-database-postgresql-flex-overview |
...
| Support matrix for PostgreSQL server backup in Azure | https://learn.microsoft.com/en-us/azure/backup/backup-azure-database-postgresql-support-matrix |
...
| Support matrix and limits for SAP HANA backup on Azure VMs | https://learn.microsoft.com/en-us/azure/backup/sap-hana-backup-support-matrix |
| Protect Azure file shares with soft delete | https://learn.microsoft.com/en-us/azure/backup/soft-delete-azure-file-share |
| Support settings and limits for SQL backup in Azure VMs | https://learn.microsoft.com/en-us/azure/backup/sql-support-matrix |
...
| Understand enhanced soft delete options in Azure Backup | https://learn.microsoft.com/en-us/azure/backup/backup-azure-enhanced-soft-delete-about |
| Configure and manage soft delete settings in Azure Backup | https://learn.microsoft.com/en-us/azure/backup/backup-azure-enhanced-soft-delete-configure-manage |
| Use Azure Backup immutable vault for tamper-proof backups | https://learn.microsoft.com/en-us/azure/backup/backup-azure-immutable-vault-concept |
| Manage operations on Azure Backup immutable vaults | https://learn.microsoft.com/en-us/azure/backup/backup-azure-immutable-vault-how-to-manage |
| Use Azure Backup private endpoints (version 2 experience) | https://learn.microsoft.com/en-us/azure/backup/backup-azure-private-endpoints-concept |
...
| Enable multiuser authorization for Azure Backup vaults | https://learn.microsoft.com/en-us/azure/backup/enable-multi-user-authorization-quickstart |
...
| Understand Azure Backup multiuser authorization with Resource Guard | https://learn.microsoft.com/en-us/azure/backup/multi-user-authorization-concept |
...
| Create and configure private endpoints for Azure Backup | https://learn.microsoft.com/en-us/azure/backup/private-endpoints |
| Understand Azure Backup private endpoints (version 1) | https://learn.microsoft.com/en-us/azure/backup/private-endpoints-overview |
...
| Configure secure-by-default soft delete for Azure Backup | https://learn.microsoft.com/en-us/azure/backup/secure-by-default |
...
| Apply soft delete to SQL and SAP HANA backups in Azure VMs | https://learn.microsoft.com/en-us/azure/backup/soft-delete-sql-saphana-in-azure-vm |
...
| Configure TLS 1.2 security for Azure Backup traffic | https://learn.microsoft.com/en-us/azure/backup/transport-layer-security |
...
| Manage AKS backup extension and trusted access | https://learn.microsoft.com/en-us/azure/backup/azure-kubernetes-service-cluster-manage-backups |
...
| Use Azure Data Box for offline MARS seeding | https://learn.microsoft.com/en-us/azure/backup/offline-backup-azure-data-box |