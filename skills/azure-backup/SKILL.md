---
name: azure-backup
description: Expert knowledge for Azure Backup development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when protecting Azure VMs, SQL/PostgreSQL/SAP HANA, AKS, Files/Blobs, or automating backup via CLI/PowerShell/REST, and other Azure Backup related development tasks. Not for Azure Site Recovery (use azure-site-recovery).
...
| Limits & Quotas | L91-L118 | Backup support matrices, regional availability, performance, retention, and quota limits for Azure Backup workloads (VMs, disks, files, DBs, SAP, AKS, Blob) plus metrics and reporting. |
| Security | L119-L160 | Security, encryption, access control, soft delete, immutability, private endpoints, MUA/Resource Guard, and Azure Policy for protecting and restoring Azure Backup data. |
| Configuration | L161-L238 | Configuring, automating, monitoring, and governing Azure Backup for VMs, AKS, databases, files, disks, and servers, including policies, diagnostics, alerts, reporting, and restore operations. |
...
| Understand Azure Backup behavior for PostgreSQL | https://learn.microsoft.com/en-us/azure/backup/backup-azure-database-postgresql-server-faq |
