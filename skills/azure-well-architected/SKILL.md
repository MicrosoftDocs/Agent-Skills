...
description: Expert guidance for designing, assessing, and optimizing Azure workloads using Azure Well Architected. Covers design review checklists, recommendations, design principles, tradeoffs, service guides, workload patterns, and assessment questions. Use when designing AI, SAP, Oracle, SaaS, AVD/AVS, or HPC workloads with cost, reliability, security, and ops tradeoffs, and other Azure Well Architected related development tasks.
...
|----------|-------|-------------|
| Design Review Checklists | L35-L43 | Checklists to review Azure solutions for cost, operations, performance, reliability, and security best practices and identify gaps against Well-Architected guidance. |
| Recommendations | L44-L116 | Guidance on cost optimization, reliability, performance, security, DevOps, automation, and sustainability best practices for designing and operating Azure workloads. |
...
| Use the security design review checklist for Azure | https://learn.microsoft.com/en-us/azure/well-architected/security/checklist |
...
| Secure your development lifecycle in Azure architectures | https://learn.microsoft.com/en-us/azure/well-architected/security/secure-development-lifecycle |
