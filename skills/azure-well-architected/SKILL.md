...
description: Expert guidance for designing, assessing, and optimizing Azure workloads using Azure Well Architected. Covers design review checklists, recommendations, design principles, tradeoffs, service guides, workload patterns, and assessment questions. Use when designing AI, SAP, Oracle, SaaS, AVD/AVS, HPC, or mission‑critical workloads on Azure, and other Azure Well Architected related development tasks.
...
| Service Guides | L148-L199 | End-to-end WAF-aligned design, security, networking, monitoring, operations, and optimization guidance for key Azure services like AVD, AVS, databases, networking, and app platforms. |
