...
description: Provides expert guidance on Azure Blob Storage, including troubleshooting, best practices, decision making, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use this skill when designing, configuring, securing, monitoring, or debugging Blob Storage accounts, containers, and blobs; choosing access tiers and protocols (NFS/SFTP/BlobFuse); optimizing performance and cost; integrating via SDK/CLI; or planning migrations and static website hosting. Not for other Azure storage services like Azure Files, Disks, SQL, or third‑party object stores unless they are specifically interacting with Azure Blob Storage.
...
| Limits & Quotas | L107-L126 | Limits, quotas, performance and scale characteristics, known issues, FAQs, and feature-specific constraints for Azure Blob Storage, tiers, protocols (NFS/SFTP), and related tools (BlobFuse, Storage Mover). |
| Security | L127-L184 | Securing Blob Storage: identity/RBAC/ABAC, ACLs, SAS and SFTP auth, encryption (server, client, scopes, CPK), private networking, and controlling/mitigating anonymous access. |
| Configuration | L185-L252 | Configuring and operating Blob Storage: monitoring, lifecycle, immutability, soft delete, snapshots/restore, networking/mounts (BlobFuse/NFS/SFTP), inventory, Data Lake, and third‑party backup/migration tools. |
...
| Deployment | L388-L401 | Guides for deploying and integrating Blob Storage: static website hosting (CDN, GitHub Actions, Terraform), feature support, Data Lake enablement, and hybrid/migration solutions (HDFS, Hadoop, Nasuni, Tiger Bridge). |
...
| Review SFTP limitations and known issues in Blob Storage | https://learn.microsoft.com/en-us/azure/storage/blobs/secure-file-transfer-protocol-known-issues |
...
| Configure Entra ID-based SFTP authorization for Blob Storage | https://learn.microsoft.com/en-us/azure/storage/blobs/secure-file-transfer-protocol-support-entra-id-based-access |
...
| Configure Azure Blob lifecycle policies to delete blobs | https://learn.microsoft.com/en-us/azure/storage/blobs/lifecycle-management-policy-delete |
