...
description: Expert guidance on Azure Data Factory architecture, best practices, troubleshooting, security, configuration, integrations, deployment, limits/quotas, and cost/decision planning across pipelines, data flows, runtimes (Azure, self-hosted, SSIS), and Workflow Orchestration Manager. Use this skill when designing or optimizing ADF solutions, planning migrations (SSIS/SAP/Fabric), configuring secure and scalable runtimes, integrating with external services/ML/Databricks, or diagnosing performance, reliability, and deployment issues. Not for Synapse Pipelines, Fabric Data Factory, or non-Azure ETL/orchestration products unless specifically using Azure Data Factory integrations.
...
| Decision Making | L117-L137 | Guidance on ADF cost planning, pricing models, runtimes and compute choices, connector upgrades, SAP/SSIS migration, Fabric migration, and when to use Workflow Orchestration Manager. |
...
| Integrations & Coding Patterns | L319-L502 | How to connect ADF to many data sources/targets, use connectors and templates, build mapping data flows and functions, and integrate with external services, ML, Databricks, SSIS, and Fabric. |
...
| Configure Azure Data Factory copy from Amazon Redshift | https://learn.microsoft.com/en-us/azure/data-factory/connector-amazon-redshift |
