...
| Security | L65-L126 | Security and compliance with Azure Policy: security baselines, machine/guest configuration, signed packages, exemptions, and mappings to many regulatory and industry standards. |
...
| Align SOC 2 controls with Azure Policy initiatives | https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-soc-2 |
