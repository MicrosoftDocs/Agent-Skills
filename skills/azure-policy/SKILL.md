...
| Security | L65-L126 | Using Azure Policy and Machine Configuration for security baselines and regulatory compliance mappings (CIS, NIST, ISO, PCI, HIPAA, FedRAMP, CMMC, national standards) across clouds and OSes |
...
| Define and use Azure Policy exemption structures | https://learn.microsoft.com/en-us/azure/governance/policy/concepts/exemption-structure |
...
| Implement CIS Azure 1.3.0 with Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/cis-azure-1-3-0 |
| Align Azure Policy with CIS Azure 1.4.0 | https://learn.microsoft.com/en-us/azure/governance/policy/samples/cis-azure-1-4-0 |
| Use Azure Policy for CIS Azure 2.0.0 compliance | https://learn.microsoft.com/en-us/azure/governance/policy/samples/cis-azure-2-0-0 |
...
| Apply CIS Azure 1.1.0 in Azure Government via Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-cis-azure-1-1-0 |
| Map CIS Azure Gov 1.3.0 controls to Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-cis-azure-1-3-0 |
| Implement CMMC Level 3 on Azure Government with Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-cmmc-l3 |
...
| Align SOC 2 on Azure Government using Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-soc-2 |
...
| Implement SOC 2 requirements with Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/soc-2 |
