...
| Security | L65-L128 | Using Azure Policy and Machine Configuration for security baselines and regulatory compliance mappings (CIS, NIST, ISO, PCI, FedRAMP, HIPAA, etc.), including initiatives, exemptions, and benchmarks. |
...
| Microsoft cloud security benchmark mapped to Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/azure-security-benchmark |
| Reference list of Azure Policy built-in initiatives | https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-initiatives |
| Reference list of Azure Policy built-in definitions | https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies |
...
| FedRAMP High controls mapped to Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/fedramp-high |
| FedRAMP Moderate controls mapped to Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/fedramp-moderate |
| Implement Microsoft cloud security benchmark with Azure Policy in Azure Government | https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-azure-security-benchmark |
...
| Sovereignty Baseline Confidential controls mapped to Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/mcfs-baseline-confidential |
| Sovereignty Baseline Global controls mapped to Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/mcfs-baseline-global |
| NIST SP 800-171 R2 mapped to Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/nist-sp-800-171-r2 |
| NIST SP 800-53 Rev. 4 mapped to Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/nist-sp-800-53-r4 |
| NIST SP 800-53 Rev. 5 mapped to Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/nist-sp-800-53-r5 |
| NL BIO Cloud Theme controls mapped to Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/nl-bio-cloud-theme |
...
| RMIT Malaysia controls mapped to Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/rmit-malaysia |
| SOC 2 controls mapped to Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/soc-2 |
...
| SWIFT CSP-CSCF v2021 mapped to Azure Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/swift-csp-cscf-2021 |
