...
| Security | L65-L128 | Using Azure Policy and Machine Configuration for security/compliance: baselines, guest config, package signing, exemptions, and mappings to CIS, NIST, ISO, PCI, FedRAMP, HIPAA, CMMC, and regional standards. |
...
| Align with Microsoft cloud security benchmark via Policy | https://learn.microsoft.com/en-us/azure/governance/policy/samples/azure-security-benchmark |
...
| Implement NIST SP 800-53 R4 with Azure Policy in Azure Government | https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-nist-sp-800-53-r4 |
| Implement NIST SP 800-53 R5 with Azure Policy in Azure Government | https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-nist-sp-800-53-r5 |
...
| Use Sovereignty Baseline Confidential policies for compliance | https://learn.microsoft.com/en-us/azure/governance/policy/samples/mcfs-baseline-confidential |
| Use Sovereignty Baseline Global policies for compliance | https://learn.microsoft.com/en-us/azure/governance/policy/samples/mcfs-baseline-global |
