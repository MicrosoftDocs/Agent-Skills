...
description: Provides expert guidance on Azure Cosmos DB across troubleshooting, best practices, architecture patterns, limits/quotas, security, configuration, integrations, decision-making, and deployment for all supported APIs (Core (NoSQL), MongoDB, Cassandra, PostgreSQL) plus legacy DocumentDB. Use this skill when designing new Cosmos-backed solutions, optimizing performance and cost, planning multitenancy or global distribution, integrating with apps/data pipelines/AI, securing and monitoring workloads, or diagnosing errors, throttling, and availability issues in production. Not for non-Azure databases or other Azure data services such as Azure SQL, Azure Database for PostgreSQL/MySQL, or generic NoSQL platforms.
...
| Limits & Quotas | L250-L290 | Limits, quotas, and behaviors for Cosmos DB (all APIs, backup, autoscale, burst, serverless, free tier, partitions, indexes) plus Cosmos DB for PostgreSQL and legacy DocumentDB. |
| Security | L291-L357 | Securing Cosmos DB and related services: identity/RBAC, keys and encryption, network isolation (VNet, Private Link, firewalls), TLS, auditing, policies, and Defender-based threat protection. |
| Configuration | L358-L485 | Configuring Cosmos DB and related services: throughput, indexing, TTL, backups/PITR, global distribution, search/vector, emulators, SDK tuning, monitoring, and IaC (Bicep/ARM/Terraform). |
| Integrations & Coding Patterns | L486-L820 | Patterns and code samples for integrating apps, tools, and data pipelines with Azure Cosmos DB (all APIs), including SDK usage, change feed, Kafka/Spark, migrations, and vector/RAG. |
...
| Understand Azure Cosmos DB hierarchical partition key limits | https://learn.microsoft.com/en-us/azure/cosmos-db/hierarchical-partition-keys-faq |
| Monitor Azure Cosmos DB 20 GB logical partition limit | https://learn.microsoft.com/en-us/azure/cosmos-db/how-to-alert-on-logical-partition-key-storage-size |
