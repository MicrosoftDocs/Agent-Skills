...
description: Expert knowledge for Azure API Management development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when designing APIM policies, VNet/self-hosted gateways, Entra/OAuth auth, multi-region setups, or Front Door/App GW routes, and other Azure API Management related development tasks. Not for Azure Application Gateway (use azure-application-gateway), Azure Front Door (use azure-front-door), Azure Web Application Firewall (use azure-web-application-firewall), Azure Logic Apps (use azure-logic-apps).
...
| Security | L104-L142 | Securing Azure API Management: authN/authZ (Entra ID, B2C, OAuth2, JWT, mTLS, basic), certificates, RBAC, managed identity, self-hosted gateway security, DDoS/Defender, and compliance policies. |
...
| Integrations & Coding Patterns | L243-L275 | Patterns and samples for integrating API Management with external APIs, LLMs, backends, logging/monitoring tools, events, OAuth providers, and exporting/importing API definitions. |
| Deployment | L276-L296 | Deploying and scaling APIM: multi-region, VNet and zone setups, backups/migration, autoscale, automation, certificates, and self-hosted gateways (AKS, ACA, Docker, Kubernetes, Arc). |
