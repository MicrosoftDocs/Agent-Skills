...
| Best Practices | L44-L55 | Scaling, throttling, security hardening (OWASP), SSE setup, policy fragments, and production guidance for self-hosted gateway and developer portal in Azure API Management |
...
| Architecture & Design Patterns | L68-L78 | Architectural patterns for APIM networking and routing (VNet, App Gateway, Front Door, AKS), plus reusable policy fragments, shared caching, coordination, and sustainability-focused gateway design. |
...
| Security | L97-L130 | Securing API Management and its portals: authN/Z with Entra ID/B2C/OAuth/JWT, client certs/TLS, managed identities, CORS, DDoS/Defender, compliance, and LLM content safety policies. |
| Configuration | L131-L230 | Configuring Azure API Management behavior: policies, caching, networking/VNet, domains, logging/metrics, GraphQL/gRPC/LLM setup, self-hosted gateway, and workspace/update migrations. |
...
| Use API Management policies for transformation and throttling | https://learn.microsoft.com/en-us/azure/api-management/transform-api |
...
| Coordinate policy fragment execution at product and API scopes | https://learn.microsoft.com/en-us/azure/api-management/fragment-policy-coordination |
