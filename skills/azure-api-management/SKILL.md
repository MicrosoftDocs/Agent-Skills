...
| Configuration | L147-L246 | Configuring Azure API Management behavior: policies, caching, networking/VNet, logging/metrics, credentials, domains, self-hosted gateways, workspaces, subscriptions, and developer portal settings. |
