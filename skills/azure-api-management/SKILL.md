...
description: Expert knowledge for Azure API Management development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when building APIM policies, self-hosted gateways, VNet/private setups, OAuth/JWT auth, or multi-region deployments, and other Azure API Management related development tasks. Not for Azure Application Gateway (use azure-application-gateway), Azure Api Center (use azure-api-center), Azure Functions (use azure-functions), Azure App Service (use azure-app-service).
...
| Configuration | L147-L246 | Configuring Azure API Management behavior: policies, caching, networking/VNet, logging/metrics, credentials, subscriptions/users, self-hosted gateways, and developer portal integrations. |
...
| Configure inbound private endpoints for Azure API Management | https://learn.microsoft.com/en-us/azure/api-management/private-endpoint |
