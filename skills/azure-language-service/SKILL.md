...
description: Expert knowledge for Azure AI Language development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when building CLU, custom NER/text classification, CQA, sentiment/summarization, or health language solutions, and other Azure AI Language related development tasks. Not for Azure AI Search (use azure-cognitive-search), Azure AI Speech (use azure-speech), Azure Translator (use azure-translator), Azure AI Immersive Reader (use azure-immersive-reader).
...
| Decision Making | L61-L69 | Guidance on migration and lifecycle decisions: when and how to move between LUIS/QnA Maker/Text Analytics/Language Studio and Azure Language, and how to choose/manage CQA resources. |
