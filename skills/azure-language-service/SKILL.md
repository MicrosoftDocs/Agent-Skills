...
description: Provides expert guidance on Azure AI Language across troubleshooting, best practices, architecture, limits, security, configuration, integrations, and deployment for CLU, custom NER, text classification, sentiment, summarization, health, and custom question answering. Use this skill when designing new Language solutions, migrating from LUIS/QnA Maker/Text Analytics, optimizing accuracy and performance, configuring projects/containers, integrating with apps or bots, or planning secure, scalable, multi-region deployments. Not for general Azure OpenAI, Speech, or non-Language Cognitive Services questions.
...
| Limits & Quotas | L77-L95 | Language service limits: rate/data/throughput caps, regional and language support matrices, and quota rules for CLU, NER, PII, CQA, containers, and orchestration workflows. |
