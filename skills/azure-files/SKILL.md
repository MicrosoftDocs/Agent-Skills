---
name: azure-files
description: Provides expert guidance on Azure Files and Azure File Sync across best practices, configuration, decision making, deployment, integrations & coding patterns, limits & quotas, and security. Use this skill when planning or optimizing Azure Files deployments, choosing tiers and redundancy, configuring networking and identity, securing access, integrating with AKS or applications, tuning performance, understanding scale limits, or designing migration/DR strategies. Not for Azure NetApp Files, Azure Blob Storage, on-prem-only file servers, or generic Windows file sharing without Azure Files involvement.
...
|----------|-------|-------------|
| Best Practices | L35-L49 | Best practices for Azure Files and Azure File Sync: disaster recovery, failover, server/drive replacement, safe deprovisioning, and performance tuning for SMB, NFS, VDI, and FSLogix. |
| Decision Making | L50-L68 | Guidance on planning Azure Files deployments, choosing tiers, redundancy and billing, estimating and reducing costs, and selecting/migrating to Azure Files or Azure File Sync from SMB/NFS/Windows. |
| Limits & Quotas | L69-L77 | Scalability, performance, and throttling limits for Azure Files and File Sync, including IOPS/throughput caps, tuning guidance, and FAQs on quotas and behavior. |
| Security | L78-L104 | Securing Azure Files and File Sync: identity-based SMB/NFS auth, Kerberos/AD/Entra setup, ACLs and share permissions, encryption in transit, and network/firewall/proxy hardening. |
| Configuration | L105-L132 | Configuring Azure Files and Azure File Sync: networking/VPN, private endpoints, DFS, redundancy, monitoring/alerts, cloud tiering, soft delete, and mounting or copying shares across platforms. |
| Integrations & Coding Patterns | L133-L140 | Guides for integrating Azure Files with AKS via CSI and building .NET, Java, and Python apps using Azure Files SDKs, including auth, mounting, and file I/O patterns. |
| Deployment | L141-L154 | Guides for deploying and migrating to Azure Files/Azure File Sync: NAS/GlusterFS/SMB/NFS moves, Data Box/Robocopy usage, region/zonal placement, and hybrid sync scenarios. |
...
| Optimize NFS Azure file share performance at scale | https://learn.microsoft.com/en-us/azure/storage/files/nfs-performance |
...
| Select development approaches for Azure Files applications | https://learn.microsoft.com/en-us/azure/storage/files/storage-files-developer-overview |
...
| Understand and tune Azure Files performance limits | https://learn.microsoft.com/en-us/azure/storage/files/understand-performance |
...
| Authorize Azure Files data access in the portal | https://learn.microsoft.com/en-us/azure/storage/files/authorize-data-operations-portal |
...
| Change Azure Files SMB identity source securely | https://learn.microsoft.com/en-us/azure/storage/files/change-identity-source |
...
| Configure security and networking for Azure Files NFS shares | https://learn.microsoft.com/en-us/azure/storage/files/files-nfs-protocol |
...
| Use Entra Domain Services authentication with Azure Files | https://learn.microsoft.com/en-us/azure/storage/files/storage-files-identity-auth-domain-services-enable |
...
| Configure Kerberos authentication for Linux Azure Files clients | https://learn.microsoft.com/en-us/azure/storage/files/storage-files-identity-auth-linux-kerberos-enable |
| Configure directory and file ACLs for Azure Files | https://learn.microsoft.com/en-us/azure/storage/files/storage-files-identity-configure-file-level-permissions |
...
| Integrate DFS Namespaces with Azure Files | https://learn.microsoft.com/en-us/azure/storage/files/files-manage-namespaces |
...
| Configure and use Azure Files soft delete for shares | https://learn.microsoft.com/en-us/azure/storage/files/storage-files-prevent-file-share-deletion |
...
| Develop .NET applications that integrate with Azure Files | https://learn.microsoft.com/en-us/azure/storage/files/storage-dotnet-how-to-use-files |
| Develop Java applications that integrate with Azure Files | https://learn.microsoft.com/en-us/azure/storage/files/storage-java-how-to-use-file-storage |
...
| Determine region redundancy support for SSD Azure Files | https://learn.microsoft.com/en-us/azure/storage/files/redundancy-premium-file-shares |
