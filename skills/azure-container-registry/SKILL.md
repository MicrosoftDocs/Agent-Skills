...
| Security | L80-L120 | Securing Azure Container Registry: auth methods, RBAC/ABAC, network isolation (firewalls, Private Link, service endpoints), data exfiltration controls, image signing/verification, and compliance/policy. |
...
| Configure ACR-to-ACR artifact cache with managed identity | https://learn.microsoft.com/en-us/azure/container-registry/artifact-cache-acr-to-acr-cli |
