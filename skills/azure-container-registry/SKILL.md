...
| Integrations & Coding Patterns | L138-L154 | Patterns and code samples for integrating ACR with AKS/ACI, GitHub Actions, ORAS, Helm, Notation signing, webhooks, artifact caching, transfers, and image import/build workflows. |
