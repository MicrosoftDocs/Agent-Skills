...
| Decision Making | L61-L67 | Guidance on choosing Kubernetes auth methods for ACR, planning geo-replication, and migrating image signing from Docker Content Trust to Notary Project. |
...
| Limits & Quotas | L75-L80 | Details on ACR SKU feature/throughput limits and how image storage capacity, layers, and repository counts are calculated and constrained. |
| Security | L81-L120 | Securing ACR: auth methods (Entra, managed identity, tokens), RBAC/ABAC, network controls (firewall, Private Link, IP, service tags), encryption keys, image signing/verification, policy and Defender scans |
| Configuration | L121-L138 | Configuring ACR behavior: caching, purge/retention/soft delete, delete locks, webhooks, metrics/logs, and ACR Tasks (YAML, timers, agent pools, multi-step builds, continuous patching). |
...
| Topic | URL |
|-------|-----|
| Compare Azure Container Registry SKU limits and features | https://learn.microsoft.com/en-us/azure/container-registry/container-registry-skus |
| Understand Azure Container Registry image storage limits | https://learn.microsoft.com/en-us/azure/container-registry/container-registry-storage |
...
| Configure Azure ABAC repository permissions for Container Registry | https://learn.microsoft.com/en-us/azure/container-registry/container-registry-rbac-abac-repository-permissions |
...
| Manage Azure Container Registry access with built-in RBAC roles | https://learn.microsoft.com/en-us/azure/container-registry/container-registry-rbac-built-in-roles-overview |
...
| Configure soft delete retention for Azure Container Registry | https://learn.microsoft.com/en-us/azure/container-registry/container-registry-soft-delete-policy |
