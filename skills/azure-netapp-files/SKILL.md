...
description: Expert knowledge for Azure NetApp Files development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when deploying ANF for SAP HANA/Oracle, AVS, AzAcSnap, ZRS, REST/PowerShell, or ransomware protection, and other Azure NetApp Files related development tasks. Not for Azure Files (use azure-files), Azure Blob Storage (use azure-blob-storage), Azure Elastic SAN (use azure-elastic-san), Azure Managed Lustre (use azure-managed-lustre).
...
| Limits & Quotas | L102-L125 | Limits, quotas, and performance of Azure NetApp Files: volume size/throughput caps, file/path/inode limits, quotas, regional capacity, and workload benchmarks (Linux, SAP HANA, Oracle, AVS). |
| Security | L126-L160 | Security configuration for Azure NetApp Files: encryption (CMK, HSM, cross-tenant), Kerberos/LDAP/AD, NFS/SMB permissions and ACLs, ransomware protection, and control/data plane hardening. |
| Configuration | L161-L198 | Configuring Azure NetApp Files: accounts, pools, networking, NFS/SMB, quotas, logging, backups, replication, ransomware protection, and AzAcSnap/database setups for SAP/Oracle. |
