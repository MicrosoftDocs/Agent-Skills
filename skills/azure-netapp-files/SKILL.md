...
| Security | L127-L163 | Security, encryption, and access control for Azure NetApp Files: keys/CMK, Kerberos, LDAP/AD, ACLs/permissions (NFS/SMB/S3), ransomware protection, and control/data plane hardening. |
