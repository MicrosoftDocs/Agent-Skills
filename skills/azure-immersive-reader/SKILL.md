...
description: Expertise in Azure AI Immersive Reader best practices, configuration, integrations, limits/quotas, and security, including token caching and reuse, per-user reading/language preferences, SDK launch flows, supported language capabilities, and Entra-based access control. Use this skill when designing, configuring, or troubleshooting Immersive Reader in web or mobile apps, optimizing performance, or validating language/feature support and security posture. Not for general Azure AI services, non-Immersive Reader accessibility features, or unrelated reading/translation products.
...
| Integrations & Coding Patterns | L57-L66 | Integrating Immersive Reader into web/iOS apps: launch flows, JS SDK usage, HTML/MathML prep, custom buttons, multi-resource setups, and Vision Read integration. |
...
| Programmatically launch Azure Immersive Reader in apps | https://learn.microsoft.com/en-us/azure/ai-services/immersive-reader/how-to-launch-immersive-reader |
