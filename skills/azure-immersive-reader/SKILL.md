...
| Integrations & Coding Patterns | L57-L65 | Integrating Immersive Reader into web/iOS apps: launch flows, custom buttons, HTML/MathML prep, multi-resource use, and JavaScript/iOS SDK usage and patterns. |
