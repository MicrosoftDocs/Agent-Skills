...
| Security | L62-L77 | Securing ARO clusters: identity/auth (Entra, managed identities, service principals, workload identity), disk encryption, NSGs/egress, FIPS, Front Door protection, and support access control. |
...
| Deployment | L107-L119 | Deploying and operating ARO clusters and apps: cluster creation (private/ARM/Bicep), upgrades, networking migration, backups/restores, and app runtimes (JBoss, WebSphere, S2I, serverless). |
