...
description: Provides expert guidance on Azure Red Hat OpenShift (ARO) across troubleshooting, best practices, decision making, limits & quotas, security, configuration, integrations, and deployment. Use this skill when you need to size and deploy ARO clusters, configure networking/storage/registry, plan upgrades and backups, integrate with Azure services (ACR, Key Vault, ANF, GPUs, Azure Monitor), understand supportability and lifecycle constraints, or diagnose and remediate cluster and certificate issues. It also clarifies shared responsibility, identity and network security patterns, and scaling/quotas for large ARO 4 environments. Not for generic Kubernetes, AKS, or non-Azure OpenShift distributions.
...
| Decision Making | L51-L56 | Operational FAQs, support processes, and the shared responsibility model between Microsoft and you for managing, securing, and supporting Azure Red Hat OpenShift clusters. |
...
| Security | L63-L80 | Identity, auth, and network security for ARO: Entra integration, managed identities/SPs, workload identity, disk encryption, FIPS, NSGs/egress, Front Door, Lockbox, and credential rotation |
...
| Topic | URL |
|-------|-----|
| Answer operational and support FAQs for Azure Red Hat OpenShift | https://learn.microsoft.com/en-us/azure/openshift/openshift-faq |
...
| Reconcile federated identity credentials for Azure Red Hat OpenShift | https://learn.microsoft.com/en-us/azure/openshift/howto-reconcile-federated-identity-credentials |
| Replace Azure Red Hat OpenShift platform and cluster identities | https://learn.microsoft.com/en-us/azure/openshift/howto-replace-cluster-identity |
