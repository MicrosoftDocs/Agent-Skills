...
description: Provides expert guidance on Azure Cost Management across troubleshooting, best practices, decision making, limits & quotas, security, configuration, integrations, and deployment of cost data exports. Use this skill to analyze and optimize Azure spend, configure billing and budgets, design tagging and allocation models, choose and manage reservations/savings plans, secure billing access, automate cost reporting via APIs/Power BI, and resolve billing/subscription/reservation issues. Not for general Azure resource configuration, non-Azure clouds, or non-cost-related performance and reliability tuning.
...
|----------|-------|-------------|
| Troubleshooting | L36-L64 | Diagnosing and fixing Azure billing, subscription, and reservation issues (errors, disabled subs, missing invoices, payment failures, utilization anomalies) and using pivot tables to debug cost data. |
...
| Decision Making | L75-L127 | Deciding how to allocate and analyze Azure costs, choose subscriptions and billing offers, and plan, buy, manage, and optimize reservations and savings plans (including special discounts and migrations). |
...
| Security | L144-L163 | Securing Azure billing and cost data: RBAC and billing roles, admin elevation, tenant/subscription protection, fraud prevention, and permissions for EA, MCA, reservations, and savings plans. |
| Configuration | L164-L235 | Configuring Azure billing, credits, reservations, savings plans, budgets, tags, alerts, and subscription/payment relationships to control, allocate, and optimize cloud costs. |
...
| Diagnose and fix Azure billing payment update errors | https://learn.microsoft.com/en-us/azure/cost-management-billing/troubleshoot-billing/billing-troubleshoot-azure-payment-issues |
...
| Resolve declined credit card issues in Azure billing | https://learn.microsoft.com/en-us/azure/cost-management-billing/troubleshoot-billing/troubleshoot-declined-card |
