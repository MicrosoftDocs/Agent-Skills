...
description: Provides expert guidance on Azure Kubernetes Service (AKS) across troubleshooting, best practices, architecture, security, configuration, integrations, limits/quotas, and deployment. Use this skill when designing or operating AKS clusters, making migration or cost decisions, setting up production-grade networking/storage, securing workloads (incl. PCI), integrating with Azure services and GPUs, or diagnosing cluster/app issues and upgrade problems. Not for non-Azure Kubernetes platforms (e.g., standalone Kubernetes, EKS, GKE) or non-AKS Azure container services such as Azure Container Apps or Azure Container Instances.
...
|----------|-------|-------------|
| Troubleshooting | L37-L57 | Diagnosing and fixing AKS and Fleet issues: networking, DNS, GPU, kubelet, security, upgrades, Windows containers, agent/CLI modes, logs, and common add-on or placement errors. |
...
| Decision Making | L105-L151 | Guidance for architectural and migration decisions in AKS: networking, VM/node pools, upgrades, pricing, cost optimization, OS/runtime choices, compliance (PCI), and comparisons with other platforms. |
| Architecture & Design Patterns | L152-L177 | AKS reference architectures, HA/DR patterns, multi-region and multi-cluster design, PCI-compliant setups, node pool/IP planning, and upgrade/rollout strategies (incl. AWS-to-AKS). |
| Limits & Quotas | L178-L196 | AKS limits, quotas, capacity, and performance: node/pod resources, egress/NAT, load balancers, Istio add-on scaling, identity bindings, API/version lifecycles, and support policies. |
| Security | L197-L277 | Securing AKS clusters: identity & access (Entra, RBAC, workload identity), network/API protection, encryption & keys, node hardening, policies, PCI compliance, and secure integrations. |
| Configuration | L278-L436 | Configuring AKS clusters, networking, storage, autoscaling, node pools (incl. GPU/NAP), ingress/egress, service mesh, costs, and multi-cluster/Fleet settings for production workloads. |
...
| Deployment | L460-L517 | Deploying and upgrading AKS clusters and apps, including CI/CD, service meshes, KEDA, AI/ML and Ray workloads, Wasm platforms, storage/migration, and production-ready infra setup. |
...
| Understand lifecycle limits for Fleet preview APIs | https://learn.microsoft.com/en-us/azure/kubernetes-fleet/concepts-preview-api-lifecycle |
...
| Configure Private API Server VNet Integration Access in AKS | https://learn.microsoft.com/en-us/azure/aks/private-apiserver-vnet-integration-cluster |
...
| Update Azure CNI IPAM mode and data plane in AKS | https://learn.microsoft.com/en-us/azure/aks/update-azure-cni |
| Update Azure CNI IPAM mode and data plane in AKS (duplicate) | https://learn.microsoft.com/en-us/azure/aks/update-azure-cni |
...
| Plan migration off Flatcar Container Linux in AKS | https://learn.microsoft.com/en-us/azure/aks/flatcar-container-linux-for-aks |
