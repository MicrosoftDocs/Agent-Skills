...
description: Provides expert guidance on Azure AI Search across troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use this skill when designing or operating Azure AI Search–backed RAG/agentic retrieval systems, tuning indexing and vector/semantic search, securing and isolating data, integrating with external data sources and SDKs, or planning capacity, regions, and automation for production deployments. Not for questions about Azure OpenAI, Azure Cognitive Services for Language, or non–Azure search products.
...
| Limits & Quotas | L89-L99 | Service limits, quotas, and behaviors for Azure AI Search: indexer run/reset/scheduling, tier-based caps, vector index size limits, and AI enrichment/Fabric Foundry resource usage. |
...
| Configuration | L139-L234 | Configuring Azure AI Search: data sources, indexes, analyzers, enrichment skillsets, vector/semantic settings, knowledge bases, monitoring, and indexer/connection options. |
| Integrations & Coding Patterns | L235-L295 | Patterns and code for integrating data sources, indexers, vectorization, custom skills, OData/Lucene queries, semantic/agentic retrieval, and SDK/REST usage with Azure AI Search. |
...
| Azure AI Search FAQ with service limits and behaviors | https://learn.microsoft.com/en-us/azure/search/search-faq-frequently-asked-questions |
