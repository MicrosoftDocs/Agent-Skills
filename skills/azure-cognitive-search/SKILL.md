...
description: Expert knowledge for Azure AI Search development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when designing indexes, skillsets, vector/semantic search, indexers over Azure data, or RAG knowledge bases, and other Azure AI Search related development tasks. Not for Azure Cosmos DB (use azure-cosmos-db), Azure Table Storage (use azure-table-storage), Azure Data Explorer (use azure-data-explorer).
...
| Best Practices | L49-L69 | Design, scaling, and performance tuning for Azure AI Search: enrichment pipelines, indexing (SQL/Blob/complex data), vector RAG chunking, concurrency-safe updates, and query/index optimization. |
| Decision Making | L70-L82 | Guidance on SKUs, capacity, and cost planning, plus how to migrate/upgrade Azure AI Search APIs, SDKs, skills, and service resources across versions and tiers. |
...
| Limits & Quotas | L90-L100 | Limits, quotas, and run windows for Azure AI Search: index counts, vector index sizes, service tiers, indexer scheduling/reset, enrichment quotas, and numeric FAQs. |
| Security | L101-L138 | Securing Azure AI Search: RBAC/keyless auth, API keys, CMK encryption, network isolation, private endpoints, and indexer access to protected data sources with ACL/RBAC and Purview labels. |
| Configuration | L139-L231 | Configuring Azure AI Search: data sources, indexes, analyzers, enrichment skillsets, vector/semantic settings, knowledge bases, monitoring, and relevance/tuning options. |
| Integrations & Coding Patterns | L232-L289 | Patterns and code for querying Azure AI Search, building custom/vector skills, indexing many Azure data sources, using OData/Lucene syntax, and integrating with apps, agents, and BI tools. |
| Deployment | L290-L297 | Provision and move Azure AI Search services across regions using ARM, Bicep, Terraform, plus check which features are available in which Azure regions. |
...
| Resolve Azure AI Search storage and metrics discrepancies | https://learn.microsoft.com/en-us/azure/search/troubleshoot-storage-metrics |
...
| Handle changed and deleted Azure Blobs in search indexers | https://learn.microsoft.com/en-us/azure/search/search-how-to-index-azure-blob-changed-deleted |
...
| Topic | URL |
|-------|-----|
| Migrate agentic retrieval code between Azure AI Search REST API versions | https://learn.microsoft.com/en-us/azure/search/agentic-retrieval-how-to-migrate |
...
| Select the right Azure AI Search SKU and tier | https://learn.microsoft.com/en-us/azure/search/search-sku-tier |
...
| Azure AI Search FAQs with numeric limits | https://learn.microsoft.com/en-us/azure/search/search-faq-frequently-asked-questions |
...
| Understand index count limits for Azure AI Search tiers | https://learn.microsoft.com/en-us/azure/search/tutorial-csharp-create-load-index |
...
| Ingest Azure RBAC scopes from Blob Storage with indexers | https://learn.microsoft.com/en-us/azure/search/search-blob-indexer-role-based-access |
...
| Configure managed identities and role assignments for Azure AI Search | https://learn.microsoft.com/en-us/azure/search/search-how-to-managed-identities |
...
| Enforce Microsoft Purview sensitivity labels at query time | https://learn.microsoft.com/en-us/azure/search/search-query-sensitivity-labels |
| Manage and use API keys securely in Azure AI Search | https://learn.microsoft.com/en-us/azure/search/search-security-api-keys |
...
| Retrieve Azure AI Search encryption key details from Key Vault | https://learn.microsoft.com/en-us/azure/search/search-security-get-encryption-keys |
...
| Topic | URL |
|-------|-----|
| Create and configure blob knowledge source for agentic retrieval | https://learn.microsoft.com/en-us/azure/search/agentic-knowledge-source-how-to-blob |
| Configure indexed OneLake knowledge source for Azure AI Search | https://learn.microsoft.com/en-us/azure/search/agentic-knowledge-source-how-to-onelake |
...
| Set up indexed SharePoint knowledge source for agentic retrieval | https://learn.microsoft.com/en-us/azure/search/agentic-knowledge-source-how-to-sharepoint-indexed |
| Configure remote SharePoint knowledge source using Copilot Retrieval API | https://learn.microsoft.com/en-us/azure/search/agentic-knowledge-source-how-to-sharepoint-remote |
| Create and configure Web Knowledge Source for agentic retrieval | https://learn.microsoft.com/en-us/azure/search/agentic-knowledge-source-how-to-web |
| Enable or disable Web Knowledge Source at subscription level | https://learn.microsoft.com/en-us/azure/search/agentic-knowledge-source-how-to-web-manage |
...
| Design index schema for agentic retrieval in Azure AI Search | https://learn.microsoft.com/en-us/azure/search/agentic-retrieval-how-to-create-index |
