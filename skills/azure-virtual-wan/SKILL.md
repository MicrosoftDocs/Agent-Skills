...
description: Provides expert guidance on Azure Virtual WAN architecture, configuration, deployment, security, integrations, limits, decision-making, and troubleshooting across hubs, VNets, VPN (P2S/S2S), ExpressRoute, and NVAs. Use this skill when designing global transit architectures, choosing hub locations or partners, configuring BGP/routing, securing and scaling P2S VPN with Entra ID, automating deployments (including cross-tenant), or diagnosing connectivity and performance issues using built-in diagnostics. Not for classic Azure VPN Gateway, VNet peering-only designs, or non–Virtual WAN SD-WAN/VPN solutions without Virtual WAN involvement.
...
| Security | L80-L92 | Configuring secure P2S VPN access in Virtual WAN using Microsoft Entra ID (MFA, app registrations, custom app IDs), Azure VPN Client setup, segmented access, and hub roles/permissions. |
| Configuration | L93-L144 | Configuring Azure Virtual WAN hubs, routing, BGP, NVAs, VPN (P2S/Always On), IPsec/NAT, Entra ID auth, certificates, client profiles, and monitoring/metrics. |
...
| Topic | URL |
|-------|-----|
| Secure P2S access to spoke VNets with Virtual WAN | https://learn.microsoft.com/en-us/azure/virtual-wan/manage-secure-access-resources-spoke-p2s |
...
| Configure BGP peering from Virtual WAN hub to NVA | https://learn.microsoft.com/en-us/azure/virtual-wan/create-bgp-peering-hub-portal |
