...
description: Expert knowledge for Azure Virtual Machines development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when using VM scale sets, Trusted Launch, ADE/CMK disk encryption, GPU/HPC SKUs, or Oracle workloads, and other Azure Virtual Machines related development tasks. Not for Azure Data Science Virtual Machines (use azure-data-science-vm), Azure Virtual Machine Scale Sets (use azure-vm-scalesets), SQL Server on Azure Virtual Machines (use azure-sql-virtual-machines), Azure App Service (use azure-app-service).
...
| Decision Making | L89-L150 | Guidance on choosing VM sizes, images, disks, costs, and licensing, plus planning migrations, retirements, backup/DR, and specialized workloads like Oracle, RHEL, WebLogic, and GPU/HPC. |
...
| Choose size flexibility vs capacity for Reserved VMs | https://learn.microsoft.com/en-us/azure/virtual-machines/reserved-vm-instance-size-flexibility |
