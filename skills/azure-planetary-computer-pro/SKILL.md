...
| Configuration | L61-L75 | Configuring Planetary Computer Pro data access and visualization: collections, tiles, mosaics, render/colormap settings, queryables, ingestion sources, APIM proxy, and US Gov cloud endpoints. |
