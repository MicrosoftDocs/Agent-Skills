---
name: azure-sap
description: Provides expert guidance on SAP HANA on Azure Large Instances across troubleshooting, architecture, deployment, configuration, security, limits, integrations, best practices, and decision making. Use this skill when designing or operating SAP HANA on Azure Large Instances: choosing HA/DR and multi-region patterns, validating certified configurations, planning storage/VM layouts, configuring OS clusters (RHEL/SLES/Windows), securing connectivity and data, integrating with Azure services and data pipelines, tuning performance, or resolving deployment/monitoring/extension issues. Not for generic SAP on Azure VMs, non-HANA databases, or non-Azure hyperscaler deployments.
...
|----------|-------|-------------|
| Troubleshooting | L37-L47 | Diagnosing and fixing SAP on Azure issues: deployment automation, BPS data pipelines (ADF/Fabric), SAP Insights monitoring, VM scale set problems, and SAP VM extension failures. |
| Best Practices | L48-L56 | Testing and tuning SAP HANA on Azure: config validation, HA test automation, VIS quality checks, DR design per layer, and optimizing Azure Premium Files for SAP workloads |
...
| Architecture & Design Patterns | L73-L98 | Designing SAP HANA/DBMS and NetWeaver architectures on Azure: HA/DR patterns, multi-region/zone availability, latency, RISE connectivity, and DB options (HANA, SQL, Oracle, Db2, ASE, IQ, MaxDB). |
...
| Security | L106-L119 | Security, identity, and access design for SAP on Azure: Key Vault, RBAC, TLS, private endpoints, NFS encryption, Entra ID integration, and secure exposure of SAP services. |
| Configuration | L120-L195 | Configuring SAP on Azure: automation framework, ACSS, monitoring providers, storage/VM layouts, HA/DR clusters (RHEL/SLES/Windows), networking, backups, and SAP HANA/NetWeaver/Db2 setup. |
| Integrations & Coding Patterns | L196-L208 | Patterns and steps to integrate SAP (S/4HANA, ECC, ABAP, RISE) with Azure services, ADF, Salesforce, Exchange, Power Query, Universal Print, and automation/monitoring tools |
| Deployment | L209-L252 | Deploying and automating SAP on Azure: control planes, workload zones, automation framework, ACSS, HA/DR topologies, DevOps/Ansible, and product-specific deployments (S/4HANA, BOBJ, B1). |
...
| Monitor and troubleshoot Fabric-based BPS data pipelines | https://learn.microsoft.com/en-us/azure/sap/business-process-solutions/monitor-fabric-data-extraction-processing |
...
| Obtain and upload SAP installation media for Azure Center for SAP solutions | https://learn.microsoft.com/en-us/azure/sap/center-sap-solutions/get-sap-installation-media |
...
| Register existing SAP systems in Azure Center for SAP solutions using CLI | https://learn.microsoft.com/en-us/azure/sap/center-sap-solutions/quickstart-register-system-cli |
| Register existing SAP systems in Azure Center for SAP solutions via portal | https://learn.microsoft.com/en-us/azure/sap/center-sap-solutions/register-existing-system |
...
| Configure secondary site disaster recovery for SAP HANA Pacemaker cluster | https://learn.microsoft.com/en-us/azure/sap/workloads/disaster-recovery-sap-hana |
...
| Prepare Azure infrastructure for SAP ASCS/SCS HA with WSFC and file share | https://learn.microsoft.com/en-us/azure/sap/workloads/sap-high-availability-infrastructure-wsfc-file-share |
...
| Configure SAP NetWeaver HA with WSFC shared disk on Azure | https://learn.microsoft.com/en-us/azure/sap/workloads/sap-high-availability-installation-wsfc-shared-disk |
