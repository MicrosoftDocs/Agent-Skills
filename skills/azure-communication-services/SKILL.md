...
description: Provides expert guidance on Azure Communication Services across troubleshooting, best practices, architecture, security, limits, configuration, integrations, decision-making, and deployment for calling, chat, SMS, email, and Teams interop. Use this skill when designing or operating ACS-based communication workloads, choosing PSTN/phone number options, integrating ACS into custom apps or contact centers, optimizing quality and compliance, or diagnosing ACS service/SDK issues in production. Not for questions about non-Azure communication platforms (e.g., Twilio, Zoom, Webex) or generic Azure networking/identity topics unrelated to ACS.
...
| Limits & Quotas | L160-L227 | Limits, quotas, and regional restrictions for ACS calling, phone numbers, Teams interop, email (MIME, send limits), media features, and telephony (direct routing, toll‑free, emergency). |
...
| Integrations & Coding Patterns | L334-L480 | End-to-end patterns for integrating ACS calling, chat, SMS, email, Rooms, Job Router, Teams, WhatsApp, bots, AI, push notifications, and media features into custom applications. |
...
| Request higher email sending quotas in Azure Communication Services | https://learn.microsoft.com/en-us/azure/communication-services/concepts/email/email-quota-increase |
