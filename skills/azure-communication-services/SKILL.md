...
description: Expert knowledge for Azure Communication Services development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when building ACS calling/chat, SMS/email, Teams interop, PSTN/phone numbers, or contact center solutions, and other Azure Communication Services related development tasks. Not for Azure AI Bot Service (use azure-bot-service), Azure Notification Hubs (use azure-notification-hubs), Azure SignalR Service (use azure-signalr-service), Azure Web PubSub (use azure-web-pubsub).
...
| Security | L228-L254 | Security, auth, and compliance for ACS: encryption, identities, Teams interop, email/WhatsApp/phone sender auth, webhooks, HMAC, emergency calling, captions/RTT data handling, and gov cloud use. |
