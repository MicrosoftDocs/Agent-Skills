...
description: Expert knowledge for Azure Test Plans development including limits & quotas, security, and integrations & coding patterns. Use when defining test run fields, handling test case/suite limits, setting test access, or automating via tcm.exe, and other Azure Test Plans related development tasks. Not for Azure DevOps (use azure-devops), Azure Pipelines (use azure-pipelines), Azure Boards (use azure-boards), Azure App Testing (use azure-app-testing).
...
|----------|-------|-------------|
| Limits & Quotas | L31-L36 | Test run customization with custom fields, plus limits, quotas, and data retention rules for Azure Test Plans (e.g., max test cases, suites, runs, and history duration). |
