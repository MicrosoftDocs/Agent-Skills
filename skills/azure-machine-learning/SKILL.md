...
description: Expert knowledge for Azure Machine Learning development including troubleshooting, best practices, decision making, architecture & design patterns, limits & quotas, security, configuration, integrations & coding patterns, and deployment. Use when using Azure ML workspaces, AutoML, pipelines, online/batch endpoints, or Prompt Flow/Agent Framework, and other Azure Machine Learning related development tasks. Not for Azure Databricks (use azure-databricks), Azure Synapse Analytics (use azure-synapse-analytics), Azure Data Science Virtual Machines (use azure-data-science-vm), Azure HDInsight (use azure-hdinsight).
...
| Decision Making | L96-L125 | Guidance on Azure ML architectural choices and migrations: algorithm selection, training/network/DR planning, cost optimization, and upgrading or moving from v1, ACI, Prompt Flow to v2/Agent Framework. |
| Architecture & Design Patterns | L126-L132 | Designing Azure ML inference architectures: choosing endpoint types, planning real-time online endpoints, and structuring data movement and multistep pipeline components. |
| Limits & Quotas | L133-L141 | Info on Azure ML regional/sovereign availability, VM SKUs, and service limits, plus how to view, plan, and manage quotas and capacity for model deployments and endpoints. |
| Security | L142-L194 | Securing Azure ML workspaces, data, and endpoints with encryption, identity/RBAC, Key Vault, policies, and network isolation (VNets, private access, exfiltration prevention). |
| Configuration | L195-L455 | How to configure Azure ML components, compute, networking, monitoring, AutoML, YAML specs, data/feature stores, deployments, and environments across studio, SDK, CLI, and Kubernetes. |
| Integrations & Coding Patterns | L456-L511 | Patterns and how-tos for wiring Azure ML to data sources, Spark/Databricks/Synapse, MLflow, REST/Events, and prompt flow tools, plus deploying and consuming models and batch endpoints. |
| Deployment | L512-L554 | Deploying and operationalizing models and prompt flows: online/batch endpoints, AKS/ACI, MLflow/ONNX/custom containers, CI/CD, blue‑green rollouts, and GenAIOps/MLOps pipelines. |
...
| Customize compute session base images for Prompt Flow | https://learn.microsoft.com/en-us/azure/machine-learning/prompt-flow/how-to-customize-session-base-image?view=azureml-api-2 |
...
| Integrate LangChain workflows into Prompt Flow | https://learn.microsoft.com/en-us/azure/machine-learning/prompt-flow/how-to-integrate-with-langchain?view=azureml-api-2 |
| Rebuild Prompt Flow workflows using Agent Framework | https://learn.microsoft.com/en-us/azure/machine-learning/prompt-flow/how-to-migrate-prompt-flow-to-agent-framework?view=azureml-api-2 |
...
| Use Content Safety text tool in prompt flow flows | https://learn.microsoft.com/en-us/azure/machine-learning/prompt-flow/tools-reference/content-safety-text-tool?view=azureml-api-2 |
| Configure the embedding tool in Azure ML prompt flow | https://learn.microsoft.com/en-us/azure/machine-learning/prompt-flow/tools-reference/embedding-tool?view=azureml-api-2 |
...
| Implement Python tools as executable nodes in prompt flow | https://learn.microsoft.com/en-us/azure/machine-learning/prompt-flow/tools-reference/python-tool?view=azureml-api-2 |
...
| Integrate SerpAPI search with prompt flow using SerpAPI tool | https://learn.microsoft.com/en-us/azure/machine-learning/prompt-flow/tools-reference/serp-api-tool?view=azureml-api-2 |
