...
| Integrations & Coding Patterns | L355-L402 | Integrating Azure ML with storage, Spark/Kubernetes/Databricks/Synapse, MLflow, AutoML, pipelines, prompt flow, and external services (Event Grid, Data Factory, AI Search, .NET) for end‑to‑end ML workflows. |
| Deployment | L403-L447 | Deploying and operationalizing models and pipelines (including MLflow, AutoML, prompt flow, batch/online endpoints, MLOps with DevOps/GitHub, and infra as code) in Azure Machine Learning. |
