...
|----------|-------|-------------|
| Troubleshooting | L37-L71 | Diagnosing and fixing Azure ML runtime issues: pipelines, AutoML, endpoints, Kubernetes, networking, environments, prompt flow, feature store, and known/validation errors. |
| Best Practices | L72-L95 | Best practices for Azure ML training, inference, AutoML, prompt flow, monitoring, cost/security, data ethics, and performance tuning (GPU, Kubernetes, checkpoints, scripts). |
| Decision Making | L96-L124 | Guidance on Azure ML architectural and migration decisions: choosing algorithms, training and networking options, cost strategies, DR/failover, and upgrading/migrating from v1 to v2 and between environments. |
...
| Limits & Quotas | L132-L140 | Region/VM availability, service limits, and quota management for Azure ML: regions and sovereign clouds, supported VM SKUs, and planning capacity within Azure ML resource limits. |
| Security | L141-L197 | Securing Azure ML with encryption, identity/RBAC, secrets, network isolation/VNets, private endpoints, policy/governance, and safe access to data, registries, endpoints, and on-prem resources. |
| Configuration | L198-L463 | Configuring Azure ML: components, data, compute, networking, monitoring, AutoML, prompt flow, and full YAML/CLI setup for training, deployment, and MLOps. |
| Integrations & Coding Patterns | L464-L506 | Patterns for connecting Azure ML to data/services, coding with SDK/REST, integrating Spark/Databricks/Synapse/MLflow, and wiring ML endpoints into apps, events, and prompt flows. |
| Deployment | L507-L550 | Deploying and operationalizing models, pipelines, and prompt flows to Azure ML online/batch endpoints, including CI/CD, blue‑green rollouts, MLflow/ONNX, AutoML, and GenAIOps integration. |
...
| Troubleshoot and debug Azure ML SDK v1 pipelines | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-debug-pipelines?view=azureml-api-1 |
...
| Diagnose issues with Azure ML managed virtual networks | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-troubleshoot-managed-network?view=azureml-api-2 |
...
| Plan network isolation for Azure ML v2 API workspaces | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-configure-network-isolation-with-v2?view=azureml-api-2 |
...
| Migrate Azure ML script runs from SDK v1 to v2 jobs | https://learn.microsoft.com/en-us/azure/machine-learning/migrate-to-v2-command-job?view=azureml-api-2 |
| Upgrade AzureML v1 deployment endpoints to v2 | https://learn.microsoft.com/en-us/azure/machine-learning/migrate-to-v2-deploy-endpoints?view=azureml-api-2 |
| Migrate Azure ML AutoML from SDK v1 AutoMLConfig to v2 jobs | https://learn.microsoft.com/en-us/azure/machine-learning/migrate-to-v2-execution-automl?view=azureml-api-2 |
...
| Migrate AzureML v1 parallel run step to v2 parallel job | https://learn.microsoft.com/en-us/azure/machine-learning/migrate-to-v2-execution-parallel-run-step?view=azureml-api-2 |
| Migrate AzureML v1 pipelines to v2 jobs | https://learn.microsoft.com/en-us/azure/machine-learning/migrate-to-v2-execution-pipeline?view=azureml-api-2 |
| Upgrade Azure ML local runs from SDK v1 to v2 | https://learn.microsoft.com/en-us/azure/machine-learning/migrate-to-v2-local-runs?view=azureml-api-2 |
...
| Decide how to migrate Azure ML workspaces to SDK v2 | https://learn.microsoft.com/en-us/azure/machine-learning/migrate-to-v2-resource-workspace?view=azureml-api-2 |
...
| Topic | URL |
|-------|-----|
| Region availability for Azure ML standard deployments | https://learn.microsoft.com/en-us/azure/machine-learning/concept-endpoint-serverless-availability?view=azureml-api-2 |
...
| Configure private endpoints for Azure Machine Learning workspaces | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-configure-private-link?view=azureml-api-2 |
...
| Secure Azure ML with managed virtual network isolation | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-managed-network?view=azureml-api-2 |
...
| Secure Azure ML registries with virtual networks and private endpoints | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-registry-network-isolation?view=azureml-api-2 |
...
| Link OneLake Lakehouse tables to Azure ML datastores via UI | https://learn.microsoft.com/en-us/azure/machine-learning/create-datastore-with-user-interface?view=azureml-api-2 |
...
| Configure inbound and outbound network traffic for secure Azure ML | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-access-azureml-behind-firewall?view=azureml-api-2 |
...
| Configure Azure ML studio datastores and data access | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-connect-data-ui?view=azureml-api-1 |
...
| Configure custom DNS for private Azure ML workspaces | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-custom-dns?view=azureml-api-2 |
...
| Configure data import and data assets in Azure Machine Learning | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-import-data-assets?view=azureml-api-2 |
...
| Define and manage Azure ML environments via CLI and SDK | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-manage-environments-v2?view=azureml-api-2 |
...
| Configure interactive R development on Azure Machine Learning | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-r-interactive-development?view=azureml-api-2 |
...
| Integrate MLflow tracking with Azure Synapse and Azure ML | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-use-mlflow-azure-synapse?view=azureml-api-2 |
| Build multistep Azure ML pipeline components | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-use-pipeline-component?view=azureml-api-2 |
...
| Deploy ONNX models with Triton on Azure ML endpoints | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-deploy-with-triton?view=azureml-api-2 |
...
| Deploy MLflow models for batch inference on Azure ML | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-mlflow-batch?view=azureml-api-2 |
