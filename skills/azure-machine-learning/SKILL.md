...
description: Provides expert guidance on Azure Machine Learning architecture, configuration, deployment, security, integrations, limits, best practices, and troubleshooting across training, inference (classic ML and generative AI), and MLOps/GenAIOps scenarios. Use this skill when you need to design or optimize Azure ML workspaces, pipelines, endpoints, prompt flow setups, CI/CD, networking, or cost/performance, or when diagnosing runtime, quota, or connectivity issues in Azure ML. Not for general Azure (non-ML) services or other cloud ML platforms such as AWS SageMaker or Google Vertex AI.
...
| Best Practices | L72-L94 | Best practices for Azure ML training, inference, AutoML, prompt flow, monitoring, cost/compute optimization, security/ethics, and performance tuning for classic ML and generative AI. |
| Decision Making | L95-L119 | Guidance on Azure ML design decisions: algorithm selection, training and networking choices, cost and DR planning, v1→v2 migration paths, and workspace/compute/data management. |
...
| Security | L137-L195 | Securing Azure ML with encryption, auth/RBAC, identities, secrets, networks/VNets, private endpoints, policies, and compliance for workspaces, endpoints, training, registries, and data. |
| Configuration | L196-L463 | Configuring Azure ML components, compute, data, AutoML, monitoring, and YAML/CLI resources, including pipelines, endpoints, environments, feature stores, prompt flow, and Responsible AI. |
| Integrations & Coding Patterns | L464-L510 | Integrating Azure ML with data sources, Spark/Databricks/Synapse, REST/MLflow, prompt flow, and external services, plus deployment patterns for online/batch endpoints and custom containers. |
| Deployment | L511-L553 | Deploying and operationalizing ML and LLM/prompt-flow models in Azure ML: online/batch endpoints, CI/CD (DevOps/GitHub), MLOps/GenAIOps, rollouts, pipelines, and cross-workspace consumption. |
...
| Configure custom Docker base image for prompt flow sessions | https://learn.microsoft.com/en-us/azure/machine-learning/prompt-flow/how-to-customize-session-base-image?view=azureml-api-2 |
...
| Customize batch deployment outputs in Azure Machine Learning | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-deploy-model-custom-output?view=azureml-api-2 |
...
| Serve models with NVIDIA Triton on Azure ML online endpoints | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-deploy-with-triton?view=azureml-api-2 |
...
| Deploy pipeline components as batch endpoints in Azure ML | https://learn.microsoft.com/en-us/azure/machine-learning/how-to-use-batch-pipeline-deployments?view=azureml-api-2 |
