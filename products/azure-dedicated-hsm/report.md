...
skill_description: Expert knowledge for Azure Dedicated HSM development including
  ...
  deployment. Use when planning HSM sizing/topology, ExpressRoute IP migration, secure
  VNet integration, or Dedicated HSM retirement/migration, and other related development
...
use_when: Use when planning HSM sizing/topology, ExpressRoute IP migration, secure
  VNet integration, or Dedicated HSM retirement/migration, and other related development
  tasks.
