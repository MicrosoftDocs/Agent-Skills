...
category_descriptions:
  security: 'Securing Service Bus namespaces: auth with Entra ID/managed identities/SAS,
    encryption and CMKs, TLS settings, network isolation (VNet, Private Link, firewalls),
    and compliance/policy controls.'
  ...
  integrations: Patterns and code for integrating Service Bus with JMS/AMQP/RabbitMQ/Event
    Grid, subscription filters, replication with Functions, and batch message operations
...
skill_description: Expert knowledge for Azure Service Bus development including troubleshooting,
  ...
  creating queues/topics, using sessions and filters, configuring geo-DR, or scaling
  Premium namespaces, and other Azure Service Bus related development tasks. Not for
...
use_when: Use when creating queues/topics, using sessions and filters, configuring
  geo-DR, or scaling Premium namespaces, and other Azure Service Bus related development
  tasks.
...
| [AMQP protocol guide](https://learn.microsoft.com/en-us/azure/service-bus-messaging/service-bus-amqp-protocol-guide) | integrations | 0.70 | The AMQP protocol guide for Service Bus and Event Hubs typically includes wire-level details, link/session configuration behaviors, protocol-specific capabilities, and product-specific mappings (e.g., how AMQP concepts map to Service Bus entities). These are integration-focused, product-specific details that go beyond generic AMQP knowledge and are needed to correctly implement clients, fitting the integrations & coding patterns category best. |
