...
category_descriptions:
  security: 'Authentication, encryption, network access, TLS, and compliance for securing
    Service Bus: Entra ID, managed identities, SAS, CMK, firewalls, VNets/Private
    Link, and Azure Policy.'
...
skill_description: Expert knowledge for Azure Service Bus development including troubleshooting,
  ...
  securing namespaces, scaling Premium units, integrating via AMQP/JMS, using sessions/filters,
  or tuning throughput, and other Azure Service Bus related development tasks. Not
  for Azure Event Hubs (use azure-event-hubs), Azure Relay (use azure-relay), Azure
  Queue Storage (use azure-queue-storage), Azure Notification Hubs (use azure-notification-hubs).
use_when: Use when securing namespaces, scaling Premium units, integrating via AMQP/JMS,
  using sessions/filters, or tuning throughput, and other Azure Service Bus related
  development tasks.
