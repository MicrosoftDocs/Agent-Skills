...
category_descriptions:
  configuration: 'Configuring VM Scale Sets: scaling rules, upgrades, health/repairs,
    disks, networking, instance mix, standby pools, protection, and automation via
    portal, CLI, PowerShell, and ARM templates.'
...
skill_description: Expert knowledge for Azure Virtual Machine Scale Sets development
  ...
  Use when configuring autoscale rules, upgrade modes, Spot/standby pools, disk encryption,
  or ARM/CLI/PowerShell deployments, and other Azure Virtual Machine Scale Sets related
...
use_when: Use when configuring autoscale rules, upgrade modes, Spot/standby pools,
  disk encryption, or ARM/CLI/PowerShell deployments, and other Azure Virtual Machine
