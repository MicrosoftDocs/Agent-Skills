...
skill_description: Expert knowledge for Azure Service Health development including
  ...
  alerts, RBAC access, VM health analysis, or event retention, and other related development
...
use_when: Use when querying Service/Resource Health via APIs, configuring alerts,
  RBAC access, VM health analysis, or event retention, and other related development
  tasks.
