...
| [Create activity log alerts using ARM template](https://learn.microsoft.com/en-us/azure/service-health/alerts-activity-log-service-notifications-arm) | 0.40 | Shows how to use an ARM template to set up Service Health alerts; focuses on a single example template rather than a full configuration matrix or expert troubleshooting/limits content. |
| [Create activity log alerts using Bicep](https://learn.microsoft.com/en-us/azure/service-health/alerts-activity-log-service-notifications-bicep) | 0.40 | Demonstrates using a Bicep file to create activity log alerts; appears to be a deployment/config example, but not a comprehensive configuration reference with parameter ranges or defaults. |
| [How to create Service health alerts](https://learn.microsoft.com/en-us/azure/service-health/alerts-activity-log-service-notifications-portal) | 0.40 | Step-by-step portal tutorial for creating Service Health alerts; no detailed configuration reference (parameter tables, defaults, ranges) beyond generic alert setup. |
...
| [Send alerts to outside systems via webhook](https://learn.microsoft.com/en-us/azure/service-health/service-health-alert-webhook-guide) | 0.40 | Tutorial-style guidance on using webhooks for Service Health alerts; integration is described generically without detailed parameter tables or product-specific constraints. |
| [Send alerts using OpsGenie](https://learn.microsoft.com/en-us/azure/service-health/service-health-alert-webhook-opsgenie) | 0.40 | Shows how to connect Azure Service Health alerts to OpsGenie using webhooks; primarily a connection tutorial without deep config tables, limits, or error-code mappings. |
| [Send alerts with ServiceNow](https://learn.microsoft.com/en-us/azure/service-health/service-health-alert-webhook-servicenow) | 0.40 | How-to article for integrating Service Health alerts with ServiceNow via webhook; focuses on workflow rather than detailed API/parameter reference or troubleshooting mappings. |
...
| [Service Health notifications data properties](https://learn.microsoft.com/en-us/azure/service-health/service-health-event-properties) | 0.30 | Explains notification data properties at a conceptual level (event types, incident types); does not expose concrete config tables, limits, or error-resolution mappings. |
| [Service Health notifications overview](https://learn.microsoft.com/en-us/azure/service-health/service-health-notifications-properties) | 0.30 | Conceptual overview of Service Health notifications and how they appear in Activity Log; no specific configuration parameters, limits, or troubleshooting mappings. |
...
| [Azure Service Health Portal](https://learn.microsoft.com/en-us/azure/service-health/service-health-portal-update) | 0.20 | Describes the Azure Service Health portal experience and dashboard conceptually; lacks detailed configuration tables, error mappings, or quantified guidance. |
| [Azure Status page overview](https://learn.microsoft.com/en-us/azure/service-health/azure-status-overview) | 0.20 | High-level overview of the Azure Status page and its purpose; no product-specific limits, configuration parameters, error codes, or decision matrices. |
