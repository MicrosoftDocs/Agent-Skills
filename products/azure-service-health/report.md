...
category_descriptions:
  ...
  security: Admin roles, RBAC, and subscription/tenant configuration for viewing Azure
    Service Health history and understanding Security advisories and their access
    controls
...
skill_description: Provides expert guidance on Azure Service Health, including configuring
  Service/Resource Health alerts (portal, ARM, Bicep, PowerShell, Resource Graph),
  deploying alert rules at scale with Azure Policy, integrating health data and alerts
  via APIs/webhooks with tools like OpsGenie, PagerDuty, and ServiceNow, understanding
  notification lifecycles and retention, managing RBAC and access to health history
  and security advisories, and troubleshooting VM Resource Health states and underlying
  platform issues. Use this skill when designing, operating, or debugging health monitoring
  for Azure resources. Not for general Azure Monitor metrics/logs configuration or
  non–Service Health alerting.
---
...
| [Health history overview](https://learn.microsoft.com/en-us/azure/service-health/health-history-overview) | security | 0.60 | Health history overview includes specific RBAC role names (owner, contributor, reader) and mentions special handling for sensitive events like security advisories, indicating product-specific access control guidance. |
...
| [Resource health types and checks](https://learn.microsoft.com/en-us/azure/service-health/resource-health-checks-resource-types) | 0.40 | Reference list of supported resource types and health checks; likely enumerates checks but not in the form of configuration parameters, limits, or troubleshooting mappings required by the defined sub-skill types. |
| [Security notifications overview](https://learn.microsoft.com/en-us/azure/service-health/stay-informed-security) | 0.40 | Security notifications overview and high-level steps to ensure alerts reach the right people; lacks concrete RBAC role lists, permission scopes, or detailed security configuration parameters. |
...
| [AI-generated summary and timelines](https://learn.microsoft.com/en-us/azure/service-health/service-health-ai-summary-timeline) | 0.30 | Overview of AI-generated summaries and timelines for service health alerts; focuses on experience and benefits, not on limits, configs, or troubleshooting details. |
| [Filter Service Health notifications by event level](https://learn.microsoft.com/en-us/azure/service-health/metadata-filter) | 0.30 | Explains how to use Event level metadata to filter and prioritize notifications; conceptual usage guidance without detailed config tables or numeric thresholds. |
| [Impacted Resources from Azure retirements](https://learn.microsoft.com/en-us/azure/service-health/impacted-resources-retirements) | 0.30 | Explains impacted resources for retirements and notes subset coverage; informational without specific limits, configuration parameters, or troubleshooting mappings. |
| [Impacted Resources from Azure security advisories](https://learn.microsoft.com/en-us/azure/service-health/impacted-resources-security) | 0.30 | Describes feature for viewing impacted resources from security advisories and rollout phases; primarily conceptual with no detailed security config, limits, or troubleshooting content. |
| [Impacted Resources from Service issues](https://learn.microsoft.com/en-us/azure/service-health/impacted-resources-outage) | 0.30 | Explains where to see impacted resources during service issues; primarily UI guidance and conceptual description, no detailed configuration tables or numeric thresholds. |
| [Impacted Resources from planned maintenance events](https://learn.microsoft.com/en-us/azure/service-health/impacted-resources-planned-maintenance) | 0.30 | Describes where to view impacted resources for planned maintenance; largely conceptual and UI-oriented without detailed configuration or numeric constraints. |
| [Service Health event tags](https://learn.microsoft.com/en-us/azure/service-health/service-health-event-tags) | 0.30 | Describes event tags, levels, and subtypes conceptually; no specific configuration parameters, limits, or troubleshooting mappings. |
...
| [Azure Service Health Portal](https://learn.microsoft.com/en-us/azure/service-health/service-health-portal-update) | 0.20 | Portal overview of Azure Service Health experience; conceptual and navigational without product-specific numeric limits, configs, or error mappings. |
| [Billing updates overview](https://learn.microsoft.com/en-us/azure/service-health/billing-elevated-access) | 0.20 | Billing updates overview for in-portal communications; high-level informational content without expert-level configuration, limits, or troubleshooting details. |
...
| [What's new](https://learn.microsoft.com/en-us/azure/service-health/whats-new) | 0.20 | What's New page is a high-level feature/changes log without detailed limits, configs, or troubleshooting mappings. |
...
| [Service Health FAQ](https://learn.microsoft.com/en-us/azure/service-health/service-health-faq) | - | FAQ/overview content about Azure Service Health and Resource Health; does not focus on numeric limits, configuration parameter tables, error-code-based troubleshooting, or other product-specific expert details as defined in the sub-skill types. |
