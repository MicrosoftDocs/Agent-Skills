...
| [Support and troubleshooting](https://learn.microsoft.com/en-us/azure/frontdoor/support-help) | 0.10 | Page is about where to get help and support for Azure Front Door (support channels, forums, documentation links). It doesn't contain product-specific limits, configuration parameters, error-code mappings, or other expert technical details. |
