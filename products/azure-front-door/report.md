...
| [Video on-demand and live streaming](https://learn.microsoft.com/en-us/azure/frontdoor/video-on-demand-live-streaming) | 0.20 | From the description and summary, the page is an architectural/performance overview of using Azure Front Door for VOD and live streaming. It focuses on high-level architecture, latency reduction, and global edge delivery, without clear evidence of numeric limits, configuration parameter tables, error codes, or decision matrices with quantified trade-offs. It reads more like conceptual/marketing and general guidance rather than detailed expert configuration, limits, or troubleshooting content. |
