...
category_descriptions:
  ...
  security: Details on WAF security rules (DRS groups), bot protection features on
    Application Gateway, and enforcing WAF configurations and standards using Azure
    Policy.
...
skill_description: Expert knowledge for Azure Web Application Firewall development
  ...
  Sentinel logging, APIM/Azure OpenAI protection, or IaC deployments, and other Azure
  Web Application Firewall related development tasks. Not for Azure Application Gateway
  (use azure-application-gateway), Azure Firewall (use azure-firewall), Azure Front
  Door (use azure-front-door), Azure DDos Protection (use azure-ddos-protection).
use_when: Use when configuring Front Door/App Gateway WAF rules, bot/CAPTCHA, Sentinel
  logging, APIM/Azure OpenAI protection, or IaC deployments, and other Azure Web Application
...
| [Overview](https://learn.microsoft.com/en-us/azure/web-application-firewall/afds/waf-front-door-drs) | security | 0.78 | The page enumerates the Azure Web Application Firewall Default Rule Set (DRS) rule groups and individual rules for Azure Front Door, including product-specific rule identifiers, groupings, and behaviors that define how security is enforced. These are detailed, service-specific security configurations and rule definitions that go beyond generic WAF concepts and are unlikely to be fully known from pretraining. This aligns best with the 'security' sub-skill type. |
