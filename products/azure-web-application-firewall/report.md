...
category_descriptions:
  ...
  security: 'Configuring and governing WAF security: IP restrictions, DRS rule groups,
    exclusions/exceptions, hardening settings, and enforcing policies with Azure Policy.'
