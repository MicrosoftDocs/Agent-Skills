...
category_descriptions:
  ...
  decision-making: Guides for choosing regions, providers, pricing plans, dev environments,
    estimating quantum resources, and understanding costs/billing for Azure Quantum
    jobs and migrations.
  ...
  configuration: Configuring Azure Quantum workspaces, QDK tools, simulators, and
    hardware targets (IonQ, PASQAL, Quantinuum, Rigetti), including resource estimator
    settings, noise models, and VS Code/Jupyter setup.
  ...
  security: 'Managing secure access to Azure Quantum workspaces: RBAC and bulk assignment,
    access control configuration, ARM locks, managed identities, service principals,
    and safe handling of access keys'
  ...
  best-practices: Best practices for using QDK in VS Code with Copilot, optimizing
    ...
    quantum code.
skill_description: Provides expert guidance on Azure Quantum architecture patterns,
  best practices, configuration, decision-making, deployment, integrations, limits/quotas,
  security, and troubleshooting across QDK, simulators, and hardware providers (IonQ,
  PASQAL, Quantinuum, Rigetti). Use this skill when designing hybrid quantum-classical
  workflows, setting up or securing Azure Quantum workspaces, choosing providers/regions/pricing,
  integrating QDK and external circuit formats, deploying via ARM/Bicep/CLI, or diagnosing
  job and connectivity issues. Not for general Azure, classical HPC, or non-Azure
  quantum services such as AWS Braket or IBM Quantum.
---
...
| [Add a group to your Azure Quantum workspace](https://learn.microsoft.com/en-us/azure/quantum/bulk-add-users-to-a-workspace) | configuration | 0.68 | The article describes a CSV-driven bulk user-add process for Azure Quantum workspaces, which implies specific column names/fields and required values unique to this product’s access model. That constitutes product-specific configuration details for managing workspace users, beyond generic conceptual guidance. |
...
| [Migrate your Azure Quantum job data](https://learn.microsoft.com/en-us/azure/quantum/migration-guide) | decision-making | 0.65 | The migration guide distinguishes between managed and unmanaged storage workspaces and provides concrete implications (for example, loss of visible job history while retaining input/output data) and different instructions per scenario. This is product-specific migration and trade-off guidance that helps decide how and when to move a workspace to a new region. |
...
| [Submit a circuit with Qiskit](https://learn.microsoft.com/en-us/azure/quantum/quickstart-microsoft-qiskit) | 0.20 | Quickstart-style tutorial on submitting Qiskit programs via QDK; focuses on how to run from VS Code/Jupyter. No evidence of detailed limits, configuration tables, error-code mappings, or product-specific decision matrices. |
...
| [Work with Q# projects](https://learn.microsoft.com/en-us/azure/quantum/how-to-work-with-qsharp-projects) | 0.20 | Explains how to create and manage Q# projects and libraries at a conceptual/how-to level. No specific quotas, configuration matrices, security roles, or error-code-based troubleshooting content indicated. |
...
| [The circuit editor](https://learn.microsoft.com/en-us/azure/quantum/qdk-circuit-editor) | 0.10 | Introduces the circuit editor feature and its usage conceptually. Does not appear to include configuration parameter tables, limits, or troubleshooting mappings. |
