...
skill_description: Expert knowledge for Azure Managed Applications development including
  ...
  UIs, StorageAccountSelector usage, external package storage, JIT access, or managed
  identities, and other related development tasks. Not for Azure Lighthouse (use azure-lighthouse),
  Azure Partner Solutions (use azure-partner-solutions), Azure Resource Manager (use
  azure-resource-manager), Azure Blueprints (use azure-blueprints).
use_when: Use when designing createUiDefinition UIs, StorageAccountSelector usage,
  external package storage, JIT access, or managed identities, and other related development
  tasks.
