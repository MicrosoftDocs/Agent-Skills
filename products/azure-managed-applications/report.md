...
skill_description: Expert knowledge for Azure Managed Applications development including
  ...
  Not for Azure Lighthouse (use azure-lighthouse), Azure Resource Manager (use azure-resource-manager),
  Azure Blueprints (use azure-blueprints), Azure Deployment Environments (use azure-deployment-environments).
