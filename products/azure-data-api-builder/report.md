...
skill_description: Expert knowledge for Azure Data Api Builder development including
  ...
  DAB REST/GraphQL, Entra-secured APIs, Azure deployments, or SQL MCP tools, and other
...
use_when: Use when exposing SQL/Cosmos via DAB REST/GraphQL, Entra-secured APIs, Azure
  deployments, or SQL MCP tools, and other related development tasks.
