...
skill_description: Expert knowledge for Azure Batch development including troubleshooting,
  ...
  configuring Batch pools/tasks, autoscale, private networking, CI/CD deployment,
  or SDK-based job orchestration, and other Azure Batch related development tasks.
...
use_when: Use when configuring Batch pools/tasks, autoscale, private networking, CI/CD
  deployment, or SDK-based job orchestration, and other Azure Batch related development
  tasks.
