...
|-----------|------------|--------|
| [Create file system in Azure portal](https://learn.microsoft.com/en-us/azure/azure-managed-lustre/create-file-system-portal) | 0.20 | Portal-based creation tutorial; likely step-by-step UI guidance without detailed limits, configuration parameter tables, or troubleshooting matrices. Does not clearly match any expert-knowledge sub-skill type from the description alone. |
