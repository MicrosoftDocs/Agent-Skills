...
category_descriptions:
  ...
  troubleshooting: Diagnosing and resolving Azure Managed Lustre deployment failures
    and cluster performance issues, including common error causes, tuning, and troubleshooting
    steps.
skill_description: Expert knowledge for Azure Managed Lustre development including
  ...
  integrating with Blob (auto import/export), using AKS CSI, quotas, or performance
  tuning, and other Azure Managed Lustre related development tasks. Not for Azure
...
use_when: Use when mounting AMLFS, integrating with Blob (auto import/export), using
  AKS CSI, quotas, or performance tuning, and other Azure Managed Lustre related development
  tasks.
