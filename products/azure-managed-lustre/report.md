...
category_descriptions:
  configuration: 'Setting up and managing Azure Managed Lustre: network/storage prereqs,
    client install/upgrade, mounting (incl. fstab), ARM/Bicep deployment, and monitoring/metrics
    with Azure Monitor.'
...
skill_description: Expert knowledge for Azure Managed Lustre development including
  ...
  filesystems, linking Blob (import/export), using AKS CSI, setting quotas, or tuning
  performance, and other Azure Managed Lustre related development tasks. Not for Azure
  HPC Cache (use azure-hpc-cache), Azure NetApp Files (use azure-netapp-files), Azure
  Blob Storage (use azure-blob-storage), Azure Elastic SAN (use azure-elastic-san).
use_when: Use when mounting AML filesystems, linking Blob (import/export), using AKS
  CSI, setting quotas, or tuning performance, and other Azure Managed Lustre related
  development tasks.
...
- [Prerequisites](https://learn.microsoft.com/en-us/azure/azure-managed-lustre/amlfs-prerequisites)
  - Updated: 2025-08-01T17:07:00.000Z → 2026-03-27T17:04:00.000Z
...
| [Prerequisites](https://learn.microsoft.com/en-us/azure/azure-managed-lustre/amlfs-prerequisites) | configuration | 0.78 | The prerequisites page contains product-specific configuration requirements for Azure Managed Lustre file systems, including required subnet/network setups, storage and resource dependencies, and other concrete setup conditions that must be met before creation. These are detailed, service-specific configuration rules rather than generic concepts, fitting the configuration sub-skill. |
