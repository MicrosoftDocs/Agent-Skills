...
skill_description: Expert knowledge for Microsoft Foundry Local (aka Azure AI Foundry
  ...
  for Microsoft Foundry (use microsoft-foundry), Microsoft Foundry Classic (use microsoft-foundry-classic),
  Microsoft Foundry Tools (use microsoft-foundry-tools), Azure Local (use azure-local).
