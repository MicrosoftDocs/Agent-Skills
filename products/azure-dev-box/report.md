...
| [Windows 365 adds Microsoft Dev Box capabilities](https://learn.microsoft.com/en-us/azure/dev-box/dev-box-windows-365-announcement) | 0.10 | Announcement/marketing-style content about Dev Box capabilities transitioning to Windows 365; no detailed limits, configuration parameters, error codes, or decision matrices with quantified trade-offs. |
