...
category_descriptions:
  decision-making: Guidance on choosing ADME deployment tiers (Developer vs Standard)
    ...
    each tier.
  configuration: 'Configuring ADME behavior: data partitioning, CORS, Reservoir DDMS
    enablement, audit logging setup, and milestone upgrade settings.'
...
skill_description: Expert knowledge for Azure Energy Data Services development including
  ...
  legal tags/ACLs, Geospatial CZ on AKS, DDMS APIs, or manifest ingestion, and other
...
use_when: Use when configuring ADME partitions/CORS, legal tags/ACLs, Geospatial CZ
  on AKS, DDMS APIs, or manifest ingestion, and other Azure Energy Data Services related
  development tasks.
...
| [Manage upgrade settings](https://learn.microsoft.com/en-us/azure/energy-data-services/how-to-manage-upgrade-settings) | configuration | 0.70 | Page is focused on managing upgrade behavior for Azure Data Manager for Energy instances, describing specific upgrade settings and how they control milestone upgrades. This is product-specific configuration guidance (how to set and adjust upgrade-related parameters), not just a conceptual overview. While it may not list numeric limits, it defines concrete settings and behaviors unique to this service, fitting the configuration sub-skill. |
...
| [Syncing Reference data values](https://learn.microsoft.com/en-us/azure/energy-data-services/concepts-reference-data-values) | 0.20 | Content is a conceptual overview of reference data values and synchronization behavior in Azure Data Manager for Energy/OSDU, without numeric limits, configuration parameter tables, error-code-based troubleshooting, or decision matrices. It does not meet the specific detection criteria for any expert-knowledge sub-skill type. |
