...
category_descriptions:
  deployment: How to deploy and modify Azure Firewall (Standard/Premium) using ARM
    templates, Bicep, or Terraform, including SKU changes and configuring IP Groups.
...
| [Change Azure Firewall SKU](https://learn.microsoft.com/en-us/azure/firewall/change-sku) | deployment | 0.68 | Provides product-specific guidance for upgrading/downgrading Azure Firewall between Standard and Premium SKUs, including concrete migration paths and constraints that affect how and when to change SKUs, which are deployment/production considerations not inferable from generic knowledge. |
