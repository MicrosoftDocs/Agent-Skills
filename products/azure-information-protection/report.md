...
skill_description: Expert knowledge for Azure Information Protection development including
  ...
  Azure RMS vs AD RMS, migrating keys/policies, deploying RMS connector/MSIPC, or
  analyzing RMS logs, and other related development tasks. Not for Azure Key Vault
  (use azure-key-vault), Azure Security (use azure-security), Azure Role-based access
  control (use azure-rbac), Azure Sentinel (use azure-sentinel).
use_when: Use when choosing Azure RMS vs AD RMS, migrating keys/policies, deploying
  RMS connector/MSIPC, or analyzing RMS logs, and other related development tasks.
confusable_not_for: Not for Azure Key Vault (use azure-key-vault), Azure Security
  (use azure-security), Azure Role-based access control (use azure-rbac), Azure Sentinel
  (use azure-sentinel).
---
