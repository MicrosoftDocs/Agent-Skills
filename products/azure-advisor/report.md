...
| [Reliability](https://learn.microsoft.com/en-us/azure/advisor/advisor-reference-reliability-recommendations) | 0.30 | Page is a catalog/list of reliability recommendations in Azure Advisor. It likely enumerates recommendation names and descriptions but not detailed limits, configuration parameters, or troubleshooting mappings with error codes. It functions more as reference/overview than expert configuration or decision content. |
...
| [Customize your view](https://learn.microsoft.com/en-us/azure/advisor/advisor-customize-view) | 0.20 | Page describes how to use filters and grouping in the Azure portal UI for Advisor recommendations. It’s a usage/navigation guide without product-specific limits, configuration parameter tables, error codes, or decision matrices. |
