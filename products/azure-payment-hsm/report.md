...
| [Lifecycle management](https://learn.microsoft.com/en-us/azure/payment-hsm/lifecycle-management) | 0.20 | Lifecycle description of Azure Payment HSM and Thales payShield 10K usage appears to be a conceptual/service overview without specific limits, configuration parameters, error codes, or decision matrices that meet the expert-knowledge criteria. |
