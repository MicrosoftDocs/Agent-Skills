...
category_descriptions:
  configuration: Configuring Azure IoT Operations data flows, endpoints, schemas,
    WASM, MQTT broker, observability, and device/asset registry settings for routing,
    transforming, and monitoring IoT data.
  ...
  security: 'Securing Azure IoT Operations: TLS/cert management, OPC UA trust, MQTT
    authz/authn and encryption, RBAC roles, secrets in Key Vault/Kubernetes, and image
    validation.'
  ...
  troubleshooting: Diagnosing and fixing Azure IoT Operations deployment and runtime
    ...
    guidance.
skill_description: 'Provides expert guidance on Azure IoT Operations across troubleshooting,
  best practices, decision making, architecture & design patterns, limits & quotas,
  security, configuration, integrations, and deployment on Kubernetes. Use this skill
  when designing or operating production Azure IoT Operations environments: planning
  layered/segmented industrial networks, configuring MQTT broker and data flows, integrating
  industrial protocols and edge modules, securing and monitoring workloads, sizing
  and scaling clusters, and diagnosing deployment/runtime issues. Not for generic
  Azure IoT, IoT Hub, or non–Azure IoT platforms.'
---
...
| [Enable secure settings](https://learn.microsoft.com/en-us/azure/iot-operations/deploy-iot-ops/howto-enable-secure-settings) | security | 0.70 | How-to article focused on enabling secure settings, secrets management, and user-assigned managed identities for Azure IoT Operations instances. This is product-specific security configuration, likely including concrete identity/secret setup steps and parameters beyond generic security concepts. |
...
| [Connect to SSE endpoints](https://learn.microsoft.com/en-us/azure/iot-operations/discover-manage-assets/howto-use-sse-connector) | configuration | 0.65 | How-to for configuring assets/devices to connect to SSE endpoints via UI or CLI. This is product-specific configuration of connectors and asset definitions, likely including concrete parameter names and settings for SSE connections rather than just conceptual guidance. |
...
| [Start developing with the SDKs](https://learn.microsoft.com/en-us/azure/iot-operations/develop-edge-apps/quickstart-get-started-sdks) | 0.20 | Quickstart for setting up a development environment and running SDK samples; appears procedural without detailed configuration matrices, limits, or troubleshooting mappings. |
...
| [Developer guide](https://learn.microsoft.com/en-us/azure/iot-operations/develop-edge-apps/overview-iot-operations-development) | 0.10 | High-level overview of Azure IoT Operations development tools and extension points; no detailed limits, configuration tables, error codes, or product-specific best-practice values. |
