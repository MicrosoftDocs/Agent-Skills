...
skill_description: Expert knowledge for Azure HPC Cache development including troubleshooting,
  ...
  setting up HPC Cache namespaces, NFS/Blob targets, AD access, write-back flows,
  or multi-region failover, and other related development tasks. Not for Azure Managed
...
use_when: Use when setting up HPC Cache namespaces, NFS/Blob targets, AD access, write-back
  flows, or multi-region failover, and other related development tasks.
