...
skill_description: Expert knowledge for Azure NAT Gateway development including troubleshooting,
  ...
  configuration, and deployment. Use when planning SNAT capacity, configuring Standard/StandardV2,
  analyzing flow logs, or designing hub-spoke outbound paths, and other related development
  tasks. Not for Azure Load Balancer (use azure-load-balancer), Azure Virtual Network
...
use_when: Use when planning SNAT capacity, configuring Standard/StandardV2, analyzing
  flow logs, or designing hub-spoke outbound paths, and other related development
  tasks.
