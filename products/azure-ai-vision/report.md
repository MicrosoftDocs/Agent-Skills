...
skill_description: Expert knowledge for Azure AI Vision development including decision
  ...
  Use when using Image Analysis, Read OCR containers, Blob-based image input, smart-crop
  thumbnails, or video frame analysis, and other related development tasks. Not for
...
use_when: Use when using Image Analysis, Read OCR containers, Blob-based image input,
  smart-crop thumbnails, or video frame analysis, and other related development tasks.
