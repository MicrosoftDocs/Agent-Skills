...
skill_description: Expert knowledge for Azure Attestation development including troubleshooting,
  ...
  tokens, authoring policies, configuring SGX/TPM baselines, or securing private endpoints,
  and other related development tasks. Not for Azure Confidential Computing (use azure-confidential-computing),
...
use_when: Use when validating attestation tokens, authoring policies, configuring
  SGX/TPM baselines, or securing private endpoints, and other related development
  tasks.
