...
category_descriptions:
  ...
  configuration: 'Configuring SRE Agent capabilities: code interpreter, knowledge
    sources, tools/skills, governance hooks, subagents, incident plans, connectors,
    network/VNet, GitHub auth, MCP/IDE, and REST hooks.'
...
| [User roles and permissions](https://learn.microsoft.com/en-us/azure/sre-agent/user-roles) | security | 0.75 | Access control and permissions for an agent that can act on production infrastructure; likely includes Azure RBAC role names, scopes, and layered access rules that are product-specific security configuration details. |
...
| [Network integration](https://learn.microsoft.com/en-us/azure/sre-agent/network-integration) | configuration | 0.70 | The page describes specific network control modes, traffic routing behavior, and how to configure Azure VNet mode for the SRE Agent. This is product-specific configuration guidance with concrete settings and behaviors that go beyond generic networking concepts. |
...
| [Managed connectors](https://learn.microsoft.com/en-us/azure/sre-agent/managed-connectors) | configuration | 0.65 | Managed connectors with per-tool governance controls imply product-specific configuration options and allowed operations for external services; likely includes settings and constraints unique to these integrations. |
...
| [Pricing and billing](https://learn.microsoft.com/en-us/azure/sre-agent/pricing-billing) | 0.40 | Pricing and billing content can include specific rates and cost examples, but the described focus is on how billing works conceptually (AAUs, always-on vs active flow) and general cost management tips. There is no clear indication of detailed configuration parameters, limits/quotas, or decision matrices that meet the expert-knowledge criteria. |
...
| [Run your first investigation](https://learn.microsoft.com/en-us/azure/sre-agent/first-investigation) | 0.20 | Walkthrough for running a first investigation; likely a basic tutorial without expert-level limits, security roles, or troubleshooting mappings. |
...
| [Team onboarding](https://learn.microsoft.com/en-us/azure/sre-agent/team-onboard) | 0.20 | Team onboarding and contextual information for investigations; appears conceptual and workflow-oriented without product-specific numeric limits, configs, or error mappings. |
...
| [What is SRE Agent?](https://learn.microsoft.com/en-us/azure/sre-agent/overview) | 0.20 | High-level product overview of Azure SRE Agent capabilities and scenarios; no specific limits, configs, roles, or error details. |
...
| [Live Reports](https://learn.microsoft.com/en-us/azure/sre-agent/live-reports) | - | The summary focuses on what Live Reports are and their general behavior, with only high-level mention of AAU consumption. It lacks detailed limits, configuration parameters, error codes, or decision matrices, so it does not meet the expert-knowledge criteria for any sub-skill type. |
