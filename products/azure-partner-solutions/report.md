...
category_descriptions:
  ...
  security: Managing security for partner solutions, including Confluent Cloud RBAC
    ...
    deployments
  troubleshooting: Diagnosing and fixing common integration, configuration, and runtime
    issues for Azure-native partner services like Confluent, Airflow, Datadog, Dynatrace,
    Elastic, Informatica, and New Relic
...
skill_description: Expert knowledge for Azure Partner Solutions development including
  ...
  Cloud, Dynatrace APM, Datadog/Elastic configs, or Palo Alto Cloud NGFW, and other
...
use_when: Use when using Service Connector, Confluent Cloud, Dynatrace APM, Datadog/Elastic
  configs, or Palo Alto Cloud NGFW, and other Azure Partner Solutions related development
  tasks.
confusable_slugs:
- azure-industry
...
| integrations | 2 | 1.8% |
| security | 2 | 1.8% |
| troubleshooting | 10 | 9.0% |
| *(Unclassified)* | 80 | 72.1% |
...
| [FAQ](https://learn.microsoft.com/en-us/azure/partner-solutions/datadog/faq) | troubleshooting | 0.70 | The description explicitly calls out troubleshooting along with features and billing. Azure Native Datadog FAQ content commonly includes specific portal messages, configuration pitfalls, and resolution steps for issues like resource linking, metrics/logs not appearing, or billing discrepancies. This is expert, product-specific symptom → solution guidance, fitting the troubleshooting category. |
| [FAQ](https://learn.microsoft.com/en-us/azure/partner-solutions/dynatrace/faq) | troubleshooting | 0.70 | The FAQ covers onboarding, environment linking, metrics/logs configuration, SSO, billing, data residency, free trial, and troubleshooting. Such content typically includes concrete misconfiguration patterns and their fixes (for example, why metrics don’t flow, SSO not working, or trial limitations), which is expert operational knowledge structured as questions with targeted resolutions, matching troubleshooting. |
...
| [FAQ](https://learn.microsoft.com/en-us/azure/partner-solutions/astronomer/faq) | troubleshooting | 0.65 | FAQ pages for specific Azure Native ISV integrations typically include concrete, product-specific error behaviors and resolutions (for example, subscription/creation failures, portal integration issues, billing linkage problems). These are organized as question → cause/behavior → resolution, which aligns with troubleshooting. While also covering general questions, such FAQs usually embed expert operational knowledge that goes beyond conceptual overviews. |
| [FAQ](https://learn.microsoft.com/en-us/azure/partner-solutions/elastic/faq) | troubleshooting | 0.65 | An FAQ for Elastic Cloud/Observability/Security on Azure generally documents specific integration issues (for example, deployment failures, region constraints, data ingestion not working) and how to resolve them. This is product- and platform-specific troubleshooting knowledge rather than generic concepts, so it best fits the troubleshooting sub-skill. |
...
| [FAQ](https://learn.microsoft.com/en-us/azure/partner-solutions/informatica/faq) | troubleshooting | 0.60 | The FAQ for Informatica IDMC as an Azure Native ISV Service is likely to include concrete questions around onboarding, connectivity, permissions, and runtime behavior, with specific answers and fixes. That pattern is expert, product-specific troubleshooting guidance rather than high-level marketing or conceptual content. |
...
| [FAQ](https://learn.microsoft.com/en-us/azure/partner-solutions/apache-kafka-confluent-cloud/faq) | 0.40 | FAQ for Apache Kafka & Apache Flink on Confluent Cloud; while FAQs can contain expert details, the provided summary is generic and doesn’t indicate specific error codes, limits, or configuration tables. |
...
| [FAQ](https://learn.microsoft.com/en-us/azure/partner-solutions/mongo-db/faq) | 0.30 | FAQ for MongoDB Atlas on Azure is likely high-level Q&A about setup, management, and support without detailed limits tables, config parameter matrices, or error-code-based troubleshooting. No clear indication of expert-only numeric limits or product-specific configuration references. |
| [FAQ](https://learn.microsoft.com/en-us/azure/partner-solutions/neon/faq) | 0.30 | FAQ for Neon Serverless Postgres on Azure appears to cover general features, setup, and management. Description does not suggest detailed limits, configuration parameter tables, or structured troubleshooting content with error codes. |
| [FAQ](https://learn.microsoft.com/en-us/azure/partner-solutions/nginx/faq) | 0.30 | NGINXaaS FAQ likely focuses on capabilities, getting started, and support. The summary does not indicate presence of numeric limits, RBAC role tables, or specific configuration parameter matrices that would qualify as expert knowledge. |
| [FAQ](https://learn.microsoft.com/en-us/azure/partner-solutions/palo-alto/faq) | 0.30 | Cloud NGFW by Palo Alto Networks FAQ is described as covering deployment, management, and configuration at a Q&A level. No evidence of detailed limits, decision matrices, or error-code-based troubleshooting that meet the expert-knowledge criteria. |
...
| [Manage resources](https://learn.microsoft.com/en-us/azure/partner-solutions/qumulo/manage) | 0.30 | Managing Azure Native Qumulo settings article likely explains how to use the portal and basic management operations. The summary does not indicate detailed configuration parameter tables, limits, or structured troubleshooting content. |
...
| [Confluent](https://learn.microsoft.com/en-us/azure/partner-solutions/apache-kafka-confluent-cloud/) | 0.25 | Confluent Cloud with Azure documentation root; appears to be a high-level integration overview without explicit limits, configuration parameter tables, or decision matrices. |
...
| [Astro](https://learn.microsoft.com/en-us/azure/partner-solutions/astronomer/) | 0.20 | Apache Airflow on Astro Azure Native ISV landing page; content is about seamless orchestration and integration, not detailed product-specific settings or troubleshooting. |
| [Create a Qumulo resource](https://learn.microsoft.com/en-us/azure/partner-solutions/qumulo/create) | 0.20 | Quickstart for creating Azure Native Qumulo service is primarily a step-by-step getting-started guide. These typically show one example configuration rather than comprehensive configuration tables, limits, or decision matrices. |
...
| [Datadog](https://learn.microsoft.com/en-us/azure/partner-solutions/datadog/) | 0.20 | Landing/overview page for Datadog Azure Native ISV integration; description indicates high-level capabilities and management, not detailed limits, configuration tables, or troubleshooting content. |
| [Dynatrace](https://learn.microsoft.com/en-us/azure/partner-solutions/dynatrace/) | 0.20 | Overview for Azure Native Dynatrace Service; focuses on what the service does and native experience, not specific quotas, config parameters, or error mappings. |
| [Elastic](https://learn.microsoft.com/en-us/azure/partner-solutions/elastic/) | 0.20 | Elastic with Azure documentation landing page; summary is conceptual (centralized analytics) without expert-level numeric limits, decision matrices, or configuration tables. |
| [F5](https://learn.microsoft.com/en-us/azure/partner-solutions/nginx/) | 0.20 | NGINXaaS Azure Native ISV landing page; focuses on what you can do (create, manage, get support) rather than detailed settings, quotas, or troubleshooting mappings. |
...
| [Informatica](https://learn.microsoft.com/en-us/azure/partner-solutions/informatica/) | 0.20 | Informatica Azure Native ISV landing page; describes marketplace integration and management at a conceptual level, not expert configuration or troubleshooting details. |
...
| [MongoDB Atlas](https://learn.microsoft.com/en-us/azure/partner-solutions/mongo-db/) | 0.20 | MongoDB Atlas Azure Native integration overview; summary is marketing-style (fully managed, vector search) without specific quotas, config options, or error codes. |
| [Neon Serverless Postgres](https://learn.microsoft.com/en-us/azure/partner-solutions/neon/) | 0.20 | Neon Serverless Postgres Azure Native integration page noting deprecation; likely a brief status/overview page without detailed expert configuration or limits. |
| [Palo Alto Network](https://learn.microsoft.com/en-us/azure/partner-solutions/palo-alto/) | 0.20 | Cloud NGFW by Palo Alto Networks Azure Native integration overview; description is high-level and marketplace-oriented, not expert-level technical guidance. |
