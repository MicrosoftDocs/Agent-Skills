...
skill_description: Expert knowledge for Azure AI Document Intelligence development
  ...
  and deployment. Use when using AnalyzeDocument API, custom models, containers, SAS/managed
  identity access, or Logic Apps/Functions workflows, and other related development
  tasks. Not for Azure AI services (use azure-ai-services), Azure AI Search (use azure-cognitive-search),
  Azure AI Vision (use azure-ai-vision), Azure AI Immersive Reader (use azure-immersive-reader).
use_when: Use when using AnalyzeDocument API, custom models, containers, SAS/managed
  identity access, or Logic Apps/Functions workflows, and other related development
  tasks.
confusable_not_for: Not for Azure AI services (use azure-ai-services), Azure AI Search
  (use azure-cognitive-search), Azure AI Vision (use azure-ai-vision), Azure AI Immersive
