...
category_descriptions:
  ...
  decision-making: Guidance on planning, comparing, and migrating Azure Cloud Services
    (classic to extended support), including VMSS comparison, VNet requirements, and
...
skill_description: Expert knowledge for Azure Cloud Services development including
  ...
  roles, .csdef/.cscfg, Guest OS versions, Key Vault certs, or autoscale rules, and
  other Azure Cloud Services related development tasks. Not for Azure Networking (use
  azure-networking), Azure Virtual Machines (use azure-virtual-machines), Azure Resource
  Manager (use azure-resource-manager), Azure Portal (use azure-portal).
use_when: Use when managing Cloud Services roles, .csdef/.cscfg, Guest OS versions,
  Key Vault certs, or autoscale rules, and other Azure Cloud Services related development
  tasks.
...
| [Frequently asked questions](https://learn.microsoft.com/en-us/azure/cloud-services-extended-support/faq) | decision-making | 0.70 | FAQ includes product-specific operational details and guidance such as migration behavior, feature support differences from classic Cloud Services, SKU/role considerations, and scenario-based recommendations (for example, when to use Cloud Services extended support vs other Azure services). These are concrete, service-specific decision and behavior details that go beyond generic concepts, fitting decision-making better than other categories. |
