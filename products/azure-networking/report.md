...
skill_description: Expert knowledge for Azure Networking development including troubleshooting,
  ...
  & coding patterns. Use when designing Azure VNets/topologies, routing via hubs/firewalls/VPN,
  Zero Trust policies, or Resource Graph queries, and other related development tasks.
...
use_when: Use when designing Azure VNets/topologies, routing via hubs/firewalls/VPN,
  Zero Trust policies, or Resource Graph queries, and other related development tasks.
