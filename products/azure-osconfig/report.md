...
| [LAPS for Azure Arc Overview](https://learn.microsoft.com/en-us/azure/osconfig/overview-laps-azure-arc) | 0.20 | Page is an overview of LAPS for Azure Arc describing what it is and how it integrates with Azure governance. From the summary it does not appear to list specific configuration parameters, RBAC roles, limits, or troubleshooting details; it is primarily conceptual/introductory content rather than expert, implementation-specific guidance. |
