...
| [LAPS for Azure Arc Overview](https://learn.microsoft.com/en-us/azure/osconfig/overview-laps-azure-arc) | 0.20 | The page is an overview of LAPS for Azure Arc, describing what the feature is and how it integrates with Azure governance. From the summary it does not appear to include concrete configuration parameter tables, RBAC role lists, limits, or troubleshooting mappings; it is primarily conceptual/introductory content rather than expert, implementation-specific details. |
