...
| [Overview](https://learn.microsoft.com/en-us/azure/external-attack-surface-management/overview) | 0.10 | High-level product overview of Microsoft Defender External Attack Surface Management without specific limits, configuration parameters, error codes, or decision matrices; primarily conceptual and marketing-style description. |
