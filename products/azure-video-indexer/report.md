...
category_descriptions:
  ...
  troubleshooting: Diagnosing and resolving Azure Video Indexer Arc connectivity,
    firewall, and streaming issues, including network checks, configuration validation,
    and common error troubleshooting.
  decision-making: Guidance on cost planning, live AI insight selection vs custom
    models, camera analytics choices, and multi-tenant management strategies for Azure
    AI Video Indexer.
  configuration: 'Configuring Video Indexer behavior: live AI insights, OpenAI integration,
    indexing options, regions, monitoring/diagnostics data, speaker identities, and
...
skill_description: Expert knowledge for Azure AI Video Indexer development including
  ...
  integrations & coding patterns, and deployment. Use when configuring live AI insights,
  OpenAI integration, ARM-based deployment, APIs/widgets, or face redaction, and other
  Azure AI Video Indexer related development tasks. Not for Azure AI Vision (use azure-ai-vision),
  Azure AI Custom Vision (use azure-custom-vision), Azure AI Face (use azure-face),
  Azure AI Immersive Reader (use azure-immersive-reader).
use_when: Use when configuring live AI insights, OpenAI integration, ARM-based deployment,
  APIs/widgets, or face redaction, and other Azure AI Video Indexer related development
  tasks.
...
| [Troubleshooting guide](https://learn.microsoft.com/en-us/azure/azure-video-indexer/arc/azure-video-indexer-enabled-by-arc-troubleshooting) | troubleshooting | 0.75 | Explicitly a troubleshooting article for Azure AI Video Indexer enabled by Arc. Such pages typically list concrete error messages, causes, and resolutions for connectivity, streaming, and encoding, which are product-specific diagnostic details not generally known from training. |
...
| [Add or remove cameras](https://learn.microsoft.com/en-us/azure/azure-video-indexer/arc/live-add-remove-camera) | 0.30 | Procedural guide for adding/removing cameras; summary indicates basic usage instructions rather than detailed configuration parameter tables or limits. |
...
| [Deploy extension](https://learn.microsoft.com/en-us/azure/azure-video-indexer/arc/live-extension) | 0.30 | How-to guide for creating/updating/deleting extensions for real-time analysis; summary suggests procedural steps rather than detailed configuration tables, limits, or error-code-based troubleshooting. |
...
| [Manage cameras](https://learn.microsoft.com/en-us/azure/azure-video-indexer/arc/live-manage-camera) | 0.25 | Describes camera management page and editable information; likely UI-level description without deep configuration ranges, quotas, or troubleshooting mappings. |
...
| [Overview](https://learn.microsoft.com/en-us/azure/azure-video-indexer/arc/live-analysis) | 0.20 | Overview of real-time analysis capabilities; appears conceptual and feature-focused without numeric limits, decision matrices, or detailed configuration parameters. |
| [Release notes](https://learn.microsoft.com/en-us/azure/azure-video-indexer/arc/release-notes) | 0.20 | Release notes often contain version changes and bug fix descriptions but usually lack structured limits, configuration tables, or troubleshooting mappings. They are more about change history than reusable expert patterns or numeric constraints, so they don't fit the defined sub-skill types. |
| [Start on Azure Arc](https://learn.microsoft.com/en-us/azure/azure-video-indexer/arc/azure-video-indexer-enabled-by-arc-quickstart) | 0.20 | Quickstart/tutorial for enabling the Arc extension; typically step-by-step setup without detailed configuration matrices, limits, or specialized troubleshooting content. |
...
| [What is VI enabled by Azure Arc?](https://learn.microsoft.com/en-us/azure/azure-video-indexer/arc/azure-video-indexer-enabled-by-arc-overview) | 0.20 | High-level overview of Azure AI Video Indexer enabled by Arc; no specific limits, configuration tables, error codes, or product-specific numeric thresholds. |
