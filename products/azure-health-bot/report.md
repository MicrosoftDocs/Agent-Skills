...
| [Healthcare agent service for Microsoft Copilot M365](https://learn.microsoft.com/en-us/azure/health-bot/quickstart-copilot-m365-integration) | 0.20 | Quickstart that primarily links to a GitHub repo and describes high-level integration of Healthcare Agent Service with Microsoft 365 Copilot; no visible limits, configuration tables, error codes, or product-specific parameter details that meet the expert-knowledge criteria. |
