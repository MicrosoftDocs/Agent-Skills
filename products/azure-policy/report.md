...
skill_description: Expert knowledge for Azure Policy development including troubleshooting,
  ...
  via ARM/Bicep/Terraform, mapping to CIS/NIST, querying with Resource Graph, or migrating
  from DSC/Automanage, and other related development tasks. Not for Azure Blueprints
...
use_when: Use when authoring Machine Configuration packages, deploying via ARM/Bicep/Terraform,
  mapping to CIS/NIST, querying with Resource Graph, or migrating from DSC/Automanage,
  and other related development tasks.
