...
category_descriptions:
  ...
  security: Using Azure Policy and Machine Configuration for security baselines and
    regulatory compliance mappings (CIS, NIST, ISO, PCI, FedRAMP, HIPAA, etc.), including
    initiatives, exemptions, and benchmarks.
...
skill_description: Expert knowledge for Azure Policy development including troubleshooting,
  ...
  via ARM/Bicep/Terraform, mapping to CIS/NIST baselines, migrating from DSC, or querying
...
use_when: Use when authoring Machine Configuration packages, deploying via ARM/Bicep/Terraform,
  mapping to CIS/NIST baselines, migrating from DSC, or querying compliance with Resource
...
|------|-------|------------|
| best-practices | 12 | 7.6% |
| configuration | 11 | 7.0% |
| decision-making | 3 | 1.9% |
| deployment | 7 | 4.4% |
| integrations | 2 | 1.3% |
| security | 60 | 38.0% |
| troubleshooting | 3 | 1.9% |
| *(Unclassified)* | 60 | 38.0% |
...
- [Windows agent release notes](https://learn.microsoft.com/en-us/azure/governance/machine-configuration/whats-new/agent/windows)
  - Updated: 2026-04-15T06:10:00.000Z → 2026-04-24T06:15:00.000Z
...
- [FedRAMP High](https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-fedramp-high)
  - Updated: 2025-10-20T08:00:00.000Z → 2026-04-18T08:00:00.000Z
...
- [Microsoft cloud security benchmark](https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-azure-security-benchmark)
  - Updated: 2025-10-31T08:00:00.000Z → 2026-04-18T08:00:00.000Z
...
- [Microsoft cloud security benchmark](https://learn.microsoft.com/en-us/azure/governance/policy/samples/azure-security-benchmark)
  - Updated: 2026-02-24T08:00:00.000Z → 2026-04-18T08:00:00.000Z
- [Microsoft Cloud for Sovereignty Confidential](https://learn.microsoft.com/en-us/azure/governance/policy/samples/mcfs-baseline-confidential)
  - Updated: 2025-08-05T20:17:00.000Z → 2026-04-18T08:00:00.000Z
- [Microsoft Cloud for Sovereignty Global](https://learn.microsoft.com/en-us/azure/governance/policy/samples/mcfs-baseline-global)
  - Updated: 2025-08-05T20:17:00.000Z → 2026-04-18T08:00:00.000Z
...
- [NIST SP 800-171 R2](https://learn.microsoft.com/en-us/azure/governance/policy/samples/nist-sp-800-171-r2)
  - Updated: 2026-02-19T08:00:00.000Z → 2026-04-18T08:00:00.000Z
- [NL BIO Cloud Theme](https://learn.microsoft.com/en-us/azure/governance/policy/samples/nl-bio-cloud-theme)
  - Updated: 2026-01-12T08:00:00.000Z → 2026-04-18T08:00:00.000Z
- *...and 3 more*
...
| [FedRAMP High](https://learn.microsoft.com/en-us/azure/governance/policy/samples/fedramp-high) | security | 0.80 | Contains detailed mappings from specific FedRAMP High controls to concrete Azure Policy definitions within a regulatory compliance initiative; this is product-specific security/compliance configuration knowledge. |
| [FedRAMP Moderate](https://learn.microsoft.com/en-us/azure/governance/policy/samples/fedramp-moderate) | security | 0.80 | Provides a control-by-control mapping between FedRAMP Moderate requirements and specific Azure Policy definitions in a built-in initiative; specialized security/compliance configuration data. |
| [Microsoft Cloud for Sovereignty Confidential](https://learn.microsoft.com/en-us/azure/governance/policy/samples/mcfs-baseline-confidential) | security | 0.80 | Lists Microsoft Cloud for Sovereignty Baseline Confidential controls and their corresponding Azure Policy definitions; specialized security/compliance mapping for this offering. |
| [Microsoft Cloud for Sovereignty Global](https://learn.microsoft.com/en-us/azure/governance/policy/samples/mcfs-baseline-global) | security | 0.80 | Provides mappings between Microsoft Cloud for Sovereignty Baseline Global controls and specific Azure Policy definitions; product-specific security/compliance configuration reference. |
| [Microsoft cloud security benchmark](https://learn.microsoft.com/en-us/azure/governance/policy/samples/azure-security-benchmark) | security | 0.80 | Details how each Microsoft cloud security benchmark control maps to Azure Policy definitions in a regulatory compliance initiative; highly product-specific security benchmark implementation guidance. |
| [NIST SP 800-171 R2](https://learn.microsoft.com/en-us/azure/governance/policy/samples/nist-sp-800-171-r2) | security | 0.80 | Provides mappings between NIST SP 800-171 R2 controls and Azure Policy definitions in a regulatory compliance initiative; detailed, product-specific security/compliance reference. |
| [NIST SP 800-53 Rev. 4](https://learn.microsoft.com/en-us/azure/governance/policy/samples/nist-sp-800-53-r4) | security | 0.80 | Contains detailed mappings from NIST SP 800-53 Rev. 4 controls to Azure Policy definitions in a built-in initiative; concrete, product-specific security/compliance implementation data. |
| [NIST SP 800-53 Rev. 5](https://learn.microsoft.com/en-us/azure/governance/policy/samples/nist-sp-800-53-r5) | security | 0.80 | Documents how each NIST SP 800-53 Rev. 5 control maps to Azure Policy definitions; specialized regulatory compliance and security configuration mapping. |
| [NL BIO Cloud Theme](https://learn.microsoft.com/en-us/azure/governance/policy/samples/nl-bio-cloud-theme) | security | 0.80 | Details mappings from NL BIO Cloud Theme controls to Azure Policy definitions; niche, product-specific security/compliance configuration knowledge. |
...
| [RMIT Malaysia](https://learn.microsoft.com/en-us/azure/governance/policy/samples/rmit-malaysia) | security | 0.80 | Lists RMIT Malaysia regulatory controls and their corresponding Azure Policy definitions; specialized regional security/compliance mapping for Azure Policy. |
| [SOC 2 Type 2](https://learn.microsoft.com/en-us/azure/governance/policy/samples/soc-2) | security | 0.80 | Maps System and Organization Controls (SOC) 2 requirements to specific Azure Policy definitions in a built-in initiative; concrete security/compliance implementation guidance. |
| [SWIFT CSP-CSCF 2021](https://learn.microsoft.com/en-us/azure/governance/policy/samples/swift-csp-cscf-2021) | security | 0.80 | Provides detailed mappings between SWIFT CSP-CSCF v2021 controls and Azure Policy definitions; highly specialized financial-sector security/compliance configuration data. |
...
| [Built-in initiatives](https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-initiatives) | security | 0.70 | Index of all built-in Azure Policy initiative definitions with exact initiative names and categories; provides concrete, product-specific compliance/security configuration artifacts. |
...
| [Built-in policies](https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies) | security | 0.70 | Index of all built-in Azure Policy definitions with exact policy names and categories; this is product-specific configuration/security reference data not inferable from general training. |
...
| [FedRAMP High](https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-fedramp-high) | security | 0.70 | Page enumerates specific FedRAMP High controls and maps each to concrete Azure Policy definitions/initiatives for Azure Government. These mappings (policy names, control IDs, and how they relate) are product- and standard-specific implementation details that qualify as expert security/compliance configuration knowledge. |
| [FedRAMP Moderate](https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-fedramp-moderate) | security | 0.70 | Contains detailed mappings between FedRAMP Moderate controls and Azure Policy initiative/policy definitions for Azure Government. The exact control-to-policy relationships and policy identifiers are specific security/compliance implementation details not derivable from general training. |
...
| [Microsoft cloud security benchmark](https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-azure-security-benchmark) | security | 0.70 | Details how Microsoft cloud security benchmark controls map to Azure Policy definitions/initiatives in Azure Government. The control IDs, policy names, and mapping structure are concrete, product-specific security configuration knowledge. |
...
| [NIST SP 800-171 R2](https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-nist-sp-800-171-r2) | security | 0.70 | Describes how each NIST SP 800-171 R2 control is implemented or assessed via specific Azure Policy definitions/initiatives. These mappings and policy references are detailed, product-specific security/compliance configuration information. |
| [NIST SP 800-53 Rev. 4](https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-nist-sp-800-53-r4) | security | 0.70 | Provides a control-by-control mapping from NIST SP 800-53 Rev. 4 to specific Azure Policy definitions/initiatives. These mappings and policy identifiers are detailed security/compliance implementation data unique to Azure Government. |
| [NIST SP 800-53 Rev. 5](https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-nist-sp-800-53-r5) | security | 0.70 | Lists NIST SP 800-53 Rev. 5 controls and their corresponding Azure Policy definitions/initiatives. The explicit mapping and policy artifacts are product- and standard-specific security configuration knowledge. |
...
| [SOC 2 Type 2](https://learn.microsoft.com/en-us/azure/governance/policy/samples/gov-soc-2) | security | 0.70 | Outlines mappings between SOC 2 controls and Azure Policy initiative/policy definitions for Azure Government. The concrete control-to-policy relationships and identifiers are specialized security/compliance implementation details. |
...
| [Linux agent release notes](https://learn.microsoft.com/en-us/azure/governance/machine-configuration/whats-new/agent/linux) | 0.30 | Release notes for the Linux machine configuration agent similarly focus on version history and issues. The summary does not show specific limits/quotas, configuration parameter tables, security role definitions, or structured troubleshooting content with error codes. Therefore it does not clearly fit any sub-skill type under the expert-knowledge rules. |
...
| [Windows agent release notes](https://learn.microsoft.com/en-us/azure/governance/machine-configuration/whats-new/agent/windows) | 0.30 | Release notes for the Windows machine configuration agent typically list version changes, fixes, and known issues, but the summary does not indicate structured limits, configuration tables, error-code mappings, or decision matrices that match any sub-skill category. Without clear evidence of numeric limits, config parameter tables, or troubleshooting mappings, it does not meet the expert-knowledge criteria defined. |
...
| [Policy rule](https://learn.microsoft.com/en-us/azure/governance/policy/concepts/definition-structure-policy-rule) | 0.20 | Primarily explains Azure Policy rule structure (if/then, logical operators, effects). No specific limits, configuration tables, error codes, or product-specific numeric thresholds; it's a conceptual/structural reference rather than expert-only operational details. |
