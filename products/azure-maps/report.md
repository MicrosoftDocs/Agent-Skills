...
category_descriptions:
  ...
  security: 'Securing Azure Maps access: auth methods (keys, Entra ID, SAS), SPA/daemon/device
    scenarios, Power BI visual access control, and private endpoints for network isolation.'
  ...
  troubleshooting: Diagnosing and fixing common Azure Maps Weather API issues, including
    ...
    problems.
skill_description: Provides expert guidance on Azure Maps across troubleshooting,
  best practices, architecture & design, limits & quotas, security, configuration,
  and integrations & coding patterns. Use this skill when designing elevation and
  multi-itinerary routing solutions, choosing pricing tiers, securing and configuring
  web/mobile/Power BI map experiences, optimizing performance and accessibility, understanding
  service limits and coverage, or diagnosing Weather API and other Azure Maps issues.
  Not for Bing Maps, Google Maps, or non-Azure mapping platforms.
---
...
| [Power BI Azure Maps Visual Data Residency](https://learn.microsoft.com/en-us/azure/azure-maps/power-bi-visual-data-residency) | 0.20 | Describes high-level data residency behavior for Azure Maps Power BI visual without specific configuration parameters, limits, roles, or decision matrices. No concrete settings, quotas, or security/RBAC details. |
...
| [Drawing Tools module](https://learn.microsoft.com/en-us/azure/azure-maps/release-notes-drawing-tools-module) | 0.10 | Release notes summary; likely lists feature changes but not structured limits, configuration tables, or troubleshooting mappings as defined. Not a targeted expert-knowledge reference per the specified categories. |
| [Geographic coverage](https://learn.microsoft.com/en-us/azure/azure-maps/geographic-coverage) | - | Geographic coverage overview; description indicates it mainly links out to coverage information. No indication of limits/quotas, configuration parameters, error codes, or other structured expert configuration or troubleshooting content. |
