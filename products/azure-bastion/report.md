...
category_descriptions:
  ...
  decision-making: Guidance on choosing and upgrading Bastion SKU tiers and using
    IP-based connections across VNets, subscriptions, and hybrid environments.
...
| [Bastion SKU comparison](https://learn.microsoft.com/en-us/azure/bastion/bastion-sku-comparison) | decision-making | 0.78 | SKU comparison pages for a specific service usually include feature/limit matrices and guidance on when to choose each tier; this directly supports tier selection decisions with concrete criteria, fitting the decision-making category. |
...
| [About IP-based connection](https://learn.microsoft.com/en-us/azure/bastion/connect-ip-address) | decision-making | 0.65 | The page describes supported scenarios, SKU requirements, and limitations for IP-based connections; this typically includes which SKUs support which scenarios and constraints, helping users decide when and how to use IP-based connections, aligning with decision-making guidance. |
...
| [Deploy Bastion - Azure portal](https://learn.microsoft.com/en-us/azure/bastion/quickstart-host-portal) | 0.30 | Quickstart focuses on how to deploy via portal with default/custom settings; it is a step-by-step tutorial rather than a structured configuration reference, decision matrix, or limits/quotas table. |
...
| [SSH connection](https://learn.microsoft.com/en-us/azure/bastion/bastion-connect-vm-ssh-linux) | 0.20 | Connection how-to for SSH via Bastion is a procedural guide; summary does not indicate detailed config parameter tables, error-code-based troubleshooting, or numeric limits beyond generic secure connection behavior. |
...
| [What's new in Bastion?](https://learn.microsoft.com/en-us/azure/bastion/whats-new) | 0.20 | Release notes and what's-new content typically list changes, fixes, and deprecations but not structured limits, configuration matrices, or decision/troubleshooting mappings as defined; summary does not indicate detailed numeric limits, config tables, or error mappings. |
