...
category_descriptions:
  ...
  decision-making: Guidance on choosing Bastion SKU tiers, safely upgrading them,
    and using IP-based Bastion connections across VNets, subscriptions, and hybrid
    environments.
...
skill_description: Expert knowledge for Azure Bastion development including troubleshooting,
  ...
  clusters, VM scale sets, IP-based access, Entra ID auth, or hub/spoke VNets, and
  other Azure Bastion related development tasks. Not for Azure Virtual Network (use
  azure-virtual-network), Azure Virtual Machines (use azure-virtual-machines), Azure
  VPN Gateway (use azure-vpn-gateway), Azure Firewall (use azure-firewall).
use_when: Use when configuring Bastion for AKS private clusters, VM scale sets, IP-based
  access, Entra ID auth, or hub/spoke VNets, and other Azure Bastion related development
  tasks.
...
| [Bastion SKU comparison](https://learn.microsoft.com/en-us/azure/bastion/bastion-sku-comparison) | decision-making | 0.75 | SKU comparison and selection guidance is explicitly called out; such pages typically include feature/limit comparison tables and recommendations for when to choose each tier, which fits decision-making with product-specific criteria. |
...
| [About IP-based connection](https://learn.microsoft.com/en-us/azure/bastion/connect-ip-address) | decision-making | 0.65 | Describes supported scenarios, SKU requirements, and limitations for IP-based connections; this is specialized guidance on when and how to use this feature across on-premises and other clouds, aligning with decision-making about feature use and SKU choice. |
...
| [Deploy Bastion - Azure portal](https://learn.microsoft.com/en-us/azure/bastion/quickstart-host-portal) | 0.30 | Quickstart deployment guide focuses on step-by-step portal usage and basic deployment; it does not emphasize tier matrices, limits, or detailed configuration parameter tables beyond a simple example. |
...
| [SSH connection](https://learn.microsoft.com/en-us/azure/bastion/bastion-connect-vm-ssh-linux) | 0.30 | How-to connect via SSH is a procedural tutorial; it likely shows basic steps and commands but not organized troubleshooting mappings, config parameter tables, or quantified best-practice guidance. |
...
| [What's new in Bastion?](https://learn.microsoft.com/en-us/azure/bastion/whats-new) | 0.20 | Release notes and what's-new content are mostly announcements, bug fixes, and high-level changes; not organized as limits, configuration matrices, error-code troubleshooting, or decision guidance with quantified criteria. |
