...
category_descriptions:
  ...
  deployment: Guides for deploying and migrating ExpressRoute circuits/gateways, including
    Direct SKUs, AZ-enabled gateways, and automation with ARM templates and Terraform.
  configuration: Configuring and managing ExpressRoute circuits, peerings, gateways,
    routing/BGP, NAT, IPv6, monitoring, resiliency, and linking VNets using portal,
    PowerShell, and CLI.
...
skill_description: Expert knowledge for Azure ExpressRoute development including troubleshooting,
  ...
  designing ExpressRoute circuits/gateways, BGP routing, FastPath, Microsoft peering,
  or encrypted connectivity, and other Azure ExpressRoute related development tasks.
  Not for Azure Internet Peering (use azure-internet-peering), Azure Virtual WAN (use
  azure-virtual-wan), Azure VPN Gateway (use azure-vpn-gateway), Azure Virtual Network
  (use azure-virtual-network).
use_when: Use when designing ExpressRoute circuits/gateways, BGP routing, FastPath,
  Microsoft peering, or encrypted connectivity, and other Azure ExpressRoute related
  development tasks.
...
- [Overview](https://learn.microsoft.com/en-us/azure/expressroute/gateway-migration)
  - Updated: 2025-10-22T22:17:00.000Z → 2026-03-23T08:00:00.000Z
...
| [Azure portal](https://learn.microsoft.com/en-us/azure/expressroute/how-to-configure-custom-bgp-communities-portal) | configuration | 0.70 | How-to article for setting custom BGP community values on ExpressRoute private peering; involves product-specific routing configuration (BGP community tags) that is unlikely to be fully known from training and maps directly to configuration of Azure resources rather than generic networking theory. |
...
| [Overview](https://learn.microsoft.com/en-us/azure/expressroute/gateway-migration) | deployment | 0.70 | Describes a product-specific migration/upgrade path between ExpressRoute gateway SKUs (Standard/HighPerf/UltraPerf to ErGw1/2/3AZ), including constraints like only allowing equal-or-higher SKU moves and IP type changes. This is concrete deployment/migration guidance rather than a generic overview. |
...
| [Azure PowerShell](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-howto-gateway-migration-powershell) | 0.30 | PowerShell-based step-by-step migration tutorial; summary focuses on how to run the migration and that higher SKUs provide more resources. From the given information, it appears procedural rather than containing configuration tables, constraints, or other expert-only details. |
| [Azure portal](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-howto-gateway-migration-portal) | 0.30 | Portal-based step-by-step migration tutorial; summary only indicates basic SKU selection and that higher SKUs provide more resources. Lacks clear evidence of matrices, constraints, or other expert-only deployment details in the provided text. |
...
| [Prerequisites](https://learn.microsoft.com/en-us/azure/expressroute/expressroute-prerequisites) | 0.20 | Prerequisites/checklist page describing requirements before ordering ExpressRoute; summary indicates conceptual and procedural guidance without explicit numeric limits, configuration parameter tables, or error-code-based troubleshooting. |
