...
category_descriptions:
  ...
  troubleshooting: 'Diagnosing and fixing Azure Managed Redis issues: connectivity,
    latency/timeouts, data loss, server resources, client performance, monitoring,
    and using Redis Insight/redis-cli.'
...
skill_description: Expert knowledge for Azure Managed Redis development including
  ...
  persistence/import-export, Private Link/TLS, or Azure Functions bindings, and other
  Azure Managed Redis related development tasks. Not for Azure Cache for Redis (use
  azure-cache-redis).
use_when: Use when using Entra ID auth, geo-replication, persistence/import-export,
  Private Link/TLS, or Azure Functions bindings, and other Azure Managed Redis related
  development tasks.
...
| [Manage data with client tools](https://learn.microsoft.com/en-us/azure/redis/how-to-redis-access-data) | troubleshooting | 0.65 | The page focuses on using Redis Insight and redis-cli specifically with Azure Managed Redis for debugging and troubleshooting. It likely includes product-specific connection details, commands, and patterns for diagnosing issues, which qualify as expert knowledge under troubleshooting and integrations-style usage, rather than just generic client usage. |
