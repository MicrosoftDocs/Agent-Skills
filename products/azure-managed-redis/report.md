...
skill_description: Expert knowledge for Azure Managed Redis development including
  ...
  persistence/import-export, Private Link/TLS, or Redis Insight, and other Azure Managed
...
use_when: Use when using Entra ID auth, geo-replication, persistence/import-export,
  Private Link/TLS, or Redis Insight, and other Azure Managed Redis related development
  tasks.
...
| [Manage data with client tools](https://learn.microsoft.com/en-us/azure/redis/how-to-redis-access-data) | troubleshooting | 0.65 | The page focuses on using Redis Insight and redis-cli specifically with Azure Managed Redis for accessing data and for troubleshooting/debugging. This implies product-specific diagnostic usage patterns and likely includes concrete commands and steps to investigate issues, which qualifies as troubleshooting-oriented expert knowledge rather than a generic client tutorial. |
