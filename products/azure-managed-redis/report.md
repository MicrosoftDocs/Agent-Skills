...
category_descriptions:
  ...
  decision-making: Guidance on planning Azure Managed Redis deployments, choosing
    ...
    and FAQs
skill_description: Provides expert guidance on Azure Managed Redis troubleshooting,
  best practices, decision making, security, configuration, integrations, and deployment,
  including client usage, scaling, geo-replication, persistence, monitoring, and secure
  connectivity from .NET, Go, Node.js/TypeScript, and Python. Use this skill when
  planning or operating Azure Managed Redis, diagnosing connectivity/latency/timeouts,
  optimizing cost and performance, configuring Entra ID, Private Link, TLS, or automating
  deployments via ARM/Bicep, CLI, or PowerShell. Not for Azure Cache for Redis (classic
  PaaS), non-Azure Redis services, or general Redis OSS administration outside Azure
  Managed Redis.
---
...
| [Azure Managed Redis architecture](https://learn.microsoft.com/en-us/azure/redis/architecture) | 0.20 | Architecture description of Azure Managed Redis but summary does not indicate product-specific patterns with quantified thresholds, decision matrices, or detailed configuration tables. Appears conceptual rather than containing the numeric or parameter-level details required for expert-knowledge classification. |
...
| [About Azure Managed Redis](https://learn.microsoft.com/en-us/azure/redis/overview) | 0.10 | High-level product overview of Azure Managed Redis without specific limits, configuration parameters, error codes, or decision matrices. Content is conceptual and marketing-oriented rather than detailed expert guidance. |
