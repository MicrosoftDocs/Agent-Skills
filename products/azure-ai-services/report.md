...
category_descriptions:
  ...
  limits-quotas: Rate limits, quotas, and list-size limits for Foundry autoscale and
    Content Moderator (image/term lists), plus service quotas for Content Understanding.
  ...
  decision-making: Guidance on choosing pricing tiers, comparing Content Understanding
    vs Document Intelligence vs LLMs, selecting standard vs pro modes, Foundry vs
    Studio, migration steps, and cost estimation.
...
skill_description: Expert knowledge for Azure AI services development including troubleshooting,
  ...
  AI services applications. Not for Azure Machine Learning (use azure-machine-learning),
  Azure AI Search (use azure-cognitive-search), Azure AI Speech (use azure-speech),
  Azure AI Custom Vision (use azure-custom-vision). Formerly Azure AI services.
---
