...
category_descriptions:
  ...
  limits-quotas: 'Rate limits and quotas for Foundry: autoscaling throughput, Content
    Moderator image/term list size and usage limits, and Content Understanding quota
    references.'
  ...
  decision-making: Guidance on choosing pricing tiers, comparing Foundry vs Content
    Understanding/Studio modes, selecting between Content Understanding, Document
    Intelligence, and LLMs, and planning/migrating analyzer costs.
...
skill_description: Provides expert guidance on troubleshooting, best practices, decision
  making, limits & quotas, security, configuration, integrations, and deployment for
  Microsoft Foundry Tools and Azure AI Content Understanding. Use this skill when
  setting up or tuning Content Understanding analyzers, choosing between Foundry and
  related Azure AI services, planning capacity and quotas, securing and configuring
  endpoints, integrating via REST/.NET, or diagnosing failed or low‑quality analyses
  in production. Not for general Azure OpenAI, Copilot, or non‑Foundry Azure AI services
  that are not using Content Understanding or Foundry containers. Formerly Azure AI
  services.
---
...
| [Foundry and Content Understanding Studio comparison](https://learn.microsoft.com/en-us/azure/ai-services/content-understanding/foundry-vs-content-understanding-studio) | decision-making | 0.80 | A feature comparison page between Foundry and Content Understanding Studio; these typically include comparison tables and criteria that guide technology/option selection, fitting the decision-making category. |
...
| [What's new](https://learn.microsoft.com/en-us/azure/ai-services/content-understanding/whats-new) | 0.20 | Release notes/what's-new page; typically contains change history and feature announcements but not stable limits, configuration matrices, or detailed troubleshooting mappings as defined by the sub-skill types. |
