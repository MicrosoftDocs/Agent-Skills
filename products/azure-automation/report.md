...
| [What's new?](https://learn.microsoft.com/en-us/azure/automation/whats-new) | 0.10 | Monthly 'what's new' changelog/overview content; does not focus on limits, configuration tables, troubleshooting mappings, or other structured expert details as defined by the sub-skill types. |
