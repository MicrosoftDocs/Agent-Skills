...
skill_description: Expert knowledge for Azure Impact Reporting development including
  ...
  Impact Reporting to Azure Monitor, Logic Apps, HPC node health, Service Health,
  or its insights API, and other related development tasks. Not for Azure Carbon Optimization
  (use azure-carbon-optimization), Azure Cost Management (use azure-cost-management),
  Azure Monitor (use azure-monitor), Azure Policy (use azure-policy).
use_when: Use when wiring Impact Reporting to Azure Monitor, Logic Apps, HPC node
  health, Service Health, or its insights API, and other related development tasks.
