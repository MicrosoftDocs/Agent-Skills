...
category_descriptions:
  ...
  deployment: 'Deploying and updating IoT Edge: supported platforms (including EFLOW),
    installing on Kubernetes/KubeVirt, managing automatic deployments, and setting
    up CI/CD pipelines for Edge modules.'
  integrations: Using IoT Edge direct methods for remote management, retrieving/uploading
    module and runtime logs, and building/customizing IoT Edge modules and integrations.
  troubleshooting: Diagnosing and fixing IoT Edge runtime, provisioning, deployment,
    monitoring, networking, and EFLOW-on-Windows issues, including portal-based troubleshooting
...
| [Configure module build options](https://learn.microsoft.com/en-us/azure/iot-edge/how-to-configure-module-build-options) | configuration | 0.80 | Describes module.json schema and fields that control build and deployment; this is a product-specific configuration file with parameter names and allowed values that qualify as expert configuration knowledge. |
...
| [Diagnose IoT Edge devices](https://learn.microsoft.com/en-us/azure/iot-edge/troubleshoot) | troubleshooting | 0.75 | Core troubleshooting guide with diagnostic skills like retrieving component status and logs; likely includes specific commands, log locations, and symptom-to-cause mappings. |
...
| [Symmetric key attestation](https://learn.microsoft.com/en-us/azure/iot-edge/how-to-provision-single-device-linux-symmetric) | security | 0.70 | Product-specific security configuration using symmetric keys for device identity and connection to IoT Hub. |
...
| [Update IoT Edge](https://learn.microsoft.com/en-us/azure/iot-edge/how-to-update-iot-edge) | deployment | 0.70 | Product-specific update paths and requirements for runtime and security subsystem versions on devices. |
...
| [Supported platforms](https://learn.microsoft.com/en-us/azure/iot-edge/support) | deployment | 0.65 | Supported OS, runtimes, and container engines form a product-specific support matrix that affects deployment choices. |
| [Symmetric key attestation](https://learn.microsoft.com/en-us/azure/iot-edge/how-to-provision-single-device-linux-on-windows-symmetric) | configuration | 0.65 | Manual provisioning with symmetric keys; details device connection information and configuration parameters for EFLOW devices in IoT Hub. |
| [Use edgeAgent direct methods](https://learn.microsoft.com/en-us/azure/iot-edge/how-to-edgeagent-direct-method) | integrations | 0.65 | Documents specific direct method names, payload schemas, and behaviors for the $edgeAgent module; these are product-specific API surfaces and parameters used to monitor and manage devices. |
...
| [IoT Edge runtime](https://learn.microsoft.com/en-us/azure/iot-edge/iot-edge-runtime) | 0.40 | Runtime and architecture explanation; conceptual description of components and responsibilities. |
...
| [Benefits](https://learn.microsoft.com/en-us/azure/iot-edge/iot-edge-for-linux-on-windows-benefits) | 0.30 | Benefits-focused article for EFLOW; primarily marketing and conceptual justification, not technical configuration or limits. |
